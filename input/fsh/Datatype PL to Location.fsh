...
Title: "Datatype PLnull to Location Map"
* title = "Datatype PLnull to Location Map"
...
* group.element[19].target.dependsOn[0].value = "HD[Identifier]"
...
* group.element[20].target.dependsOn[0].value = "\"instance\""
...
* group.element[21].target.dependsOn[0].value = "\"bu\""
...
* group.element[22].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/location-physical-type\""
...
* group.element[26].target.dependsOn[0].value = "\"lvl\""
...
* group.element[30].target.dependsOn[0].value = "EI[Identifier-Organization]"
* group.element[30].target.product[0].property = "antlr"
* group.element[30].target.product[0].value = "IF PL.3 VALUED"
...
* group.element[31].target.dependsOn[0].value = "EI[Identifier-Organization]"
* group.element[31].target.product[0].property = "antlr"
* group.element[31].target.product[0].value = "IF PL.2 VALUED AND PL.3 NOT VALUED"
...
* group.element[32].target.dependsOn[0].value = "EI[Identifier-Organization]"
* group.element[32].target.product[0].property = "antlr"
* group.element[32].target.product[0].value = "IF PL.1 VALUE AND PL.2 NOT VALUED AND PL.3 NOT VALUED"
...
* group.element[33].target.dependsOn[0].value = "EI[Identifier-Organization]"
* group.element[33].target.product[0].property = "antlr"
* group.element[33].target.product[0].value = "IF PL.8 VALUED AND PL.1 NOT VALUED AND PL.2 NOT VALUED AND PL3.NOT VALUED"
...
* group.element[34].target.dependsOn[0].value = "EI[Identifier-Organization]"
* group.element[34].target.product[0].property = "antlr"
* group.element[34].target.product[0].value = "IF PL.7 VALUED AND PL.1 NOT VALUED AND PL.2 NOT VALUED AND PL.3 NOT VALUED AND PL.8 NOT VALUED"
...
* group.element[35].target.product[0].value = "IF PL.4 VALUED AND PL.1 NOT VALUED AND PL.2 NOT VALUED AND PL.3 NOT VALUED AND PL.8 NOT VALUED AND PL.7 NOT VALUED"
...
* group.element[36].target.dependsOn[0].value = "EI[Identifier-DefaultAssigner]"
* group.element[36].target.product[0].property = "antlr"
* group.element[36].target.product[0].value = "IF PL.11 VALUED AND IF PL.3 VALUED"
...
* group.element[37].target.dependsOn[0].value = "EI[Identifier-DefaultAssigner]"
* group.element[37].target.product[0].property = "antlr"
* group.element[37].target.product[0].value = "IF PL.11 VALUED AND IF PL.2 VALUED AND PL.3 NOT VALUED"
...
* group.element[38].target.dependsOn[0].value = "EI[Identifier-DefaultAssigner]"
* group.element[38].target.product[0].property = "antlr"
* group.element[38].target.product[0].value = "IF PL.11 VALUED AND IF PL.1 VALUED AND PL.2 NOT VALUED AND PL.3 NOT VALUED"
...
* group.element[39].target.dependsOn[0].value = "EI[Identifier-DefaultAssigner]"
* group.element[39].target.product[0].property = "antlr"
* group.element[39].target.product[0].value = "IF PL.11 VALUED AND IF PL.8 VALUED AND PL.1 NOT VALUED AND PL.2 NOT VALUED AND PL3.NOT VALUED"
...
* group.element[40].target.dependsOn[0].value = "EI[Identifier-DefaultAssigner]"
* group.element[40].target.product[0].property = "antlr"
* group.element[40].target.product[0].value = "IF PL.11 VALUED AND IF PL.7 VALUED AND PL.1 NOT VALUED AND PL.2 NOT VALUED AND PL.3 NOT VALUED AND PL.8 NOT VALUED"
...
* group.element[41].target.product[0].value = "IF PL.11 VALUED AND IF PL.4 VALUED AND PL.1 NOT VALUED AND PL.2 NOT VALUED AND PL.3 NOT VALUED AND PL.8 NOT VALUED AND PL.7 NOT VALUED"
...
* group.element[42].target.dependsOn[0].value = "HD[Organization]"
...
* group.element[43].target.dependsOn[0].value = "HD[Organization]"
