...
Title: "Message ADT_A11null to Bundle Map"
* title = "Message ADT_A11null to Bundle Map"
...
* group.element[13].target.dependsOn[0].value = "PD1[Observation-LivingWill]"
* group.element[13].target.dependsOn[1].property = "references"
* group.element[13].target.dependsOn[1].value = "Observation[1].subject.reference=Patient[1].id"
* group.element[13].target.product[0].property = "antlr"
* group.element[13].target.product[0].value = "IF PD1-7 VALUED"
...
* group.element[19].target.dependsOn[0].value = "OBX[Observation]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "Observation[3].subject.reference=Patient[1].id"
* group.element[19].target.product[0].property = "narrative"
* group.element[19].target.product[0].value = "Based on profiles, such as Vital Signs, certain observations are represented on the Observation, while others on its components.  No computable guidance available yet."
...
* group.element[20].target.dependsOn[0].value = "OBX[Observation-Component]"
...
* group.element[21].target.dependsOn[1].value = "Condition[1].subject.reference=Patient[1].id"
* group.element[21].target.product[0].property = "narrative"
* group.element[21].target.product[0].value = "If in context of the patient"
...
* group.element[23].target.dependsOn[1].value = """
