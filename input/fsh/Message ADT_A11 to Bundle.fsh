...
* group.element[16].code = #ADT_A11.PV2
...
* group.element[18].code = #ADT_A11.OBSERVATION.OBX
...
* group.element[18].target.code = #Observation[3]
* group.element[18].target.display = "Observation[3]"
...
* group.element[18].target.dependsOn[1].value = "Observation[3].subject.reference=Patient[1].id"
...
* group.element[19].target.comment = "Processing of the DG1 segment results in the creation of a new Condition resource"
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "DG1[Condition]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "Condition[1].subject.reference=Patient[1].id"
* group.element[19].target.product[0].property = "narrative"
* group.element[19].target.product[0].value = "If in context of the patient"
...
* group.element[20].target.dependsOn[0].value = "DG1[Encounter]"
* group.element[20].target.dependsOn[1].property = "references"
* group.element[20].target.dependsOn[1].value = "Encounter[1].diagnosis.reference=Condition[1].id"
* group.element[20].target.product[0].property = "narrative"
* group.element[20].target.product[0].value = "If in context of an encounter"
...
* group.element[21].target.code = #EpisodeOfCare[1]
* group.element[21].target.display = "EpisodeOfCare[1]"
* group.element[21].target.dependsOn[0].property = "segment-map"
* group.element[21].target.dependsOn[0].value = "DG1[EpisodeOfCare]"
* group.element[21].target.dependsOn[1].property = "references"
* group.element[21].target.dependsOn[1].value = """
...
* group.element[21].target.product[0].value = "If in context of a episode of care"
