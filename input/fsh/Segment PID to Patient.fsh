...
* group.element[7].target.dependsOn[0].value = "IF PID-7 LENGTH GREATER THAN 8"
* group.element[7].target.dependsOn[0].display = "IF PID-7 LENGTH GREATER THAN 8"
...
* group.element[8].target.dependsOn[0].value = "IF PID-7 LENGTH GREATER THAN 8"
* group.element[8].target.dependsOn[0].display = "IF PID-7 LENGTH GREATER THAN 8"
...
* group.element[12].target.dependsOn[0].value = "IF PID-11 LST.COUNT EQUALS 1 AND PID-11.9 IS NOT VALUED"
* group.element[12].target.dependsOn[0].display = "IF PID-11 LST.COUNT EQUALS 1 AND PID-11.9 IS NOT VALUED"
...
* group.element[13].target.dependsOn[0].value = "IF PID-11 LST.COUNT EQUALS 1 AND PID-11.9 IS VALUED NOT EQUAL PID-12"
* group.element[13].target.dependsOn[0].display = "IF PID-11 LST.COUNT EQUALS 1 AND PID-11.9 IS VALUED NOT EQUAL PID-12"
...
* group.element[14].target.dependsOn[0].value = "IF PID-11 LST.COUNT GREATER THAN 1"
* group.element[14].target.dependsOn[0].display = "IF PID-11 LST.COUNT GREATER THAN 1"
...
* group.element[15].target.dependsOn[0].value = "IF PID-11 IS NOT VALUED"
* group.element[15].target.dependsOn[0].display = "IF PID-11 IS NOT VALUED"
...
* group.element[17].target.extension[0].extension[0].valueString = "\"home\""
...
* group.element[17].target.dependsOn[0].value = "IF PID-13.2 IS NOT VALUED"
* group.element[17].target.dependsOn[0].display = "IF PID-13.2 IS NOT VALUED"
...
* group.element[19].target.extension[0].extension[0].valueString = "\"work\""
...
* group.element[19].target.dependsOn[0].value = "IF PID-14.2 IS NOT VALUED"
* group.element[19].target.dependsOn[0].display = "IF PID-14.2 IS NOT VALUED"
...
* group.element[33].target.dependsOn[0].value = "IF PID-25 NOT VALUED"
* group.element[33].target.dependsOn[0].display = "IF PID-25 NOT VALUED"
...
* group.element[42].target.dependsOn[0].value = "IF PID-29 NOT VALUED"
* group.element[42].target.dependsOn[0].display = "IF PID-29 NOT VALUED"
