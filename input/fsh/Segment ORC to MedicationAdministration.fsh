...
* group[0].element[0].target.code = #extension.url
...
* group[0].element[0].target.extension[0].extension[3].valueString = "\"http://hl7.org/fhir/StructureDefinition/businessEvent\""
* group[0].element[0].target.display = "extension.url"
...
* group[0].element[1].target.code = #extension[1].extension.url
...
* group[0].element[1].target.extension[0].extension[3].valueString = "\"value\""
* group[0].element[1].target.display = "extension[1].extension.url"
...
* group[0].element[2].target.code = #extension[1].valueCodeableConcept.coding.code
...
* group[0].element[2].target.display = "extension[1].valueCodeableConcept.coding.code"
...
* group[0].element[3].target.code = #extension[1].valueCodeableConcept.coding.system
...
* group[0].element[3].target.extension[0].extension[3].valueString = "\"http://terminology.hl7.org/ValueSet/v2-0119\""
* group[0].element[3].target.display = "extension[1].valueCodeableConcept.coding.system"
* group[0].element[4].code = #ORC-2
...
* group[0].element[4].display = "Placer Order Number"
* group[0].element[4].target.equivalence = #equivalent
* group[0].element[4].target.code = #identifier[1]
...
* group[0].element[4].target.display = "identifier[1]"
* group[0].element[5].code = #ORC-2
...
* group[0].element[5].display = "Placer Order Number"
* group[0].element[5].target.equivalence = #equivalent
* group[0].element[5].target.code = #identifier[1].type.coding.code
...
* group[0].element[5].target.extension[0].extension[3].valueString = "\"PLAC\""
* group[0].element[5].target.display = "= \"PLAC\""
...
* group[0].element[6].target.code = #identifier[1].type.coding.system
...
* group[0].element[6].target.display = "identifier[1].type.coding.system"
* group[0].element[7].code = #ORC-3
...
* group[0].element[7].display = "Filler Order Number"
* group[0].element[7].target.equivalence = #equivalent
* group[0].element[7].target.code = #identifier[2]
...
* group[0].element[7].target.display = "identifier[2]"
* group[0].element[8].code = #ORC-3
...
* group[0].element[8].display = "Filler Order Number"
* group[0].element[8].target.equivalence = #equivalent
* group[0].element[8].target.code = #identifier[2].type.coding.code
...
* group[0].element[8].target.extension[0].extension[3].valueString = "\"FILL\""
* group[0].element[8].target.display = "identifier[2].type.coding.code"
...
* group[0].element[10].target.code = #performer.actor(Practitioner)
...
* group[0].element[10].target.display = "performer.actor(Practitioner)"
...
* group[0].element[11].target.code = #performer.function.coding.code
...
* group[0].element[11].target.extension[0].extension[3].valueString = "\"OP\""
* group[0].element[11].target.display = "performer.function.coding.code"
* group[0].element[12].code = #ORC-12
...
* group[0].element[12].display = "Ordering Provider"
* group[0].element[12].target.equivalence = #equivalent
* group[0].element[12].target.code = #performer.function.coding.system
...
* group[0].element[12].target.extension[0].extension[3].valueString = "\"http://terminology.hl7.org/CodeSystem/v2-0443\""
* group[0].element[12].target.display = "performer.function.coding.system"
* group[0].element[13].code = #ORC-28
...
* group[0].element[13].display = "Confidentiality Code"
...
* group[0].element[13].target.extension[0].extension[3].valueUrl = "ConceptMap/table-hl70177-to-v3-confidentiality"
