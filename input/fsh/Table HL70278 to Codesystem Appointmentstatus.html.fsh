...
Instance: TableHL70278toCodesystemAppointmentstatus.html
InstanceOf: ConceptMap
Title: "Table HL70278 to Codesystem Appointmentstatus.html Map"
* description = "This ConceptMap represents a mapping from the HL7 V2 Table HL70278 to the FHIR Codesystem Appointmentstatus.html Value Set."
* id = "table-hl70278-to-codesystem-appointmentstatus.html"
* url = "http://hl7.org/fhir/uv/v2mappings/table-hl70278-to-codesystem-appointmentstatus.html"
* version = "1.0"
* name = "TableHL70278toCodesystemAppointmentstatus.html"
* status = #active
* experimental = true
* date = "2023-07-20"
...
* extension[0].extension[1].valueString = "Table HL70278 to Codesystem Appointmentstatus.html.fsh"
