// HL7 Message - FHIR E2_ ADT_A05 - Sheet1.csv
...
* url = "http://hl7.org/fhir/uv/v2mappings/ConceptMap/message-adt-a05-to-bundle"
...
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1Je9NkudYOh2maDwrDQ_6k5nkbaRovioO0BVIT1zgYao/edit?gid=0#gid=0"
* group[0].element[0].code = #ADT_A05.MSH
...
* group[0].element[1].code = #ADT_A05.MSH
...
* group[0].element[2].code = #ADT_A05.MSH
...
* group[0].element[3].code = #ADT_A05.MSH
...
* group[0].element[4].code = #ADT_A05.SFT
...
* group[0].element[5].code = #ADT_A05.SFT
...
* group[0].element[6].code = #ADT_A05.EVN
...
* group[0].element[7].code = #ADT_A05.EVN
...
* group[0].element[8].code = #ADT_A05.PID
...
* group[0].element[9].code = #ADT_A05.PID
...
* group[0].element[10].code = #ADT_A05.PID
...
* group[0].element[11].code = #ADT_A05.PD1
...
* group[0].element[13].code = #ADT_A05:follow:PID.ROL
...
* group[0].element[14].code = #ADT_A05:follow:PID.ROL
...
* group[0].element[15].code = #ADT_A05:follow:PID.PRT
...
* group[0].element[16].code = #ADT_A05:follow:PID.PRT
...
* group[0].element[17].code = #ADT_A05.NEXT_OF_KIN.NK1
...
* group[0].element[18].code = #ADT_A05.NEXT_OF_KIN.NK1
...
* group[0].element[19].code = #ADT_A05.PV1
...
* group[0].element[20].code = #ADT_A05.PV1
...
* group[0].element[21].code = #ADT_A05.PV1
...
* group[0].element[22].code = #ADT_A05.PV1
...
* group[0].element[23].code = #ADT_A05.PV2
...
* group[0].element[24].code = #ADT_A05:follow:PV1.ROL
...
* group[0].element[25].code = #ADT_A05.OBSERVATION.OBX
...
* group[0].element[26].code = #ADT_A05.OBSERVATION.OBX
...
* group[0].element[27].code = #ADT_A05.AL1
...
* group[0].element[28].code = #ADT_A05.DG1
...
* group[0].element[29].code = #ADT_A05.DG1
...
* group[0].element[30].code = #ADT_A05.DG1
...
* group[0].element[31].code = #ADT_A05.PROCEDURE.PR1
...
* group[0].element[32].code = #ADT_A05.INSURANCE.IN1
...
* group[0].element[33].code = #ADT_A05.INSURANCE.IN3
