...
Title: "Message ADT_A05null to Bundle Map"
* title = "Message ADT_A05null to Bundle Map"
...
* group.element[15].target.dependsOn[0].value = "PRT[Patient-GeneralPractitioner-PractitionerRole]"
...
* group.element[22].code = #ADT_A05.PV1
...
* group.element[23].code = #ADT_A05.PV2
...
* group.element[24].code = #ADT_A05:follow:PV1.ROL
...
* group.element[26].code = #ADT_A05.OBSERVATION.OBX
...
* group.element[27].code = #ADT_A05.AL1
...
* group.element[30].code = #ADT_A05.DG1
...
* group.element[31].code = #ADT_A05.PROCEDURE.PR1
...
* group.element[32].code = #ADT_A05.INSURANCE.IN1
