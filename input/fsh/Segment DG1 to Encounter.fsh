...
* url = "http://hl7.org/fhir/uv/v2mappings/ConceptMap/segment-dg1-to-encounter"
...
* group[0].element[3].target.code = #diagnosis.use
...
* group[0].element[5].target.comment = "Condition.recorder is also an option. Neither of these fields can repeat like DG1-16 can."
...
* group[0].element[12].target.code = #diagnosis.condition(Condition.extension[1].uri)
...
* group[0].element[12].target.extension[0].extension[3].valueString = "\"http://hl7.org/fhir/StructureDefinition/condition-dueTo\""
* group[0].element[12].target.display = "diagnosis.condition(Condition.extension[1].uri)"
...
* group[0].element[13].target.code = #diagnosis.condition(Condition.extension[1].valueReference(Condition))
...
* group[0].element[13].target.display = "diagnosis.condition(Condition.extension[1].valueReference(Condition))"
