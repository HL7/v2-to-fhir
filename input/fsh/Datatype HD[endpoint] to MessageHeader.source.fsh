...
* group.element[0].target.dependsOn[0].value = "IF HD.2 NOT VALUED AND (HD-3 NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\"))"
* group.element[0].target.dependsOn[0].display = "IF HD.2 NOT VALUED AND (HD-3 NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\"))"
...
* group.element[1].target.dependsOn[0].value = "IF HD-3 = \"ISO\""
* group.element[1].target.dependsOn[0].display = "IF HD-3 = \"ISO\""
...
* group.element[2].target.dependsOn[0].value = "IF HD-3 = \"UUID\""
* group.element[2].target.dependsOn[0].display = "IF HD-3 = \"UUID\""
...
* group.element[3].target.dependsOn[0].value = "IF HD-3 = \"DNS\""
* group.element[3].target.dependsOn[0].display = "IF HD-3 = \"DNS\""
...
* group.element[4].target.dependsOn[0].value = "IF HD-3 = \"URI\""
* group.element[4].target.dependsOn[0].display = "IF HD-3 = \"URI\""
...
* group.element[5].target.extension[0].extension[0].valueString = "HD.1+\" - \"+HD.3+\":\"+HD.2"
...
* group.element[5].target.dependsOn[0].value = "IF HD-3 NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\")"
* group.element[5].target.dependsOn[0].display = "IF HD-3 NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\")"
...
* group.element[6].target.extension[0].extension[0].url = "fixedValue"
* group.element[6].target.extension[0].extension[0].valueString = "\"http://hl7.org/fhir/R4/extension-data-absent-reason.html\""
...
* group.element[6].target.dependsOn[0].value = "IF NOT VALUED OR NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\")"
* group.element[6].target.dependsOn[0].display = "IF NOT VALUED OR NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\")"
...
* group.element[7].target.extension[0].extension[0].valueString = "\"unknown\""
...
* group.element[7].target.dependsOn[0].value = "IF NOT VALUED OR NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\")"
* group.element[7].target.dependsOn[0].display = "IF NOT VALUED OR NOT IN (\"ISO\", \"UUID\", \"DNS\", \"URI\")"
