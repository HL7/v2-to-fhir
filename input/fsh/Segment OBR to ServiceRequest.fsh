...
Title: "Segment OBRnull to ServiceRequest Map"
* title = "Segment OBRnull to ServiceRequest Map"
...
* group.element[16].target.dependsOn[0].value = "TQ[ServiceRequest]"
* group.element[16].target.product[0].property = "antlr"
* group.element[16].target.product[0].value = "IF ORC-7 NOT VALUED AND ORC-6 NOT VALUED"
...
* group.element[17].target.product[0].value = "IF OBR-29.1 VALUED AND OBR-50 NOT VALUED"
* group.element[17].target.product[1].property = "narrative"
* group.element[17].target.product[1].value = "If OBR-29.2 is also valued, implementation needs to decide which one to use."
...
* group.element[19].target.product[0].value = "IF OBR-29.2 VALUED AND OBR-50 NOT VALUED"
* group.element[19].target.product[1].property = "narrative"
* group.element[19].target.product[1].value = "If OBR-29.1 is also valued, implementation needs to decide which one to use."
...
* group.element[20].target.dependsOn[0].value = "\"ServiceRequest\""
