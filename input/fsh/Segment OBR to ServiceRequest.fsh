...
* group.element[0].target.extension[0].extension[0].valueString = "\"order\""
...
* group.element[1].target.dependsOn[0].value = "IF ORC-2 NOT VALUED"
* group.element[1].target.dependsOn[0].display = "IF ORC-2 NOT VALUED"
...
* group.element[2].target.dependsOn[0].value = "IF ORC-2 NOT VALUED"
* group.element[2].target.dependsOn[0].display = "IF ORC-2 NOT VALUED"
...
* group.element[3].target.dependsOn[0].value = "IF ORC-2 NOT VALUED"
* group.element[3].target.dependsOn[0].display = "IF ORC-2 NOT VALUED"
...
* group.element[4].target.dependsOn[0].value = "IF ORC-3 NOT VALUED"
* group.element[4].target.dependsOn[0].display = "IF ORC-3 NOT VALUED"
...
* group.element[5].target.dependsOn[0].value = "IF ORC-3 NOT VALUED"
* group.element[5].target.dependsOn[0].display = "IF ORC-3 NOT VALUED"
...
* group.element[6].target.dependsOn[0].value = "IF ORC-3 NOT VALUED"
* group.element[6].target.dependsOn[0].display = "IF ORC-3 NOT VALUED"
...
* group.element[10].target.extension[0].extension[0].valueString = "\"#add-on#\""
...
* group.element[10].target.dependsOn[0].value = "IF OBR-11 EQUALS \"A\""
* group.element[10].target.dependsOn[0].display = "IF OBR-11 EQUALS \"A\""
...
* group.element[10].target.dependsOn[1].value = "IF OBR-11 EQUALS \"A\""
* group.element[10].target.dependsOn[1].display = "IF OBR-11 EQUALS \"A\""
...
* group.element[11].target.dependsOn[0].value = "IF OBR-11 EQUALS \"G\""
* group.element[11].target.dependsOn[0].display = "IF OBR-11 EQUALS \"G\""
...
* group.element[11].target.dependsOn[1].value = "IF OBR-11 EQUALS \"G\""
* group.element[11].target.dependsOn[1].display = "IF OBR-11 EQUALS \"G\""
...
* group.element[12].target.extension[0].extension[0].valueString = "\"order\""
...
* group.element[12].target.dependsOn[0].value = "IF OBR-11 NOT IN (\"G\",\"A\")"
* group.element[12].target.dependsOn[0].display = "IF OBR-11 NOT IN (\"G\",\"A\")"
* group.element[12].target.dependsOn[1].property = "Computable-FHIRPath"
* group.element[12].target.dependsOn[1].system = "http://hl7.org/fhirpath/N1"
* group.element[12].target.dependsOn[1].value = "IF OBR-11 NOT IN (\"G\",\"A\")"
* group.element[12].target.dependsOn[1].display = "IF OBR-11 NOT IN (\"G\",\"A\")"
...
* group.element[13].target.dependsOn[0].value = "IF ORC-12 NOT VALUED"
* group.element[13].target.dependsOn[0].display = "IF ORC-12 NOT VALUED"
...
* group.element[16].target.dependsOn[0].value = "IF ORC-7 NOT VALUED AND ORC-6 NOT VALUED"
* group.element[16].target.dependsOn[0].display = "IF ORC-7 NOT VALUED AND ORC-6 NOT VALUED"
...
* group.element[17].target.dependsOn[0].value = "IF OBR-29.1 VALUED AND OBR-50 NOT VALUED"
* group.element[17].target.dependsOn[0].display = "IF OBR-29.1 VALUED AND OBR-50 NOT VALUED"
...
* group.element[18].target.extension[0].extension[0].valueString = "\"ServiceRequest\""
...
* group.element[18].target.dependsOn[0].value = "IF OBR-29.1 VALUED AND OBR-50 NOT VALUED"
* group.element[18].target.dependsOn[0].display = "IF OBR-29.1 VALUED AND OBR-50 NOT VALUED"
...
* group.element[19].target.dependsOn[0].value = "IF OBR-29.2 VALUED AND OBR-50 NOT VALUED"
* group.element[19].target.dependsOn[0].display = "IF OBR-29.2 VALUED AND OBR-50 NOT VALUED"
...
* group.element[20].target.extension[0].extension[0].url = "fixedValue"
* group.element[20].target.extension[0].extension[0].valueString = "\"ServiceRequest\""
...
* group.element[20].target.dependsOn[0].value = "IF OBR-29.2 VALUED AND OBR-50 NOT VALUED"
* group.element[20].target.dependsOn[0].display = "IF OBR-29.2 VALUED AND OBR-50 NOT VALUED"
