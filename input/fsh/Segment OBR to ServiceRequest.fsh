...
* group[0].element[19].target.code = #basedOn.identifier
* group[0].element[19].target.display = "basedOn.identifier"
...
* group[0].element[20].target.code = #basedOn.type
* group[0].element[20].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group[0].element[20].target.extension[0].extension[0].url = "assignment"
* group[0].element[20].target.extension[0].extension[0].valueString = "\"ServiceRequest\""
* group[0].element[20].target.display = "basedOn.type"
...
* group[0].element[21].target.code = #basedOn.identifier
* group[0].element[21].target.display = "basedOn.identifier"
...
* group[0].element[22].target.code = #basedOn.type
* group[0].element[22].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group[0].element[22].target.extension[0].extension[0].url = "assignment"
* group[0].element[22].target.extension[0].extension[0].valueString = "\"ServiceRequest\""
* group[0].element[22].target.display = "basedOn.type"
