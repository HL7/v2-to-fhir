...
* group[0].element[13].code = #OBR-16
...
* group[0].element[13].display = "Ordering Provider"
* group[0].element[13].target.equivalence = #equivalent
* group[0].element[13].target.code = #requester(Practitioner)
...
* group[0].element[13].target.display = "requester(Practitioner)"
* group[0].element[13].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[13].target.dependsOn[0].value = "IF ORC-12 NOT VALUED"
* group[0].element[14].code = #OBR-17
...
* group[0].element[14].extension[0].extension[1].valueInteger = 2
* group[0].element[14].extension[0].extension[2].url = "cardinalityMax"
* group[0].element[14].extension[0].extension[2].valueInteger = 2
* group[0].element[14].display = "Order Callback Phone Number"
* group[0].element[14].target.equivalence = #equivalent
* group[0].element[14].target.code = #requester.extension[1].url
...
* group[0].element[14].target.display = "requester.extension[1].url"
* group[0].element[14].target.comment = "\"http://hl7.org/fhir/StructureDefinition/servicerequest-order-callback-phone-number\""
* group[0].element[15].code = #OBR-17
...
* group[0].element[15].extension[0].extension[1].valueInteger = 2
* group[0].element[15].extension[0].extension[2].url = "cardinalityMax"
* group[0].element[15].extension[0].extension[2].valueInteger = 2
* group[0].element[15].display = "Order Callback Phone Number"
* group[0].element[15].target.equivalence = #equivalent
* group[0].element[15].target.code = #requester.extension[1].valueContactPoint
...
* group[0].element[15].target.display = "requester.extension[1].valueContactPoint"
* group[0].element[16].code = #OBR-27
...
* group[0].element[16].extension[0].extension[0].valueCode = #"TQ"
...
* group[0].element[16].display = "Quantity/Timing"
* group[0].element[16].target.equivalence = #equivalent
* group[0].element[16].target.code = #$this
* group[0].element[16].target.display = "$this"
* group[0].element[16].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[16].target.dependsOn[0].value = "IF ORC-7 NOT VALUED AND ORC-6 NOT VALUED"
* group[0].element[17].code = #OBR-29
...
* group[0].element[17].display = "ParentResults Observation Identifier"
* group[0].element[17].target.equivalence = #equivalent
* group[0].element[17].target.code = #basedOn.identifier
* group[0].element[17].target.display = "basedOn.identifier"
* group[0].element[17].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[17].target.dependsOn[0].value = "IF OBR-29.1 VALUED AND OBR-50 NOT VALUED"
* group[0].element[17].target.dependsOn[1].property = "Narrative-Condition"
* group[0].element[17].target.dependsOn[1].value = "If OBR-29.2 is also valued, implementation needs to decide which one to use."
* group[0].element[18].code = #OBR-29
...
* group[0].element[18].display = "ParentResults Observation Identifier"
* group[0].element[18].target.equivalence = #equivalent
* group[0].element[18].target.code = #basedOn.type
...
* group[0].element[18].target.extension[0].extension[0].valueString = "\"ServiceRequest\""
* group[0].element[18].target.display = "basedOn.type"
* group[0].element[18].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[18].target.dependsOn[0].value = "IF OBR-29.1 VALUED AND OBR-50 NOT VALUED"
* group[0].element[18].target.dependsOn[1].property = "Narrative-Condition"
* group[0].element[18].target.dependsOn[1].value = "If OBR-29.2 is also valued, implementation needs to decide which one to use."
...
* group[0].element[19].target.dependsOn[0].value = "IF OBR-29.2 VALUED AND OBR-50 NOT VALUED"
* group[0].element[19].target.dependsOn[1].property = "Narrative-Condition"
* group[0].element[19].target.dependsOn[1].value = "If OBR-29.1 is also valued, implementation needs to decide which one to use."
...
* group[0].element[20].target.dependsOn[0].value = "IF OBR-29.2 VALUED AND OBR-50 NOT VALUED"
* group[0].element[20].target.dependsOn[1].property = "Narrative-Condition"
* group[0].element[20].target.dependsOn[1].value = "If OBR-29.1 is also valued, implementation needs to decide which one to use."
* group[0].element[21].code = #OBR-31
...
* group[0].element[21].display = "Reason for Study"
* group[0].element[21].target.equivalence = #equivalent
* group[0].element[21].target.code = #reasonCode
...
* group[0].element[21].target.display = "reasonCode"
* group[0].element[22].code = #OBR-46
...
* group[0].element[22].display = "Placer Supplemental Service Information"
* group[0].element[22].target.equivalence = #equivalent
* group[0].element[22].target.code = #orderDetail[1]
...
* group[0].element[22].target.extension[0].extension[0].valueCode = #"CodeableConcept"
...
* group[0].element[22].target.display = "orderDetail[1]"
* group[0].element[23].code = #OBR-47
...
* group[0].element[23].display = "Filler Supplemental Service Information"
* group[0].element[23].target.equivalence = #equivalent
* group[0].element[23].target.code = #orderDetail[2]
...
* group[0].element[23].target.display = "orderDetail[2]"
* group[0].element[24].code = #OBR-53
...
* group[0].element[24].extension[0].extension[0].valueCode = #"CX"
...
* group[0].element[24].display = "Alternate Placer Order Number"
* group[0].element[24].target.equivalence = #equivalent
* group[0].element[24].target.code = #identifier[3]
...
* group[0].element[24].target.display = "identifier[3]"
* group[0].element[25].code = #OBR-53
...
* group[0].element[25].extension[0].extension[0].valueCode = #"CX"
...
* group[0].element[25].display = "Alternate Placer Order Number"
* group[0].element[25].target.equivalence = #equivalent
* group[0].element[25].target.code = #identifier[3].type.coding.code
...
* group[0].element[25].target.extension[0].extension[3].valueString = "\"PLAC\""
* group[0].element[25].target.display = "identifier[3].type.coding.code"
...
* group[0].element[26].target.code = #identifier[3].type.coding.system
...
* group[0].element[26].target.extension[0].extension[3].valueString = "\"http://terminology.hl7.org/CodeSystem/v2-0203\""
* group[0].element[26].target.display = "identifier[3].type.coding.system"
