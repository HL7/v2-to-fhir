...
* group.element[23].display = "Re-admission Indicator"
* group.element[23].target.equivalence = #equivalent
* group.element[23].target.code = #hospitalization.reAdmission
...
* group.element[23].target.display = "hospitalization.reAdmission"
...
* group.element[23].target.dependsOn[1].value = "ReadmissionIndicator"
* group.element[24].code = #PV1-14
...
* group.element[24].display = "Admit Source"
* group.element[24].target.equivalence = #equivalent
* group.element[24].target.code = #hospitalization.admitSource
...
* group.element[24].target.display = "hospitalization.admitSource"
* group.element[24].target.comment = "Table 0023 doesn't have any suggested values, therefore there is no vocabulary mapping"
* group.element[24].target.dependsOn[0].property = "data-type-map"
* group.element[24].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[25].code = #PV1-16
...
* group.element[25].display = "VIP Indicator"
* group.element[25].target.equivalence = #equivalent
* group.element[25].target.code = #hospitalization.specialCourtesy
...
* group.element[25].target.display = "hospitalization.specialCourtesy"
* group.element[25].target.comment = "Depending on the vocabulary used in PV1-16, this may require additional mapping."
* group.element[25].target.dependsOn[0].property = "data-type-map"
* group.element[25].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[25].target.dependsOn[1].property = "vocabulary-map"
* group.element[25].target.dependsOn[1].value = "VIPIndicator"
...
* group.element[26].target.code = #participant[4].individual(Practitioner)
...
* group.element[26].target.extension[0].extension[0].valueCode = #"Reference(Practitioner)"
...
* group.element[26].target.display = "participant[4].individual(Practitioner)"
* group.element[26].target.dependsOn[0].property = "data-type-map"
* group.element[26].target.dependsOn[0].value = "XCN[Practitioner]"
...
* group.element[27].target.code = #participant[4].type.coding.code
...
* group.element[27].target.display = "participant[4].type.coding.code"
* group.element[27].target.dependsOn[0].property = "value"
* group.element[27].target.dependsOn[0].value = "\"ADM\""
...
* group.element[28].target.code = #participant[4].type.coding.system
...
* group.element[28].target.display = "participant[4].type.coding.system"
* group.element[28].target.dependsOn[0].property = "value"
* group.element[28].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v3-ParticipationType\""
...
* group.element[29].target.code = #participant[4].type.text
...
* group.element[29].target.display = "participant[4].type.text"
* group.element[29].target.dependsOn[0].property = "value"
* group.element[29].target.dependsOn[0].value = "\"admitter\""
...
* group.element[30].target.code = #identifier[1]
...
* group.element[30].target.display = "identifier[1]"
* group.element[30].target.dependsOn[0].property = "data-type-map"
* group.element[30].target.dependsOn[0].value = "CX[Identifier]"
...
* group.element[31].target.code = #identifier[1].type.coding.code
...
* group.element[31].target.display = "identifier[1].type.coding.code"
* group.element[31].target.dependsOn[0].property = "value"
* group.element[31].target.dependsOn[0].value = "\"VN\""
...
* group.element[32].target.code = #identifier[1].type.coding.system
...
* group.element[32].target.display = "identifier[1].type.coding.system"
* group.element[32].target.dependsOn[0].property = "value"
* group.element[32].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0203\""
...
* group.element[33].target.code = #identifier[1].type.text
...
* group.element[33].target.display = "identifier[1].type.text"
* group.element[33].target.dependsOn[0].property = "value"
* group.element[33].target.dependsOn[0].value = "\"visit number\""
* group.element[34].code = #PV1-36
...
* group.element[34].display = "Discharge Disposition"
* group.element[34].target.equivalence = #equivalent
* group.element[34].target.code = #hospitalization.dischargeDisposition
...
* group.element[34].target.display = "hospitalization.dischargeDisposition"
...
* group.element[34].target.dependsOn[1].value = "DischargeDisposition"
* group.element[35].code = #PV1-37
...
* group.element[35].extension[0].extension[0].valueCode = #"DLD"
...
* group.element[35].display = "Discharged to Location"
* group.element[35].target.equivalence = #equivalent
* group.element[35].target.code = #hospitalization.destination(Location)
...
* group.element[35].target.display = "hospitalization.destination(Location)"
* group.element[35].target.comment = "This location should be a new location resources instance."
* group.element[35].target.dependsOn[0].property = "value"
* group.element[35].target.dependsOn[0].value = "/Encounter.hospitalization.destination.reference=Location[n].id/"
* group.element[35].target.dependsOn[1].property = "data-type-map"
* group.element[35].target.dependsOn[1].value = "DLD[Location-Discharge]"
* group.element[36].code = #PV1-38
...
* group.element[36].display = "Diet Type"
* group.element[36].target.equivalence = #equivalent
* group.element[36].target.code = #hospitalization.dietPreference
...
* group.element[36].target.display = "hospitalization.dietPreference"
* group.element[36].target.dependsOn[0].property = "data-type-map"
* group.element[36].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[36].target.dependsOn[1].property = "vocabulary-map"
* group.element[36].target.dependsOn[1].value = "DietType"
* group.element[37].code = #PV1-40
...
* group.element[37].display = "Bed Status"
* group.element[37].target.equivalence = #equivalent
* group.element[37].target.code = #location.location(Location.operationalStatus)
...
* group.element[37].target.display = "location.location(Location.operationalStatus)"
* group.element[37].target.comment = "The operational status is on the Location resource where the implementer must determine which of the Encounter.location(Location) instances reflect the Bed or Room and apply it to the most granular available."
* group.element[37].target.dependsOn[0].property = "vocabulary-map"
* group.element[37].target.dependsOn[0].value = "BedStatus"
* group.element[37].target.product[0].property = "antlr"
* group.element[37].target.product[0].value = "IF PV1-3.2 OR PV1-3.3 VALUED"
* group.element[38].code = #PV1-42
...
* group.element[38].display = "Pending Location"
* group.element[38].target.equivalence = #equivalent
* group.element[38].target.code = #location[4]
...
* group.element[38].target.extension[0].extension[0].valueCode = #"Backbone"
...
* group.element[38].target.display = "location[4]"
...
* group.element[39].target.code = #location[5]
...
* group.element[39].target.extension[0].extension[0].valueCode = #"Backbone"
...
* group.element[39].target.display = "location[5]"
* group.element[39].target.dependsOn[0].property = "data-type-map"
* group.element[39].target.dependsOn[0].value = "PL[Location]"
...
* group.element[40].target.code = #period.start
...
* group.element[40].target.display = "period.start"
...
* group.element[41].target.code = #period.end
...
* group.element[41].target.display = "period.end"
...
* group.element[42].target.code = #status
...
* group.element[43].target.code = #identifier[2]
...
* group.element[43].target.display = "identifier[2]"
* group.element[43].target.dependsOn[0].property = "data-type-map"
* group.element[43].target.dependsOn[0].value = "CX[Identifier]"
...
* group.element[44].target.code = #participant[5].individual(Practitioner)
...
* group.element[44].target.display = "participant[5].individual(Practitioner)"
...
* group.element[45].target.code = #participant[5].type.coding.code
...
* group.element[46].target.code = #participant[5].type.coding.system
...
* group.element[46].target.display = "participant[5].type.coding.system"
...
* group.element[47].target.code = #participant[5].type.text
...
* group.element[48].target.code = #episodeOfCare(EpisodeOfCare[1].identifier)
...
* group.element[48].target.display = "episodeOfCare(EpisodeOfCare[1].identifier)"
* group.element[48].target.dependsOn[0].property = "data-type-map"
* group.element[48].target.dependsOn[0].value = "CX[Identifier]"
