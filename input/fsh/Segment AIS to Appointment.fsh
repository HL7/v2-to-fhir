...
* group[0].element[0].target.code = #serviceType
...
* group[0].element[0].target.display = "serviceType"
...
* group[0].element[2].target.extension[0].extension[0].valueString = "/.start + AIS-5 according to AIS-6 units/"
...
* group[0].element[3].target.extension[0].extension[0].valueString = "Appointment.participant.period.start + AIS-7"
...
* group[0].element[4].display = "Filler Status Code"
* group[0].element[4].target.equivalence = #equivalent
* group[0].element[4].target.code = #status
...
* group[0].element[4].target.extension[0].extension[3].valueUrl = "ConceptMap/table-hl70278-to-appointmentstatus"
* group[0].element[4].target.display = "status"
