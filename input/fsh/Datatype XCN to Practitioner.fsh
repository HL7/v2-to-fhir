...
Title: "Datatype XCNnull to Practitioner Map"
* title = "Datatype XCNnull to Practitioner Map"
...
* group.element[10].target.code = #identifier[1].extension[1].url
...
* group.element[10].target.display = "identifier[1].extension[1].url"
...
* group.element[11].target.code = #identifier[1].extension[1].valueString
...
* group.element[11].target.display = "identifier[1].extension[1].valueString"
...
* group.element[12].target.code = #identifier[1].extension[2].url
...
* group.element[12].target.display = "identifier[1].extension[2].url"
* group.element[12].target.dependsOn[0].property = "value"
* group.element[12].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/namingsystem-checkDigit\""
...
* group.element[13].target.code = #identifier[1].extension[2].valueString
...
* group.element[13].target.display = "identifier[1].extension[2].valueString"
...
* group.element[14].target.code = #identifier[1].type.coding.code
...
* group.element[14].target.display = "identifier[1].type.coding.code"
* group.element[14].target.dependsOn[0].property = "vocabulary-map"
* group.element[14].target.dependsOn[0].value = "IDType"
...
* group.element[15].target.code = #name.period
...
* group.element[15].target.dependsOn[0].value = "DR[Period]"
* group.element[15].target.product[0].property = "antlr"
* group.element[15].target.product[0].value = "IF XCN.19 DOES NOT EXIST AND IF XCN.20 DOES NOT EXIST"
...
* group.element[16].target.code = #name.family.extension.url
...
* group.element[16].target.display = "name.family.extension.url"
* group.element[16].target.dependsOn[0].property = "value"
* group.element[16].target.dependsOn[0].value = "\"http://hl7.org/fhir/R4/extension-humanname-assembly-order.html\""
...
* group.element[17].target.code = #name.family.extension.valueCode
...
* group.element[17].target.display = "name.family.extension.valueCode"
* group.element[17].target.dependsOn[0].property = "vocabulary-map"
* group.element[17].target.dependsOn[0].value = "NameAssemblyOrder"
...
* group.element[18].target.code = #name.period.start
...
* group.element[18].target.display = "name.period.start"
...
* group.element[19].target.code = #name.period.end
...
* group.element[19].target.display = "name.period.end"
...
* group.element[20].target.code = #name.suffix
...
* group.element[20].target.display = "name.suffix"
