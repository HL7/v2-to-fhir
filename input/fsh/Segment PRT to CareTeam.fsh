...
* group.element[1].target.dependsOn[0].value = "IF PRT-6 IS NOT VALUED"
* group.element[1].target.dependsOn[0].display = "IF PRT-6 IS NOT VALUED"
...
* group.element[2].target.dependsOn[0].value = "IF PRT-6 IS NOT VALUED"
* group.element[2].target.dependsOn[0].display = "IF PRT-6 IS NOT VALUED"
...
* group.element[3].target.dependsOn[0].value = "IF PRT-6 IS VALUED"
* group.element[3].target.dependsOn[0].display = "IF PRT-6 IS VALUED"
...
* group.element[5].target.dependsOn[0].value = "IF PRT-5 AND PRT-6 AREA NOT VALUED"
* group.element[5].target.dependsOn[0].display = "IF PRT-5 AND PRT-6 AREA NOT VALUED"
...
* group.element[6].target.dependsOn[0].value = "IF PRT-5 OR PRT-6 IS VALUED"
* group.element[6].target.dependsOn[0].display = "IF PRT-5 OR PRT-6 IS VALUED"
...
* group.element[9].target.dependsOn[0].value = "IF PRT-6 IS NOT VALUED"
* group.element[9].target.dependsOn[0].display = "IF PRT-6 IS NOT VALUED"
...
* group.element[10].target.dependsOn[0].value = "IF PRT-6 IS NOT VALUED"
* group.element[10].target.dependsOn[0].display = "IF PRT-6 IS NOT VALUED"
...
* group.element[11].target.dependsOn[0].value = "IF PRT-6 IS VALUED"
* group.element[11].target.dependsOn[0].display = "IF PRT-6 IS VALUED"
...
* group.element[12].target.dependsOn[0].value = "IF PRT-5 AND PRT-6 AREA NOT VALUED"
* group.element[12].target.dependsOn[0].display = "IF PRT-5 AND PRT-6 AREA NOT VALUED"
...
* group.element[13].target.dependsOn[0].value = "IF PRT-5 OR PRT-6 IS VALUED"
* group.element[13].target.dependsOn[0].display = "IF PRT-5 OR PRT-6 IS VALUED"
...
* group.element[14].target.dependsOn[0].value = "IF PRT-6 IS NOT VALUED"
* group.element[14].target.dependsOn[0].display = "IF PRT-6 IS NOT VALUED"
...
* group.element[15].target.dependsOn[0].value = "IF PRT-6 IS NOT VALUED"
* group.element[15].target.dependsOn[0].display = "IF PRT-6 IS NOT VALUED"
...
* group.element[16].target.dependsOn[0].value = "IF PRT-6 IS VALUED"
* group.element[16].target.dependsOn[0].display = "IF PRT-6 IS VALUED"
...
* group.element[17].target.dependsOn[0].value = "IF PRT-5 AND PRT-6 AREA NOT VALUED"
* group.element[17].target.dependsOn[0].display = "IF PRT-5 AND PRT-6 AREA NOT VALUED"
...
* group.element[18].target.dependsOn[0].value = "IF PRT-5 OR PRT-6 IS VALUED"
* group.element[18].target.dependsOn[0].display = "IF PRT-5 OR PRT-6 IS VALUED"
