...
* group.element[2].target.dependsOn[0].value = "OG[Extension-Subidentifier]"
* group.element[2].target.product[0].property = "narrative"
* group.element[2].target.product[0].value = "Map to Observation.partOf or Observation.hasMember or Observation.DerivedFrom according to the implementation guidance for the v2 message at hand, otherwise map to the extension-sub-id to enable the final destination to determine how to structure the observations."
...
* group.element[3].target.dependsOn[0].value = "NM[Quantity]"
* group.element[3].target.product[0].property = "antlr"
* group.element[3].target.product[0].value = "IF OBX-2 EQUALS \"NM\""
...
* group.element[4].target.product[0].value = "IF OBX-2 IN (\"ST\", \"FT\", \"TX\")"
* group.element[4].target.product[1].property = "narrative"
* group.element[4].target.product[1].value = "Any markup in ST, FT or TX data may not present properly given that valueString is a string data type"
...
* group.element[5].target.dependsOn[0].value = "CF[CodeableConcept]"
* group.element[5].target.product[0].property = "antlr"
* group.element[5].target.product[0].value = "IF OBX-2 EQUALS \"CF\""
...
* group.element[6].target.dependsOn[0].value = "CNE[CodeableConcept]"
* group.element[6].target.product[0].property = "antlr"
* group.element[6].target.product[0].value = "IF OBX-2 EQUALS \"CNE\""
...
* group.element[7].target.dependsOn[0].value = "CE[CodeableConcept]"
* group.element[7].target.product[0].property = "antlr"
* group.element[7].target.product[0].value = "IF OBX-2 EQUALS \"CE\""
...
* group.element[8].target.product[0].value = "IF OBX-2 EQUALS \"CWE\""
...
* group.element[9].target.dependsOn[0].value = "IS[CodeableConcept]"
* group.element[9].target.product[0].property = "antlr"
* group.element[9].target.product[0].value = "IF OBX-2 EQUALS \"IS\""
...
* group.element[10].target.product[0].value = "IF OBX-2 EQUALS \"DR\""
...
* group.element[11].target.product[0].value = "IF OBX-2 IN (\"DTM\", \"DT\")"
...
* group.element[12].target.dependsOn[0].value = "NR[Range]"
* group.element[12].target.product[0].property = "antlr"
* group.element[12].target.product[0].value = "IF OBX-2 EQUALS \"NR\""
...
* group.element[13].target.dependsOn[0].value = "OBX-5.1+\"-\"+OBX-5.2"
* group.element[13].target.product[0].property = "antlr"
* group.element[13].target.product[0].value = "IF OBX-2 EQUALS \"VR\""
...
* group.element[14].target.product[0].value = "IF OBX-2 EQUALS \"TM\""
...
* group.element[15].target.code = #component[each].valueRatio
...
* group.element[15].target.display = "component[each].valueRatio"
...
* group.element[15].target.product[0].value = "IF (OBX-2 EQUALS \"SN\" AND OBX-5.3 IN (\":\", \"/\")"
...
* group.element[16].target.code = #component[each].valueRange
...
* group.element[16].target.display = "component[each].valueRange"
...
* group.element[17].target.code = #component[each].valueString
...
* group.element[17].target.display = "component[each].valueString"
* group.element[17].target.dependsOn[0].property = "value"
* group.element[17].target.dependsOn[0].value = "OBX-5.1+\"\"+OBX-5.2+\"\"+OBX-5.3+\"\"+OBX-5.4"
...
* group.element[18].target.code = #component[each].valueQuantity
...
* group.element[18].target.display = "component[each].valueQuantity"
...
* group.element[18].target.product[0].value = "IF OBX-2 EQUALS \"SN\" and OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[19].target.code = #component[each].valueSampledData
...
* group.element[19].target.display = "component[each].valueSampledData"
* group.element[19].target.comment = "Need to add text on converting from NA to SampledData"
...
* group.element[20].target.code = #component[each].extension[1].url
...
* group.element[20].target.display = "component[each].extension[1].url"
* group.element[20].target.comment = "Some implementers may include in OBX-5 the documentation that the other OBX-5 components are derived from.  In that situations"
...
* group.element[20].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation included"
...
* group.element[21].target.code = #component[each].extension[1].valueAttachment
...
* group.element[21].target.display = "component[each].extension[1].valueAttachment"
...
* group.element[21].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation included"
...
* group.element[22].target.code = #derivedFrom(DocumentReference)
...
* group.element[22].target.extension[0].extension[0].valueCode = #"Reference"
* group.element[22].target.display = "derivedFrom(DocumentReference)"
* group.element[22].target.dependsOn[0].property = "data-type-map"
* group.element[22].target.dependsOn[0].value = "ED[DocumentReference]"
...
* group.element[22].target.product[1].value = "And if other observation in OBX-5 are derived from the documentation included"
...
* group.element[23].target.code = #component[each].extension[1].url
...
* group.element[23].target.display = "component[each].extension[1].url"
...
* group.element[23].target.product[1].property = "narrative"
* group.element[23].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation referenced"
...
* group.element[24].target.code = #component[each].extension[1].valueAttachment
...
* group.element[24].target.display = "component[each].extension[1].valueAttachment"
...
* group.element[24].target.dependsOn[0].value = "RP[Attachment]"
* group.element[24].target.product[0].property = "antlr"
* group.element[24].target.product[0].value = "IF OBX-2 EQUALS \"RP\""
* group.element[24].target.product[1].property = "narrative"
* group.element[24].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation referenced"
...
* group.element[25].target.code = #derivedFrom(DocumentReference)
...
* group.element[25].target.extension[0].extension[0].valueCode = #"Reference"
* group.element[25].target.display = "derivedFrom(DocumentReference)"
* group.element[25].target.dependsOn[0].property = "data-type-map"
* group.element[25].target.dependsOn[0].value = "RP[DocumentReference]"
* group.element[25].target.product[0].property = "antlr"
* group.element[25].target.product[0].value = "IF OBX-2 EQUALS \"RP\""
* group.element[25].target.product[1].property = "narrative"
* group.element[25].target.product[1].value = "And if other observation in OBX-5 are derived from the documentation being referenced"
...
* group.element[26].target.code = #component[each].valueQuantity
...
* group.element[26].target.display = "component[each].valueQuantity"
...
* group.element[26].target.product[0].value = "IF OBX-2 EQUALS \"SN\" and OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[27].target.product[0].value = "IF OBX-2 IN (\"NA\", \"NM\")"
...
* group.element[28].target.code = #component[each].valueRange.low
...
* group.element[28].target.display = "component[each].valueRange.low"
...
* group.element[28].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[29].target.code = #component[each].valueRange.high
...
* group.element[29].target.display = "component[each].valueRange.high"
...
* group.element[29].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[30].target.code = #component[each].valueRatio.numerator
...
* group.element[30].target.display = "component[each].valueRatio.numerator"
...
* group.element[30].target.product[0].value = "IF (OBX-2 EQUALS \"SN\" AND (OBX-5.3 IN (\":\", \"/\"))"
...
* group.element[31].target.code = #component[each].valueRatio.denominator
...
* group.element[31].target.display = "component[each].valueRatio.denominator"
* group.element[31].target.dependsOn[0].property = "data-type-map"
* group.element[31].target.dependsOn[0].value = "CWE[Quantity]"
* group.element[31].target.product[0].property = "antlr"
* group.element[31].target.product[0].value = "IF (OBX-2 EQUALS \"SN\" AND (OBX-5.3 IN (\":\", \"/\"))"
* group.element[32].code = #OBX-7
...
* group.element[32].display = "References Range"
* group.element[32].target.equivalence = #equivalent
* group.element[32].target.code = #component[each].referenceRange.text
* group.element[32].target.display = "component[each].referenceRange.text"
* group.element[32].target.comment = "If OBX-7 is sufficiently parseable, then the low, high, type, appliesTo, and/or age may be used."
* group.element[33].code = #OBX-8
...
* group.element[33].display = "Interpretation Codes"
* group.element[33].target.equivalence = #equivalent
* group.element[33].target.code = #interpretation
...
* group.element[33].target.display = "interpretation"
...
* group.element[33].target.dependsOn[1].value = "InterpretationCode"
...
* group.element[34].target.code = #extension[2].uri
...
* group.element[34].target.display = "extension[2].uri"
* group.element[34].target.dependsOn[0].property = "value"
* group.element[34].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-nature-of-abnormal-test\""
...
* group.element[35].target.code = #extension[2].valueCodeableConcept
...
* group.element[35].target.display = "extension[2].valueCodeableConcept"
* group.element[35].target.dependsOn[0].property = "data-type-map"
* group.element[35].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[35].target.dependsOn[1].property = "vocabulary-map"
* group.element[35].target.dependsOn[1].value = "NatureOfAbnormalTesting"
...
* group.element[36].target.code = #status
...
* group.element[36].target.display = "status"
* group.element[36].target.dependsOn[0].property = "vocabulary-map"
* group.element[36].target.dependsOn[0].value = "ObservationStatus"
...
* group.element[38].target.dependsOn[0].value = "XCN[PractitionerRole]"
...
* group.element[41].target.comment = "The cardinality of Observation.method is 0..1 while the source allows for multiple methods.  As we are not aware of anybody populating multiples in HL7 v2, we did not provide further mapping guidance.  If you need to support multiples, please submit a gForge to OO for the HL7 v2 to FHIR mapping Implementation Guide."
...
* group.element[42].target.code = #device(Device.identifier)
...
* group.element[42].target.display = "device(Device.identifier)"
...
* group.element[43].display = "Date/Time of the Analysis"
* group.element[43].target.equivalence = #equivalent
* group.element[43].target.code = #extension[1].url
...
* group.element[43].target.display = "extension[1].url"
* group.element[43].target.comment = "\"http://hl7.org/fhir/StructureDefinition/observation-analysis-date-time\""
* group.element[44].code = #OBX-19
...
* group.element[44].display = "Date/Time of the Analysis"
* group.element[44].target.equivalence = #equivalent
* group.element[44].target.code = #extension[1].valueDateTime
...
* group.element[44].target.display = "extension[1].valueDateTime"
* group.element[45].code = #OBX-20
...
* group.element[45].display = "Observation Site"
* group.element[45].target.equivalence = #equivalent
* group.element[45].target.code = #bodySite
...
* group.element[46].display = "Observation Instance Identifier"
* group.element[46].target.equivalence = #equivalent
* group.element[46].target.code = #identifier
...
* group.element[46].target.display = "identifier"
...
* group.element[47].display = "Observation Instance Identifier"
* group.element[47].target.equivalence = #equivalent
* group.element[47].target.code = #identifier.type.coding.code
...
* group.element[47].target.extension[0].extension[0].valueCode = #"code"
...
* group.element[47].target.display = "identifier.type.coding.code"
* group.element[47].target.dependsOn[0].property = "value"
* group.element[47].target.dependsOn[0].value = "\"FILL\""
* group.element[48].code = #OBX-23
...
* group.element[48].extension[0].extension[0].valueCode = #"XON"
...
* group.element[48].display = "Performing Organization Name"
* group.element[48].target.equivalence = #equivalent
* group.element[48].target.code = #performer[2](Organization)
...
* group.element[48].target.extension[0].extension[0].valueCode = #"Reference(Organization)"
...
* group.element[48].target.display = "performer[2](Organization)"
* group.element[48].target.dependsOn[0].property = "data-type-map"
* group.element[48].target.dependsOn[0].value = "XON[Organization]"
* group.element[49].code = #OBX-23
...
* group.element[49].extension[0].extension[0].valueCode = #"XON"
...
* group.element[49].display = "Performing Organization Name"
* group.element[49].target.equivalence = #equivalent
* group.element[49].target.code = #performer[2](PractitionerRole.organization(Organization))
...
* group.element[49].target.extension[0].extension[0].valueCode = #"Reference(Organization)"
...
* group.element[49].target.display = "performer[2](PractitionerRole.organization(Organization))"
* group.element[49].target.dependsOn[0].property = "data-type-map"
* group.element[49].target.dependsOn[0].value = "XON[Organization]"
* group.element[49].target.product[0].property = "antlr"
* group.element[49].target.product[0].value = "IF OBX-25 VALUED"
* group.element[50].code = #OBX-24
...
* group.element[50].extension[0].extension[0].valueCode = #"XAD"
...
* group.element[50].display = "Performing Organization Address"
* group.element[50].target.equivalence = #equivalent
* group.element[50].target.code = #performer[2](Organization.address)
...
* group.element[50].target.extension[0].extension[0].valueCode = #"Address"
...
* group.element[50].target.display = "performer[2](Organization.address)"
* group.element[50].target.dependsOn[0].property = "data-type-map"
* group.element[50].target.dependsOn[0].value = "XAD[Address]"
* group.element[51].code = #OBX-24
...
* group.element[51].extension[0].extension[0].valueCode = #"XAD"
...
* group.element[51].display = "Performing Organization Address"
* group.element[51].target.equivalence = #equivalent
* group.element[51].target.code = #performer[2](PractitionerRole.organization(Organization.address))
...
* group.element[51].target.extension[0].extension[0].valueCode = #"Address"
...
* group.element[51].target.display = "performer[2](PractitionerRole.organization(Organization.address))"
* group.element[51].target.dependsOn[0].property = "data-type-map"
* group.element[51].target.dependsOn[0].value = "XAD[Address]"
...
* group.element[52].target.code = #performer[2](PractitionerRole)
...
* group.element[52].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[52].target.display = "performer[2](PractitionerRole)"
* group.element[52].target.dependsOn[0].property = "data-type-map"
* group.element[52].target.dependsOn[0].value = "XCN[PractitionerRole]"
* group.element[53].code = #OBX-25
...
* group.element[53].display = "Performing Organization Medical Director"
* group.element[53].target.equivalence = #equivalent
* group.element[53].target.code = #performer[2](PractitionerRole.code.coding.value)
...
* group.element[53].target.extension[0].extension[0].valueCode = #"string"
* group.element[53].target.display = "performer[2](PractitionerRole.code.coding.value)"
* group.element[53].target.dependsOn[0].property = "value"
* group.element[53].target.dependsOn[0].value = "\"MDIR\""
...
* group.element[54].target.code = #performer[2](PractitionerRole.code.coding.system)
...
* group.element[54].target.display = "performer[2](PractitionerRole.code.coding.system)"
* group.element[54].target.dependsOn[0].property = "value"
* group.element[54].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0912\""
...
* group.element[55].target.code = #extension[1].uri
...
* group.element[56].target.code = #extension[1].valueReference(Group.member.entity(Specimen.identifier[1])
* group.element[56].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[56].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[56].target.extension[0].extension[0].valueInteger = 0
* group.element[56].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[56].target.extension[0].extension[1].valueInteger = 1
* group.element[56].target.display = "extension[1].valueReference(Group.member.entity(Specimen.identifier[1])"
...
* group.element[57].target.code = #extension[2].uri
* group.element[57].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[57].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[57].target.extension[0].extension[0].valueInteger = 0
* group.element[57].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[57].target.extension[0].extension[1].valueInteger = 1
* group.element[57].target.display = "extension[2].uri"
...
* group.element[58].target.code = #extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))
...
* group.element[58].target.display = "extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))"
...
* group.element[59].target.code = #specimen(Specimen.identifier[1])
...
* group.element[59].target.extension[0].extension[0].valueCode = #"Identifier"
* group.element[59].target.display = "specimen(Specimen.identifier[1])"
* group.element[59].target.dependsOn[0].property = "data-type-map"
* group.element[59].target.dependsOn[0].value = "EIP[Identifier-PlacerAssignedIdentifier]"
...
* group.element[60].target.code = #specimen(Specimen.identifier[2])
...
* group.element[60].target.extension[0].extension[0].valueCode = #"Identifier"
* group.element[60].target.display = "specimen(Specimen.identifier[2])"
* group.element[60].target.dependsOn[0].property = "data-type-map"
* group.element[60].target.dependsOn[0].value = "EIP[Identifier-FillerAssignedIdentifier]"
