...
* group.element[19].target.comment = "Some implementers may include in OBX-5 the documentation that the other OBX-5 components are derived from.  In that situations"
...
* group.element[19].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation included"
...
* group.element[21].target.code = #derivedFrom(DocumentReference)
...
* group.element[21].target.extension[0].extension[0].valueCode = #"Reference"
* group.element[21].target.display = "derivedFrom(DocumentReference)"
* group.element[21].target.dependsOn[0].property = "data-type-map"
* group.element[21].target.dependsOn[0].value = "ED[DocumentReference]"
...
* group.element[21].target.product[1].value = "And if other observation in OBX-5 are derived from the documentation included"
...
* group.element[22].target.code = #component[each].extension[1].url
...
* group.element[22].target.display = "component[each].extension[1].url"
...
* group.element[22].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation referenced"
...
* group.element[23].target.code = #component[each].extension[1].valueAttachment
...
* group.element[23].target.display = "component[each].extension[1].valueAttachment"
...
* group.element[23].target.dependsOn[0].value = "RP[Attachment]"
...
* group.element[24].target.code = #derivedFrom(DocumentReference)
...
* group.element[24].target.extension[0].extension[0].valueCode = #"Reference"
* group.element[24].target.display = "derivedFrom(DocumentReference)"
* group.element[24].target.dependsOn[0].property = "data-type-map"
* group.element[24].target.dependsOn[0].value = "RP[DocumentReference]"
...
* group.element[24].target.product[1].value = "And if other observation in OBX-5 are derived from the documentation being referenced"
...
* group.element[25].target.code = #component[each].valueQuantity
...
* group.element[25].target.display = "component[each].valueQuantity"
...
* group.element[25].target.product[0].value = "IF OBX-2 EQUALS \"SN\" and OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[26].target.product[0].value = "IF OBX-2 IN (\"NA\", \"NM\")"
...
* group.element[27].target.code = #component[each].valueRange.low
...
* group.element[27].target.display = "component[each].valueRange.low"
...
* group.element[28].target.code = #component[each].valueRange.high
...
* group.element[28].target.display = "component[each].valueRange.high"
...
* group.element[29].target.code = #component[each].valueRatio.numerator
...
* group.element[29].target.display = "component[each].valueRatio.numerator"
...
* group.element[30].target.code = #component[each].valueRatio.denominator
...
* group.element[30].target.display = "component[each].valueRatio.denominator"
...
* group.element[31].target.code = #component[each].referenceRange.text
* group.element[31].target.display = "component[each].referenceRange.text"
...
* group.element[36].extension[0].extension[0].valueCode = #"DTM"
...
* group.element[36].display = "Date/Time of the Observation"
* group.element[36].target.equivalence = #equivalent
* group.element[36].target.code = #effectiveDateTime
...
* group.element[36].target.extension[0].extension[0].valueCode = #"dateTime"
...
* group.element[36].target.display = "effectiveDateTime"
...
* group.element[37].target.code = #performer[1](PractitionerRole.practitioner(Practitioner))
...
* group.element[37].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[37].target.display = "performer[1](PractitionerRole.practitioner(Practitioner))"
* group.element[37].target.dependsOn[0].property = "data-type-map"
* group.element[37].target.dependsOn[0].value = "XCN[PractitionerRole]"
...
* group.element[38].target.code = #performer[1](PractitionerRole.code.coding.code)
...
* group.element[38].target.display = "performer[1](PractitionerRole.code.coding.code)"
* group.element[38].target.dependsOn[0].property = "value"
* group.element[38].target.dependsOn[0].value = "\"responsibleObserver\""
...
* group.element[39].target.code = #performer[1](PractitionerRole.code.coding.system)
...
* group.element[39].target.display = "performer[1](PractitionerRole.code.coding.system)"
* group.element[39].target.dependsOn[0].property = "value"
* group.element[39].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/practitioner-role\""
* group.element[40].code = #OBX-17
...
* group.element[40].display = "Observation Method"
* group.element[40].target.equivalence = #equivalent
* group.element[40].target.code = #method
...
* group.element[41].display = "Equipment Instance Identifier"
* group.element[41].target.equivalence = #equivalent
* group.element[41].target.code = #device(Device.identifier)
...
* group.element[41].target.display = "device(Device.identifier)"
* group.element[41].target.dependsOn[0].property = "data-type-map"
* group.element[41].target.dependsOn[0].value = "EI[Identifier-Extension]"
* group.element[42].code = #OBX-19
...
* group.element[42].display = "Date/Time of the Analysis"
* group.element[42].target.equivalence = #equivalent
* group.element[42].target.code = #extension[1].url
...
* group.element[42].target.extension[0].extension[0].valueCode = #"uri"
...
* group.element[42].target.display = "extension[1].url"
* group.element[42].target.comment = "\"http://hl7.org/fhir/StructureDefinition/observation-analysis-date-time\""
...
* group.element[43].target.code = #extension[1].valueDateTime
...
* group.element[43].target.display = "extension[1].valueDateTime"
* group.element[44].code = #OBX-20
...
* group.element[44].display = "Observation Site"
* group.element[44].target.equivalence = #equivalent
* group.element[44].target.code = #bodySite
...
* group.element[44].target.display = "bodySite"
* group.element[44].target.comment = "The cardinality of Observation.bodySite is 0..1 while the source allows for multiple body sites.  As we are not aware of anybody populating multiples in HL7 v2, we did not provide further mapping guidance.  If you need to support multiples, please submit a gForge to OO for the HL7 v2 to FHIR mapping Implementation Guide."
...
* group.element[45].target.code = #identifier
...
* group.element[45].target.display = "identifier"
...
* group.element[46].target.code = #identifier.type.coding.code
...
* group.element[46].target.display = "identifier.type.coding.code"
* group.element[46].target.dependsOn[0].property = "value"
* group.element[46].target.dependsOn[0].value = "\"FILL\""
...
* group.element[47].target.code = #performer[2](Organization)
...
* group.element[47].target.display = "performer[2](Organization)"
...
* group.element[48].target.code = #performer[2](PractitionerRole.organization(Organization))
...
* group.element[48].target.display = "performer[2](PractitionerRole.organization(Organization))"
...
* group.element[49].target.code = #performer[2](Organization.address)
...
* group.element[49].target.display = "performer[2](Organization.address)"
...
* group.element[50].target.code = #performer[2](PractitionerRole.organization(Organization.address))
...
* group.element[50].target.display = "performer[2](PractitionerRole.organization(Organization.address))"
...
* group.element[50].target.product[0].value = "IF OBX-25 VALUED"
...
* group.element[51].target.code = #performer[2](PractitionerRole)
...
* group.element[51].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[51].target.display = "performer[2](PractitionerRole)"
* group.element[51].target.dependsOn[0].property = "data-type-map"
* group.element[51].target.dependsOn[0].value = "XCN[PractitionerRole]"
...
* group.element[52].target.code = #performer[2](PractitionerRole.code.coding.value)
...
* group.element[52].target.extension[0].extension[0].valueCode = #"string"
* group.element[52].target.display = "performer[2](PractitionerRole.code.coding.value)"
* group.element[52].target.dependsOn[0].property = "value"
* group.element[52].target.dependsOn[0].value = "\"MDIR\""
...
* group.element[53].target.code = #performer[2](PractitionerRole.code.coding.system)
...
* group.element[53].target.extension[0].extension[0].valueCode = #"uri"
* group.element[53].target.display = "performer[2](PractitionerRole.code.coding.system)"
* group.element[53].target.dependsOn[0].property = "value"
* group.element[53].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0912\""
...
* group.element[54].target.code = #extension[1].uri
...
* group.element[55].target.code = #extension[1].valueReference(Group.member.entity(Specimen.identifier[1])
...
* group.element[55].target.display = "extension[1].valueReference(Group.member.entity(Specimen.identifier[1])"
...
* group.element[56].target.code = #extension[2].uri
...
* group.element[56].target.display = "extension[2].uri"
* group.element[56].target.dependsOn[0].property = "value"
* group.element[56].target.dependsOn[0].value = "\"http://hl7.org/fhir/5.0/StructureDefinition/extension-Observation.specimen"
...
* group.element[57].target.code = #extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))
...
* group.element[57].target.display = "extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))"
...
* group.element[58].target.code = #specimen(Specimen.identifier[1])
...
* group.element[58].target.display = "specimen(Specimen.identifier[1])"
* group.element[58].target.dependsOn[0].property = "data-type-map"
* group.element[58].target.dependsOn[0].value = "EIP[Identifier-PlacerAssignedIdentifier]"
...
* group.element[59].target.code = #specimen(Specimen.identifier[2])
...
* group.element[59].target.display = "specimen(Specimen.identifier[2])"
* group.element[59].target.dependsOn[0].property = "data-type-map"
* group.element[59].target.dependsOn[0].value = "EIP[Identifier-FillerAssignedIdentifier]"
