...
* group.element[15].target.dependsOn[0].value = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
* group.element[15].target.product[0].property = "antlr"
* group.element[15].target.product[0].value = "IF (OBX-2 EQUALS \"SN\"  AND OBX-5.1  EQUALS \"<>\""
...
* group.element[16].target.dependsOn[0].value = "SN[Ratio]"
* group.element[16].target.product[0].property = "antlr"
* group.element[16].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
...
* group.element[17].target.dependsOn[0].value = "SN[Range]"
...
* group.element[18].target.dependsOn[0].value = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
* group.element[18].target.product[0].property = "antlr"
* group.element[18].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"+\""
...
* group.element[19].target.dependsOn[0].value = "SN[Quantity]"
* group.element[19].target.product[0].property = "antlr"
* group.element[19].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[20].target.dependsOn[0].value = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
* group.element[20].target.product[0].property = "narrative"
* group.element[20].target.product[0].value = "If line 19 through 23 all fail while OBX-2 = SN"
...
* group.element[21].target.code = #component[each].valueSampledData
...
* group.element[21].target.extension[0].extension[0].valueCode = #"SampledData"
...
* group.element[21].target.display = "component[each].valueSampledData"
* group.element[21].target.comment = "Need to add text on converting from NA to SampledData"
* group.element[21].target.product[0].property = "antlr"
* group.element[21].target.product[0].value = "IF OBX-2 EQUALS \"NA\""
...
* group.element[22].target.comment = "Some implementers may include in OBX-5 the documentation that the other OBX-5 components are derived from.  In that situations"
...
* group.element[22].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation included"
...
* group.element[23].target.comment = "We are for now addressing Base64 that cover .pdf, pictures and other binaries.  If somebody does this, we will address those."
...
* group.element[23].target.product[0].value = "IF OBX-2 EQUALS \"ED\" AND IF OBX-5.4 EQUALS \"Base64\""
* group.element[23].target.product[1].property = "narrative"
* group.element[23].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation included"
...
* group.element[24].target.dependsOn[0].value = "ED[DocumentReference]"
* group.element[24].target.product[0].property = "antlr"
* group.element[24].target.product[0].value = "IF OBX-2 EQUALS \"ED\" AND IF OBX-5.4 EQUALS \"Base64\""
* group.element[24].target.product[1].property = "narrative"
* group.element[24].target.product[1].value = "And if other observation in OBX-5 are derived from the documentation included"
...
* group.element[25].target.code = #component[each].extension[1].url
...
* group.element[25].target.display = "component[each].extension[1].url"
* group.element[25].target.dependsOn[0].property = "value"
* group.element[25].target.dependsOn[0].value = "\"https://hl7.org/fhir/R5/StructureDefinition/extension-Observation.valueAttachment"
...
* group.element[25].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation referenced"
...
* group.element[26].target.code = #component[each].extension[1].valueAttachment
...
* group.element[26].target.extension[0].extension[0].valueCode = #"Attachment"
...
* group.element[26].target.display = "component[each].extension[1].valueAttachment"
* group.element[26].target.comment = "To be resolved when we resolve DocumentReference and valueAttachment"
* group.element[26].target.dependsOn[0].property = "data-type-map"
* group.element[26].target.dependsOn[0].value = "RP[Attachment]"
* group.element[26].target.product[0].property = "antlr"
* group.element[26].target.product[0].value = "IF OBX-2 EQUALS \"RP\""
* group.element[26].target.product[1].property = "narrative"
* group.element[26].target.product[1].value = "If none of the other observations in OBX-5 are not derived from the documentation referenced"
* group.element[27].code = #OBX-5
...
* group.element[27].extension[0].extension[0].valueCode = #"varies"
...
* group.element[27].display = "Observation Value"
* group.element[27].target.equivalence = #equivalent
* group.element[27].target.code = #derivedFrom(DocumentReference)
...
* group.element[27].target.extension[0].extension[0].valueCode = #"Reference"
* group.element[27].target.display = "derivedFrom(DocumentReference)"
* group.element[27].target.dependsOn[0].property = "data-type-map"
* group.element[27].target.dependsOn[0].value = "RP[DocumentReference]"
* group.element[27].target.product[0].property = "antlr"
* group.element[27].target.product[0].value = "IF OBX-2 EQUALS \"RP\""
* group.element[27].target.product[1].property = "narrative"
* group.element[27].target.product[1].value = "And if other observation in OBX-5 are derived from the documentation being referenced"
...
* group.element[28].target.code = #component[each].valueQuantity
...
* group.element[28].target.display = "component[each].valueQuantity"
...
* group.element[28].target.product[0].value = "IF OBX-2 IN (\"NA\", \"NM\")"
...
* group.element[29].target.code = #component[each].valueQuantity[1]
...
* group.element[29].target.display = "component[each].valueQuantity[1]"
* group.element[29].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[29].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[30].target.code = #component[each].valueRange[1].low
...
* group.element[30].target.display = "component[each].valueRange[1].low"
...
* group.element[30].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[31].target.code = #component[each].valueRange[1].high
...
* group.element[31].target.extension[0].extension[0].valueCode = #"SimpleQuantity"
* group.element[31].target.display = "component[each].valueRange[1].high"
...
* group.element[31].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[32].target.code = #component[each].valueRatio[1].numerator
...
* group.element[32].target.display = "component[each].valueRatio[1].numerator"
* group.element[32].target.dependsOn[0].property = "data-type-map"
* group.element[32].target.dependsOn[0].value = "CWE[Quantity]"
* group.element[32].target.product[0].property = "antlr"
* group.element[32].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
* group.element[33].code = #OBX-6
...
* group.element[33].display = "Units"
* group.element[33].target.equivalence = #equivalent
* group.element[33].target.code = #component[each].valueRatio[1].denominator
...
* group.element[33].target.extension[0].extension[0].valueCode = #"Quantity"
* group.element[33].target.display = "component[each].valueRatio[1].denominator"
* group.element[33].target.dependsOn[0].property = "data-type-map"
* group.element[33].target.dependsOn[0].value = "CWE[Quantity]"
* group.element[33].target.product[0].property = "antlr"
* group.element[33].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
* group.element[34].code = #OBX-7
...
* group.element[34].extension[0].extension[0].valueCode = #"ST"
...
* group.element[34].display = "References Range"
* group.element[34].target.equivalence = #equivalent
* group.element[34].target.code = #component[each].referenceRange.text
* group.element[34].target.display = "component[each].referenceRange.text"
* group.element[34].target.comment = "If OBX-7 is sufficiently parseable, then the low, high, type, appliesTo, and/or age may be used."
* group.element[35].code = #OBX-8
...
* group.element[35].display = "Interpretation Codes"
* group.element[35].target.equivalence = #equivalent
* group.element[35].target.code = #interpretation
...
* group.element[35].target.display = "interpretation"
...
* group.element[35].target.dependsOn[1].value = "InterpretationCode"
...
* group.element[36].target.code = #extension[2].uri
...
* group.element[36].target.display = "extension[2].uri"
* group.element[36].target.dependsOn[0].property = "value"
* group.element[36].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-nature-of-abnormal-test\""
* group.element[37].code = #OBX-10
...
* group.element[37].display = "Nature of Abnormal Test"
* group.element[37].target.equivalence = #equivalent
* group.element[37].target.code = #extension[2].valueCodeableConcept
...
* group.element[37].target.display = "extension[2].valueCodeableConcept"
* group.element[37].target.dependsOn[0].property = "data-type-map"
* group.element[37].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[37].target.dependsOn[1].property = "vocabulary-map"
* group.element[37].target.dependsOn[1].value = "NatureOfAbnormalTesting"
...
* group.element[38].target.code = #status
...
* group.element[38].target.extension[0].extension[0].valueCode = #"code"
...
* group.element[38].target.display = "status"
* group.element[38].target.dependsOn[0].property = "vocabulary-map"
* group.element[38].target.dependsOn[0].value = "ObservationStatus"
...
* group.element[39].target.dependsOn[0].property = "vocabulary-map"
* group.element[39].target.dependsOn[0].value = "ObservationStatus"
* group.element[39].target.product[0].property = "antlr"
* group.element[39].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[40].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/alternate-codes\""
* group.element[40].target.product[0].property = "antlr"
* group.element[40].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[41].target.dependsOn[0].value = "\"X\""
* group.element[41].target.product[0].property = "antlr"
* group.element[41].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[42].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0085\""
* group.element[42].target.product[0].property = "antlr"
* group.element[42].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[43].extension[0].extension[0].valueCode = #"ID"
...
* group.element[43].target.dependsOn[0].value = "\"not-asked\""
* group.element[43].target.product[0].property = "antlr"
* group.element[43].target.product[0].value = "IF OBX-11 IS \"N\""
...
* group.element[44].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/data-absent-reason\""
* group.element[44].target.product[0].property = "antlr"
* group.element[44].target.product[0].value = "IF OBX-11 IS \"N\""
...
* group.element[46].target.dependsOn[0].value = "XCN[PractitionerRole]"
...
* group.element[47].target.dependsOn[0].value = "\"responsibleObserver\""
...
* group.element[48].target.dependsOn[0].property = "value"
* group.element[48].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/practitioner-role\""
...
* group.element[51].extension[0].extension[0].valueCode = #"DTM"
...
* group.element[53].target.dependsOn[0].value = "CWE[CodeableConcept]"
...
* group.element[54].extension[0].extension[0].valueCode = #"EI"
...
* group.element[54].target.dependsOn[0].value = "EI[Identifier-Extension]"
...
* group.element[55].target.dependsOn[0].value = "\"FILL\""
...
* group.element[56].extension[0].extension[0].valueCode = #"XON"
...
* group.element[56].target.dependsOn[0].value = "XON[Organization]"
...
* group.element[57].target.dependsOn[0].value = "XON[Organization]"
...
* group.element[58].extension[0].extension[0].valueCode = #"XAD"
...
* group.element[58].target.dependsOn[0].value = "XAD[Address]"
...
* group.element[59].target.dependsOn[0].value = "XAD[Address]"
* group.element[59].target.product[0].property = "antlr"
* group.element[59].target.product[0].value = "IF OBX-25 VALUED"
...
* group.element[60].target.dependsOn[0].value = "XCN[PractitionerRole]"
...
* group.element[61].extension[0].extension[0].valueCode = #"XCN"
...
* group.element[61].target.dependsOn[0].value = "\"MDIR\""
...
* group.element[62].target.dependsOn[0].property = "value"
* group.element[62].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0912\""
...
* group.element[66].extension[0].extension[0].valueCode = #"ID"
...
* group.element[67].target.dependsOn[0].property = "value"
* group.element[67].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-structure-type\""
...
* group.element[70].target.dependsOn[0].property = "value"
* group.element[70].target.dependsOn[0].value = "\"http://hl7.org/fhir/5.0/StructureDefinition/extension-Observation.specimen"
...
* group.element[72].extension[0].extension[0].valueCode = #"EIP"
* group.element[72].extension[0].extension[1].url = "cardinalityMin"
* group.element[72].extension[0].extension[1].valueInteger = -1
* group.element[72].extension[0].extension[2].url = "cardinalityMax"
...
* group.element[72].target.dependsOn[0].property = "data-type-map"
* group.element[72].target.dependsOn[0].value = "EIP[Identifier-PlacerAssignedIdentifier]"
* group.element[72].target.product[0].property = "antlr"
* group.element[72].target.product[0].value = "IF OBX-33 COUNT=1"
...
* group.element[73].target.dependsOn[0].property = "data-type-map"
* group.element[73].target.dependsOn[0].value = "EIP[Identifier-FillerAssignedIdentifier]"
* group.element[73].target.product[0].property = "antlr"
* group.element[73].target.product[0].value = "IF OBX-33 COUNT=1"
