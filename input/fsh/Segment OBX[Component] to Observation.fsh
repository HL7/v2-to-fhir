...
* url = "http://hl7.org/fhir/uv/v2mappings/segment-obxcomponent-to-observation"
* version = "1.0"
...
* group.element[37].target.dependsOn[0].value = "EI[Identifier]"
...
* group.element[39].target.dependsOn[0].value = "EI[Identifier]"
