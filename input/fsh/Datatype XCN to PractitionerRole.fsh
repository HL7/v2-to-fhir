...
* group.element[15].target.dependsOn[0].value = "IF XCN.19 NOT VALUED XCN.20 NOT VALUED"
* group.element[15].target.dependsOn[0].display = "IF XCN.19 NOT VALUED XCN.20 NOT VALUED"
