...
* group.element[10].target.code = #practitioner(Practitioner.identifier.type.coding.code)
...
* group.element[10].target.display = "practitioner(Practitioner.identifier.type.coding.code)"
...
* group.element[11].target.code = #practitioner(Practitioner.name.period)
...
* group.element[11].target.display = "practitioner(Practitioner.name.period)"
...
* group.element[11].target.product[0].value = "IF XCN.19 NOT VALUED XCN.20 NOT VALUED"
...
* group.element[12].target.code = #practitioner(Practitioner.name.family.extension.url)
...
* group.element[12].target.display = "practitioner(Practitioner.name.family.extension.url)"
...
* group.element[13].target.code = #practitioner(Practitioner.name.family.extension.valueCode)
...
* group.element[13].target.display = "practitioner(Practitioner.name.family.extension.valueCode)"
...
* group.element[14].target.code = #practitioner(Practitioner.name.period.start)
...
* group.element[14].target.display = "practitioner(Practitioner.name.period.start)"
...
* group.element[15].target.code = #practitioner(Practitioner.name.period.end)
...
* group.element[15].target.display = "practitioner(Practitioner.name.period.end)"
...
* group.element[16].target.code = #practitioner(Practitioner.name.suffix)
...
* group.element[16].target.display = "practitioner(Practitioner.name.suffix)"
