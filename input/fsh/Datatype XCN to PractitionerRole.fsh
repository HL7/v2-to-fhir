...
* group.element[12].target.code = #PractitionerRole.practitioner(Practitioner.name.family.extension-humanname-assembly-order)
...
* group.element[12].target.display = "PractitionerRole.practitioner(Practitioner.name.family.extension-humanname-assembly-order)"
...
* group.element[13].target.code = #practitioner(Practitioner.name.period.start)
...
* group.element[13].target.display = "practitioner(Practitioner.name.period.start)"
...
* group.element[14].target.code = #practitioner(Practitioner.name.period.end)
...
* group.element[14].target.display = "practitioner(Practitioner.name.period.end)"
...
* group.element[15].target.code = #practitioner(Practitioner.name.suffix)
...
* group.element[15].target.display = "practitioner(Practitioner.name.suffix)"
