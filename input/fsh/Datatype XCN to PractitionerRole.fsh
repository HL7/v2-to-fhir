...
* group.element[11].target.code = #practitioner(Practitioner.identifier.extension[2].url)
...
* group.element[12].target.code = #practitioner(Practitioner.identifier.type.coding.code)
...
* group.element[13].target.code = #practitioner(Practitioner.name.period)
...
* group.element[14].target.code = #practitioner(Practitioner.name.family.extension.url)
...
* group.element[15].target.code = #practitioner(Practitioner.name.family.extension.valueCode)
...
* group.element[16].target.code = #practitioner(Practitioner.name.period.start)
...
* group.element[16].target.display = "practitioner(Practitioner.name.period.start)"
...
* group.element[17].target.code = #practitioner(Practitioner.name.period.end)
...
* group.element[17].target.display = "practitioner(Practitioner.name.period.end)"
...
* group.element[18].target.code = #practitioner(Practitioner.name.suffix)
...
* group.element[18].target.display = "practitioner(Practitioner.name.suffix)"
