...
* group.element[1].target.dependsOn[1].value = "RequestedGiveCode"
...
* group.element[3].target.dependsOn[0].value = "\"ordered\""
...
* group.element[5].target.dependsOn[1].value = "RequestedGiveUnits"
* group.element[5].target.product[0].property = "antlr"
* group.element[5].target.product[0].value = "IF RXO-2 IS VALUED AND (IF RXO-4.1 IS VALUED OR RXO-4.3 IS VALUED)"
...
* group.element[6].target.dependsOn[0].value = "CWE[String]"
* group.element[6].target.product[0].property = "antlr"
* group.element[6].target.product[0].value = "IF RXO-2 IS VALUED AND (IF RXO-4.1 IS NOT VALUED AND RXO-4.3 IS NOT VALUED)"
...
* group.element[7].target.product[0].value = "IF RXO-2 IS VALUED AND (IF RXO-4.1 IS VALUED OR RXO-4.3 IS VALUED)"
...
* group.element[8].target.dependsOn[0].value = "CWE[String]"
* group.element[8].target.product[0].property = "antlr"
* group.element[8].target.product[0].value = "IF RXO-2 IS VALUED AND (IF RXO-4.1 IS NOT VALUED AND RXO-4.3 IS NOT VALUED)"
...
* group.element[9].target.dependsOn[1].value = "RequestedDosageForm"
...
* group.element[10].target.dependsOn[1].value = "AllowSubstition"
...
* group.element[12].target.dependsOn[0].value = "CWE[Code]"
* group.element[12].target.dependsOn[1].property = "vocabulary-map"
* group.element[12].target.dependsOn[1].value = "RequestedDispenseUnits"
* group.element[12].target.product[0].property = "antlr"
* group.element[12].target.product[0].value = "IF RXO-12.1 IS VALUED OR RXO-12.3 IS VALUED"
...
* group.element[13].target.product[0].value = "IF RXO-12.1 IS NOT VALUED AND RXO-12.3 IS NOT VALUED"
...
* group.element[15].target.dependsOn[0].value = "XCN[Practitioner]"
...
* group.element[17].target.dependsOn[1].value = "RequestedGiveStrengthUnits"
* group.element[17].target.product[0].property = "antlr"
* group.element[17].target.product[0].value = "IF RXO-19.1 IS VALUED OR RXO-19.3 IS VALUED"
...
* group.element[18].target.dependsOn[0].value = "CWE[String]"
* group.element[18].target.product[0].property = "antlr"
* group.element[18].target.product[0].value = "IF RXO-19.1 IS NOT VALUED AND RXO-19.3 IS NOT VALUED"
* group.element[19].code = #RXO-25
...
* group.element[19].extension[0].extension[0].valueCode = #"NM"
...
* group.element[19].display = "Requested Drug Strength Volume"
* group.element[19].target.equivalence = #equivalent
* group.element[19].target.code = #medicationReference(Medication.ingredient.strength.denominator.value
...
* group.element[19].target.extension[0].extension[0].valueCode = #"decimal"
* group.element[19].target.display = "medicationReference(Medication.ingredient.strength.denominator.value"
* group.element[20].code = #RXO-26
...
* group.element[20].display = "Requested Drug Strength Volume Units"
* group.element[20].target.equivalence = #equivalent
* group.element[20].target.code = #medicationReference(Medication.ingredient.strength.denominator.code
...
* group.element[20].target.display = "medicationReference(Medication.ingredient.strength.denominator.code"
* group.element[20].target.dependsOn[0].property = "vocabulary-map"
* group.element[20].target.dependsOn[0].value = "RequestedDrugStengthVolumeUnits"
* group.element[20].target.product[0].property = "antlr"
* group.element[20].target.product[0].value = "IF RXO-26.1 IS VALUED OR RXO-26.3 IS VALUED"
* group.element[21].code = #RXO-26
...
* group.element[21].display = "Requested Drug Strength Volume Units"
* group.element[21].target.equivalence = #equivalent
* group.element[21].target.code = #medicationReference(Medication.ingredient.strength.denominator.unit
...
* group.element[21].target.display = "medicationReference(Medication.ingredient.strength.denominator.unit"
* group.element[21].target.dependsOn[0].property = "data-type-map"
* group.element[21].target.dependsOn[0].value = "CWE[String]"
* group.element[21].target.product[0].property = "antlr"
* group.element[21].target.product[0].value = "IF RXO-26.1 IS NOT VALUED AND RXO-26.3 IS NOT VALUED"
