...
* group.element[19].target.dependsOn[0].value = "CQ[Quantity]"
...
* group.element[21].target.dependsOn[0].value = "\"d\""
...
* group.element[23].target.dependsOn[0].value = "RequestedDrugStengthVolumeUnits"
* group.element[23].target.product[0].property = "antlr"
* group.element[23].target.product[0].value = "IF RXO-26.1 IS VALUED OR RXO-26.3 IS VALUED"
...
* group.element[24].target.dependsOn[0].value = "CWE[String]"
* group.element[24].target.product[0].property = "antlr"
* group.element[24].target.product[0].value = "IF RXO-26.1 IS NOT VALUED AND RXO-26.3 IS NOT VALUED"
