...
* group.element[9].target.extension[0].extension[3].valueString = "\"http://hl7.org/fhir/StructureDefinition/event-statusReason\""
...
* group.element[11].display = "Confidentiality Code"
