...
* group[0].element[0].display = "Entered By Person"
* group[0].element[0].target.equivalence = #equivalent
* group[0].element[0].target.code = #agent[1].who(Practitioner)
...
* group[0].element[0].target.display = "agent[1].who(Practitioner)"
* group[0].element[1].code = #SCH-20
...
* group[0].element[1].display = "Entered By Person"
* group[0].element[1].target.equivalence = #equivalent
* group[0].element[1].target.code = #agent[1].type.coding.code
...
* group[0].element[1].target.extension[0].extension[3].valueString = "\"enterer\""
* group[0].element[1].target.display = "agent[1].type.coding.code"
* group[0].element[2].code = #SCH-20
...
* group[0].element[2].display = "Entered By Person"
* group[0].element[2].target.equivalence = #equivalent
* group[0].element[2].target.code = #agent[1].type.coding.system
...
* group[0].element[2].target.extension[0].extension[3].valueString = "\"http://terminology.hl7.org/CodeSystem/provenance-participant-type\""
* group[0].element[2].target.display = "agent[1].type.coding.system"
