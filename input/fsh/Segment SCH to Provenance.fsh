...
* group.element[1].target.extension[0].extension[3].valueString = "\"enterer\""
...
* group.element[2].target.extension[0].extension[3].valueString = "\"http://terminology.hl7.org/CodeSystem/provenance-participant-type\""
