...
* group.element[12].code = #ADT_A06:follow:PID.ROL
...
* group.element[14].code = #ADT_A06:follow:PID.PRT
...
* group.element[16].code = #ADT_A06.MRG
...
* group.element[16].display = "Merge Information"
* group.element[16].target.equivalence = #equivalent
* group.element[16].target.code = #Account[2]
* group.element[16].target.display = "Account[2]"
...
* group.element[16].target.dependsOn[0].value = "MRG[Account]"
* group.element[16].target.dependsOn[1].property = "references"
* group.element[16].target.dependsOn[1].value = "Account[2].subject.reference=Patient[1].id"
* group.element[17].code = #ADT_A06.NEXT_OF_KIN.NK1
...
* group.element[19].code = #ADT_A06.PV1
...
* group.element[19].target.comment = "Processing of the PV1 segment results in the creation of a new Encounter resource.  Note also that per A06 and A07 trigger event definitions PV1-19 - Visit Number may also be changed during this event."
...
* group.element[21].code = #ADT_A06.PV2
...
* group.element[22].code = #ADT_A06:follow:PV1.ROL
...
* group.element[23].code = #ADT_A06.OBSERVATION.OBX
...
* group.element[25].code = #ADT_A06.AL1
...
* group.element[26].code = #ADT_A06.DG1
...
* group.element[29].code = #ADT_A06.PROCEDURE.PR1
...
* group.element[30].code = #ADT_A06.INSURANCE.IN1
...
* group.element[30].target.dependsOn[0].value = "IN1[Coverage]"
* group.element[31].code = #ADT_A06.INSURANCE.IN3
...
* group.element[31].target.code = #CareTeam[1].participant[2]
* group.element[31].target.display = "CareTeam[1].participant[2]"
...
* group.element[31].target.dependsOn[0].value = "IN3[CareTeam]"
* group.element[31].target.dependsOn[1].property = "references"
* group.element[31].target.dependsOn[1].value = "CareTeam[1].subject.reference=Patient[1].id"
