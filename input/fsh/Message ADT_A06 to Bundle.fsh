...
* group.element[14].target.dependsOn[0].value = "PRT[Patient-GeneralPractitioner]"
...
* group.element[31].code = #ADT_A06.INSURANCE.IN2
...
* group.element[31].target.dependsOn[0].value = "IN2[Coverage]"
