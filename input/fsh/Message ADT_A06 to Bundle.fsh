...
* group.element[21].target.dependsOn[0].value = "IF PV1-43 VALUED"
* group.element[21].target.dependsOn[0].display = "IF PV1-43 VALUED"
...
* group.element[23].target.dependsOn[0].value = "IF PV1-20 VALUE"
* group.element[23].target.dependsOn[0].display = "IF PV1-20 VALUE"
