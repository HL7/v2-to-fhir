...
* group.element[32].code = #ADT_A06.INSURANCE.IN2
...
* group.element[32].display = "Insurance Additional Info."
...
* group.element[32].target.comment = "Incorporate IN2 content into the Coverage created from the IN1 segment."
* group.element[32].target.dependsOn[0].property = "segment-map"
* group.element[32].target.dependsOn[0].value = "IN2[Coverage]"
* group.element[33].code = #ADT_A06.INSURANCE.IN3
...
* group.element[33].display = "Insurance Additional Info - Cert."
* group.element[33].target.equivalence = #equivalent
* group.element[33].target.code = #CareTeam[1].participant[2]
* group.element[33].target.display = "CareTeam[1].participant[2]"
* group.element[33].target.comment = "Incorporate IN3 content into the Coverage created from the IN1 segment."
* group.element[33].target.dependsOn[0].property = "segment-map"
* group.element[33].target.dependsOn[0].value = "IN3[CareTeam]"
* group.element[33].target.dependsOn[1].property = "references"
* group.element[33].target.dependsOn[1].value = "CareTeam[1].subject.reference=Patient[1].id"
