...
* group.element[14].code = #VXU_V04.PATIENT_VISIT.PV2
...
* group.element[15].target.product[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1"
* group.element[16].code = #VXU_V04.PERSON_OBSERVATION.OBX
...
* group.element[16].target.product[0].value = "IF OBX-5 LST.count GREATER THAN 1"
...
* group.element[17].target.code = #Device[1]
* group.element[17].target.display = "Device[1]"
* group.element[17].target.dependsOn[0].property = "segment-map"
* group.element[17].target.dependsOn[0].value = "PRT[Device]"
* group.element[17].target.dependsOn[1].property = "references"
* group.element[17].target.dependsOn[1].value = "Observation[1].device.reference=Device.id"
* group.element[17].target.product[0].property = "antlr"
* group.element[17].target.product[0].value = "IF PRT-10 VALUED"
...
* group.element[19].target.code = #PractitionerRole[1]
* group.element[19].target.display = "PractitionerRole[1]"
...
* group.element[19].target.dependsOn[1].value = "Observation.performer.reference=PractitionerRole[1].id"
* group.element[19].target.product[0].property = "antlr"
* group.element[19].target.product[0].value = "IF PRT-5 VALUED"
* group.element[20].code = #VXU_V04.PERSON_OBSERVATION.NTE
...
* group.element[20].display = "Notes (Regarding Patient Observation)"
* group.element[20].target.equivalence = #equivalent
* group.element[20].target.code = #Observation[1].note
* group.element[20].target.display = "Observation[1].note"
* group.element[20].target.dependsOn[0].property = "segment-map"
* group.element[20].target.dependsOn[0].value = "NTE[ServiceRequest]"
...
* group.element[21].target.code = #Immunization[1]
* group.element[21].target.display = "Immunization[1]"
* group.element[21].target.comment = "Processing of each ORC segment results in the creation of a new Immunization resource"
* group.element[21].target.dependsOn[0].property = "segment-map"
* group.element[21].target.dependsOn[0].value = "ORC[Immunization]"
* group.element[21].target.dependsOn[1].property = "references"
* group.element[21].target.dependsOn[1].value = "Immunzation.patient.reference=Patient[1].id"
* group.element[22].code = #VXU_V04.ORDER.ORC
...
* group.element[22].target.comment = "Processing of each ORC segment results in the creation of a new ServiceRequest resource if the receiving system wants to know about the order that lead to the immunization event"
...
* group.element[22].target.dependsOn[1].value = "ServiceRequest.subject.reference=Patient[1].id"
* group.element[22].target.product[0].property = "narrative"
* group.element[22].target.product[0].value = "Only if the system wants to know about the order that lead to the immunization event"
...
* group.element[23].target.code = #PractitionerRole[2]
* group.element[23].target.display = "PractitionerRole[2]"
* group.element[23].target.comment = """
...
* group.element[23].target.dependsOn[1].value = "Immunization.performer.actor.reference=PractitionerRole[2].id"
...
* group.element[24].target.display = "= \"OP'\""
...
* group.element[26].target.dependsOn[1].value = "Immunization.performer.actor.reference=PractitionerRole[3].id"
...
* group.element[27].target.code = #Immunization[1].performer.function.coding.code
* group.element[27].target.display = "= \"AP'\""
...
* group.element[28].target.code = #Immunization[1].performer.function.coding.system
* group.element[28].target.display = "= \"http://terminology.hl7.org/CodeSystem/v2-0443\""
...
* group.element[29].code = #VXU_V04.ORDER.RXA
...
* group.element[29].display = "Pharmacy Administration Segment"
...
* group.element[29].target.comment = "Incorporate RXA content into the Immunization created from the ORC segment in the same segment group."
* group.element[29].target.dependsOn[0].property = "segment-map"
* group.element[29].target.dependsOn[0].value = "RXA[Immunization]"
* group.element[30].code = #VXU_V04.ORDER.RXR
...
* group.element[30].display = "Pharmacy Route"
* group.element[30].target.equivalence = #equivalent
* group.element[30].target.code = #Immunization[1]
* group.element[30].target.display = "Immunization[1]"
* group.element[30].target.comment = "Incorporate RXR content into the Immunization created from the ORC segment in the same segment group."
* group.element[30].target.dependsOn[0].property = "segment-map"
* group.element[30].target.dependsOn[0].value = "RXR[Immunization]"
...
* group.element[31].target.dependsOn[1].value = "Observation[2].subject.reference=Patient[1].id; Observation[2].partOf.reference=Immunization[1].id"
...
* group.element[32].code = #VXU_V04.ORDER.OBSERVATION.OBX
...
* group.element[32].target.dependsOn[1].value = "Observation[2].subject.reference=Patient[1].id; Observation[2].partOf.reference=Immunization[1].id"
* group.element[32].target.product[0].property = "antlr"
* group.element[32].target.product[0].value = "IF OBX-5 LST.count GREATER THAN 1"
* group.element[32].target.product[1].property = "narrative"
* group.element[32].target.product[1].value = "Some observations about the immunization may map to elements within the Immuniation resource rather than an independent Observation resource. For example, funding source, patient eligibility and educational material are often sent as OBX segments but map to Immunization elements.  Specific guidance on how to map, e.g., the US CDC implementation guide on immunizations, will be provided separately at a future time TBD."
...
* group.element[33].target.code = #Device[2]
* group.element[33].target.display = "Device[2]"
...
* group.element[35].target.code = #PractitionerRole[4]
* group.element[35].target.display = "PractitionerRole[4]"
...
* group.element[35].target.dependsOn[1].value = "Observation[2].performer.reference=PractitionerRole[1].id"
* group.element[35].target.product[0].property = "antlr"
* group.element[35].target.product[0].value = "IF PRT-5 VALUED"
* group.element[36].code = #VXU_V04.ORDER.OBSERVATION.NTE
...
* group.element[36].display = "Notes (Regarding Immunization)"
* group.element[36].target.equivalence = #equivalent
* group.element[36].target.code = #Observation[2].note
* group.element[36].target.display = "Observation[2].note"
* group.element[36].target.dependsOn[0].property = "segment-map"
* group.element[36].target.dependsOn[0].value = "NTE[ServiceRequest]"
