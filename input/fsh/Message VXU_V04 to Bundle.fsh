...
* group.element[7].code = #VXU_V04.PD1
...
* group.element[8].target.dependsOn[1].value = "RelatedPerson.patient.reference=Patient[PID].id"
...
* group.element[10].target.comment = "Processing of the PV1 segment results in the creation of a new Encounter resource"
* group.element[10].target.dependsOn[0].property = "segment-map"
* group.element[10].target.dependsOn[0].value = "PV1[Encounter]"
* group.element[10].target.dependsOn[1].property = "references"
* group.element[10].target.dependsOn[1].value = "Encounter.subject.reference=Patient[PID].id"
* group.element[10].target.product[0].property = "narrative"
* group.element[10].target.product[0].value = "Only if the system wants to know about the encounter related to the immunization event"
...
* group.element[12].code = #VXU_V04.PATIENT_VISIT.PV2
...
* group.element[15].target.code = #Device[1]
* group.element[15].target.display = "Device[1]"
...
* group.element[18].code = #VXU_V04.PERSON_OBSERVATION.NTE
...
* group.element[18].display = "Notes (Regarding Patient Observation)"
* group.element[18].target.equivalence = #equivalent
* group.element[18].target.code = #Observation[1].note
* group.element[18].target.display = "Observation[1].note"
* group.element[18].target.dependsOn[0].property = "segment-map"
* group.element[18].target.dependsOn[0].value = "NTE[ServiceRequest]"
...
* group.element[19].target.code = #Immunization[1]
* group.element[19].target.display = "Immunization[1]"
* group.element[19].target.comment = "Processing of each ORC segment results in the creation of a new Immunization resource"
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "ORC[Immunization]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "Immunzation.patient.reference=Patient[1].id"
...
* group.element[20].target.comment = "Processing of each ORC segment results in the creation of a new ServiceRequest resource if the receiving system wants to know about the order that lead to the immunization event"
...
* group.element[20].target.dependsOn[1].value = "ServiceRequest.subject.reference=Patient[1].id"
* group.element[20].target.product[0].property = "narrative"
* group.element[20].target.product[0].value = "Only if the system wants to know about the order that lead to the immunization event"
...
* group.element[21].target.dependsOn[1].value = "Immunization.performer.actor.reference=PractitionerRole[2].id"
...
* group.element[22].target.display = "= \"OP'\""
...
* group.element[24].target.dependsOn[1].value = "Immunization.performer.actor.reference=PractitionerRole[3].id"
...
* group.element[25].target.code = #Immunization[1].performer.function.coding.code
* group.element[25].target.display = "= \"AP'\""
...
* group.element[26].target.code = #Immunization[1].performer.function.coding.system
* group.element[26].target.display = "= \"http://terminology.hl7.org/CodeSystem/v2-0443\""
...
* group.element[27].code = #VXU_V04.ORDER.RXA
...
* group.element[27].display = "Pharmacy Administration Segment"
...
* group.element[27].target.comment = "Incorporate RXA content into the Immunization created from the ORC segment in the same segment group."
* group.element[27].target.dependsOn[0].property = "segment-map"
* group.element[27].target.dependsOn[0].value = "RXA[Immunization]"
* group.element[28].code = #VXU_V04.ORDER.RXR
...
* group.element[28].display = "Pharmacy Route"
...
* group.element[28].target.comment = "Incorporate RXR content into the Immunization created from the ORC segment in the same segment group."
* group.element[28].target.dependsOn[0].property = "segment-map"
* group.element[28].target.dependsOn[0].value = "RXR[Immunization]"
...
* group.element[29].target.product[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1"
...
* group.element[31].target.code = #Device[2]
* group.element[31].target.display = "Device[2]"
...
* group.element[31].target.dependsOn[1].value = "Observation[1].device.reference=Device.id"
...
* group.element[33].target.code = #PractitionerRole[4]
* group.element[33].target.display = "PractitionerRole[4]"
...
* group.element[33].target.dependsOn[1].value = "Observation.performer.reference=PractitionerRole[1].id"
* group.element[33].target.product[0].property = "antlr"
* group.element[33].target.product[0].value = "IF PRT-5 VALUED"
* group.element[34].code = #VXU_V04.ORDER.OBSERVATION.NTE
...
* group.element[34].display = "Notes (Regarding Immunization)"
* group.element[34].target.equivalence = #equivalent
* group.element[34].target.code = #Observation[2].note
* group.element[34].target.display = "Observation[2].note"
* group.element[34].target.dependsOn[0].property = "segment-map"
* group.element[34].target.dependsOn[0].value = "NTE[ServiceRequest]"
