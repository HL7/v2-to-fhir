...
* url = "http://hl7.org/fhir/uv/v2mappings/ConceptMap/datatype-cwe-to-organization"
...
* group[0].element[2].target.code = #identifier.system
...
* group[0].element[2].target.display = "identifier.system"
* group[0].element[3].code = #CWE.9
...
* group[0].element[3].display = "Original Text"
* group[0].element[3].target.equivalence = #equivalent
* group[0].element[3].target.code = #name
...
* group[0].element[3].target.display = "name"
