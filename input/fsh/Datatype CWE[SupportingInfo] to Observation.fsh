...
* group.element[0].target.extension[0].extension[3].valueString = "/to be determined by implementer based on use of OBR-13/"
...
* group.element[1].target.extension[0].extension[3].valueString = "\"final\""
