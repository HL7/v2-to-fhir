...
* group.element[10].target.dependsOn[0].value = "PID[Provenance]"
...
* group.element[12].code = #SIU_S12.PATIENT.PV2
...
* group.element[12].target.dependsOn[1].value = "Encounter.subject=Patient[1].id"
* group.element[13].code = #SIU_S12.PATIENT.OBX
...
* group.element[13].target.code = #Observation
* group.element[13].target.display = "Observation"
...
* group.element[13].target.dependsOn[1].value = "Observation.subject=Patient[1].id"
* group.element[14].code = #SIU_S12.PATIENT.DG1
...
* group.element[14].display = "Diagnosis"
* group.element[14].target.equivalence = #equivalent
* group.element[14].target.code = #Condition[1]
* group.element[14].target.display = "Condition[1]"
* group.element[14].target.comment = "Processing of the DG1 segment results in the creation of a new Condition resource"
* group.element[14].target.dependsOn[0].property = "segment-map"
* group.element[14].target.dependsOn[0].value = "DG1[Condition]"
* group.element[14].target.dependsOn[1].property = "references"
* group.element[14].target.dependsOn[1].value = "Condition[1].subject.reference=Patient[1].id"
* group.element[14].target.product[0].property = "narrative"
* group.element[14].target.product[0].value = "If in context of the patient"
* group.element[15].code = #SIU_S12.RESOURCES.SERVICE.AIS
...
* group.element[15].display = "Appointment Information - Service"
* group.element[15].target.equivalence = #equivalent
* group.element[15].target.code = #Appointment[1]
* group.element[15].target.display = "Appointment[1]"
* group.element[15].target.dependsOn[0].property = "segment-map"
* group.element[15].target.dependsOn[0].value = "AIS[Appointment]"
* group.element[15].target.product[0].property = "narrative"
* group.element[15].target.product[0].value = "Determine which AIS populates Appointment if there is more than one AIS."
...
* group.element[16].target.code = #ServiceRequest[n]
* group.element[16].target.display = "ServiceRequest[n]"
* group.element[16].target.comment = """
...
* group.element[16].target.dependsOn[0].value = "AIS[ServiceRequest]"
* group.element[16].target.product[0].property = "antlr"
* group.element[16].target.product[0].value = "IF SCH-26 IS VALUED OR SCH-27 IS VALUED"
* group.element[17].code = #SIU_S12.RESOURCES.SERVICE.NTE
...
* group.element[17].display = "Notes and Comments"
* group.element[17].target.equivalence = #equivalent
* group.element[17].target.code = #Appointment[1]
* group.element[17].target.display = "Appointment[1]"
* group.element[17].target.comment = "Because multiple NTE segments in a message all need to map to a single Appointment.comment element, the content of the NTEs will need to be concatenated together in R4"
* group.element[17].target.dependsOn[0].property = "segment-map"
* group.element[17].target.dependsOn[0].value = "NTE[Appointment]"
* group.element[17].target.dependsOn[1].property = "references"
* group.element[17].target.dependsOn[1].value = "Appointment.participant.actor=Patient[1].id"
* group.element[17].target.product[0].property = "narrative"
* group.element[17].target.product[0].value = "Determine which AIS populates Appointment if there is more than one AIS."
* group.element[18].code = #SIU_S12.RESOURCES.GENERAL_RESOURCE.AIG
...
* group.element[18].display = "Appointment Information - General Resource"
...
* group.element[18].target.dependsOn[0].value = "AIG[Appointment]"
* group.element[18].target.product[0].property = "narrative"
* group.element[18].target.product[0].value = "Determine which AIG populates Appointment if there is more than one AIG."
* group.element[19].code = #SIU_S12.RESOURCES.LOCATION_RESOURCE.AIL
...
* group.element[19].display = "Appointment Information - Location Resource"
* group.element[19].target.equivalence = #equivalent
* group.element[19].target.code = #Appointment[1]
* group.element[19].target.display = "Appointment[1]"
* group.element[19].target.comment = "I only see in OR cases"
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "AIL[Appointment]"
* group.element[19].target.product[0].property = "narrative"
* group.element[19].target.product[0].value = "Determine which AIL populates Appointment if there is more than one AIL."
* group.element[20].code = #SIU_S12.RESOURCES.PERSONNEL_RESOURCE.AIP
...
* group.element[20].display = "Appointment Information - Personnel Resource"
...
* group.element[20].target.dependsOn[0].value = "AIP[Appointment]"
