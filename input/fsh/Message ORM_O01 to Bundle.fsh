...
Title: "Message ORM_O01null to Bundle Map"
* title = "Message ORM_O01null to Bundle Map"
...
* group.element[7].target.dependsOn[0].value = "PD1[Observation-LivingWill]"
* group.element[7].target.dependsOn[1].property = "references"
* group.element[7].target.dependsOn[1].value = "Observation[2].subject.reference=Patient[1].id"
* group.element[7].target.product[0].property = "antlr"
* group.element[7].target.product[0].value = "IF PD1-7 VALUED"
...
* group.element[8].target.dependsOn[1].value = "Encounter.subject.reference=Patient[1].id"
...
* group.element[10].code = #ORM_O01.PATIENT.VISIT.PV2
...
* group.element[11].code = #ORM_O01.PATIENT.INSURANCE.IN1
...
* group.element[11].display = "Insurance"
* group.element[11].target.equivalence = #equivalent
* group.element[11].target.code = #Coverage[1]
* group.element[11].target.display = "Coverage[1]"
* group.element[11].target.comment = "Processing of the IN1 segment results in the creation of a new Coverage resource"
* group.element[12].code = #ORM_O01.PATIENT.INSURANCE.IN2
...
* group.element[12].display = "Insurance Additional Info"
* group.element[12].target.equivalence = #equivalent
* group.element[12].target.code = #Coverage[1]
* group.element[12].target.display = "Coverage[1]"
* group.element[12].target.comment = "Incorporate IN2 content into the Coverage created from the IN1 segment."
* group.element[13].code = #ORM_O01.PATIENT.INSURANCE.IN3
...
* group.element[13].display = "Insurance Add'l Info – Cert."
* group.element[13].target.equivalence = #equivalent
* group.element[13].target.code = #Coverage[1]
* group.element[13].target.display = "Coverage[1]"
* group.element[13].target.comment = "Incorporate IN3 content into the Coverage created from the IN1 segment."
* group.element[14].code = #ORM_O01.PATIENT.AL1
...
* group.element[14].display = "Allergy Information"
* group.element[14].target.equivalence = #equivalent
* group.element[14].target.code = #AllergyIntolerance
* group.element[14].target.display = "AllergyIntolerance"
* group.element[14].target.comment = "Processing of the AL1 segment results in the creation of a new AllergyIntolerance resource"
* group.element[14].target.dependsOn[0].property = "segment-map"
* group.element[14].target.dependsOn[0].value = "AL1[AllergyIntolerance]"
* group.element[14].target.dependsOn[1].property = "references"
* group.element[14].target.dependsOn[1].value = "AllergyIntolerance.patient.reference=Patient[1].id"
...
* group.element[15].target.comment = "Processing of each ORC segment results in the creation of a new ServiceRequest resource"
* group.element[15].target.dependsOn[0].property = "segment-map"
* group.element[15].target.dependsOn[0].value = "ORC[ServiceRequest]"
* group.element[15].target.dependsOn[1].property = "references"
* group.element[15].target.dependsOn[1].value = "ServiceRequest[1].subject.reference=Patient[1].id"
...
* group.element[16].target.code = #Task[1]
* group.element[16].target.display = "Task[1]"
...
* group.element[16].target.product[0].property = "fhirpath"
* group.element[16].target.product[0].value = "h"
...
* group.element[17].target.code = #Provenance[2]
* group.element[17].target.display = "Provenance[2]"
* group.element[17].target.dependsOn[0].property = "segment-map"
* group.element[17].target.dependsOn[0].value = "ORC[Provenance]"
* group.element[17].target.dependsOn[1].property = "references"
* group.element[17].target.dependsOn[1].value = "Provenance[2].target=ServiceRequest[1]"
...
* group.element[18].target.comment = "Incorporate OBR content into the ServiceRequest created from the ORC segment in the same segment group."
...
* group.element[18].target.product[0].value = "IF PID VALUED"
* group.element[19].code = #ORM_O01.ORDER_DETAIL.CHOICE.OBR
...
* group.element[19].display = "Order Detail Segment OBR, etc."
* group.element[19].target.equivalence = #equivalent
* group.element[19].target.code = #SupplyRequest[1]
* group.element[19].target.display = "SupplyRequest[1]"
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "OBR[ServiceRequest]"
* group.element[19].target.product[0].property = "antlr"
* group.element[19].target.product[0].value = "IF PID NOT VALUED"
* group.element[20].code = #ORM_O01.ORDER_DETAIL.CHOICE.RXO
...
* group.element[20].display = "Pharmacy/Treatment Order"
* group.element[20].target.equivalence = #equivalent
* group.element[20].target.code = #MedicationRequest
* group.element[20].target.display = "MedicationRequest"
* group.element[20].target.dependsOn[0].property = "segment-map"
* group.element[20].target.dependsOn[0].value = "RXO[MedicationRequest]"
* group.element[21].code = #ORM_O01.ORDER_DETAIL.CHOICE.ODS
...
* group.element[21].display = "Dietary Orders, Supplements, and Preferences"
* group.element[21].target.equivalence = #equivalent
* group.element[21].target.code = #SupplyRequest[2]
* group.element[21].target.display = "SupplyRequest[2]"
* group.element[21].target.product[0].property = "antlr"
* group.element[21].target.product[0].value = "IF PID NOT VALUED"
* group.element[22].code = #ORM_O01.ORDER_DETAIL.NTE
...
* group.element[22].display = "Notes and Comments (for Detail)"
* group.element[22].target.equivalence = #equivalent
* group.element[22].target.code = #ServiceRequest[1].note
* group.element[22].target.display = "ServiceRequest[1].note"
* group.element[22].target.dependsOn[0].property = "segment-map"
* group.element[22].target.dependsOn[0].value = "NTE[ServiceRequest]"
* group.element[23].code = #ORM_O01.ORDER_DETAIL.DG1
...
* group.element[23].display = "Diagnosis"
* group.element[23].target.equivalence = #equivalent
* group.element[23].target.code = #ServiceRequest[1].reasonReference(Condition)
* group.element[23].target.display = "ServiceRequest[1].reasonReference(Condition)"
* group.element[23].target.comment = "Processing of the DG1 segment results in the creation of a new Condition resource which is referenced in the ServiceRequest created by the ORC segment"
* group.element[23].target.dependsOn[0].property = "segment-map"
* group.element[23].target.dependsOn[0].value = "DG1[Condition]"
* group.element[23].target.dependsOn[1].property = "references"
* group.element[23].target.dependsOn[1].value = "Condition.subject.reference=Patient[1].id"
...
* group.element[24].target.product[0].value = "IF  OBX-5 LST.count GREATER THAN 1"
* group.element[25].code = #ORM_O01.ORDER_DETAIL.OBSERVATION.OBX
...
* group.element[25].target.code = #Observation[1]
* group.element[25].target.display = "Observation[1]"
...
* group.element[25].target.dependsOn[1].value = "ServiceRequest[1].supportingInfo.reference=Observation[1].id; Observation[1].subject.id=Patient[1].id"
* group.element[25].target.product[0].property = "antlr"
* group.element[25].target.product[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1"
