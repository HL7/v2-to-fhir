...
* group.element[9].target.dependsOn[0].value = "PV1[EncounterHistory]"
* group.element[9].target.dependsOn[1].property = "references"
* group.element[9].target.dependsOn[1].value = "EncounterHistory.subject.reference=Patient[1].id"
* group.element[9].target.product[0].property = "antlr"
* group.element[9].target.product[0].value = "IF PV1-43 VALUED"
...
* group.element[11].target.dependsOn[0].value = "PV1[Coverage]"
* group.element[11].target.dependsOn[1].property = "references"
* group.element[11].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
* group.element[11].target.product[0].property = "antlr"
* group.element[11].target.product[0].value = "IF PV1-20 VALUE"
...
* group.element[16].target.dependsOn[0].value = "AL1[AllergyIntolerance]"
* group.element[16].target.dependsOn[1].property = "references"
* group.element[16].target.dependsOn[1].value = "AllergyIntolerance.patient.reference=Patient[1].id"
...
* group.element[17].target.dependsOn[0].value = "ORC[ServiceRequest]"
* group.element[17].target.dependsOn[1].property = "references"
* group.element[17].target.dependsOn[1].value = "ServiceRequest[1].subject.reference=Patient[1].id"
...
* group.element[18].target.product[0].property = "fhirpath"
* group.element[18].target.product[0].value = "h"
...
* group.element[19].target.dependsOn[1].value = "Provenance[2].target=ServiceRequest[1]"
...
* group.element[20].target.dependsOn[0].value = "OBR[ServiceRequest]"
* group.element[20].target.product[0].property = "antlr"
* group.element[20].target.product[0].value = "IF PID VALUED"
...
* group.element[21].target.dependsOn[0].value = "OBR[ServiceRequest]"
...
* group.element[22].target.dependsOn[0].value = "RXO[MedicationRequest]"
...
* group.element[23].target.product[0].value = "IF PID NOT VALUED"
...
* group.element[26].target.dependsOn[1].value = "ServiceRequest[1].supportingInfo.reference=Observation[1].id; Observation[1].subject.id=Patient[1].id"
* group.element[26].target.product[0].property = "antlr"
* group.element[26].target.product[0].value = "IF  OBX-5 LST.count GREATER THAN 1"
...
* group.element[27].target.dependsOn[1].value = "ServiceRequest[1].supportingInfo.reference=Observation[1].id; Observation[1].subject.id=Patient[1].id"
