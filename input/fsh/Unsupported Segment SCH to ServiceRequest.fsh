// mappings/messages/HL7 Message - FHIR R4_ SIU-S12 - Sheet1.csv:8
Instance: SegmentSCHtoServiceRequest
InstanceOf: ConceptMap
Title: "Segment SCH to ServiceRequest Map"
* description = "This ConceptMap represents a mapping from the HL7 V2 Segment SCH to the FHIR ServiceRequest. It is not yet supported."
