...
* group.element[3].target.code = #reason.extension[1].valueCodeableConcept
...
* group.element[4].display = "Operator ID"
* group.element[4].target.equivalence = #equivalent
* group.element[4].target.code = #agent.who(Practitioner)
...
* group.element[4].target.display = "agent.who(Practitioner)"
...
* group.element[4].target.dependsOn[1].value = "OperatorID"
* group.element[5].code = #EVN-6
...
* group.element[5].display = "Event Occurred"
* group.element[5].target.equivalence = #equivalent
* group.element[5].target.code = #occurredDateTime
...
* group.element[5].target.display = "occurredDateTime"
* group.element[6].code = #EVN-7
...
* group.element[6].display = "Event Facility"
* group.element[6].target.equivalence = #equivalent
* group.element[6].target.code = #location(Location)
...
* group.element[6].target.extension[0].extension[0].valueInteger = 0
...
* group.element[6].target.display = "location(Location)"
* group.element[6].target.dependsOn[0].property = "data-type-map"
* group.element[6].target.dependsOn[0].value = "HD[Location]"
