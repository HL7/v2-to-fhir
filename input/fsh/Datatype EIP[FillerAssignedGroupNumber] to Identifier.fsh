// HL7 Data Type - FHIR E2_ EIP[Identifier-FillerAssignedGroupNumber] - Sheet1.csv
Instance: DatatypeEIPFillerAssignedGroupNumberToIdentifier
InstanceOf: ConceptMap
Title: "Datatype EIP [FillerAssignedGroupNumber] to Identifier Map"
Usage: #definition
* title = "Datatype EIP [FillerAssignedGroupNumber] to Identifier Map"
* description = "This ConceptMap represents a mapping from the HL7 V2 Datatype EIP to the FHIR Identifier Data Type."
* id = "datatype-eip-fillerassignedgroupnumber-to-identifier"
* url = "http://hl7.org/fhir/uv/v2mappings/ConceptMap/datatype-eip-fillerassignedgroupnumber-to-identifier"
* name = "DatatypeEIPFillerAssignedGroupNumberToIdentifier"
* insert PublicationData
* extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/RelatedArtifact"
* extension[0].extension[0].url = "type"
* extension[0].extension[0].valueCode = #derived-from
* extension[0].extension[1].url = "label"
* extension[0].extension[1].valueString = "Datatype EIP[FillerAssignedGroupNumber] to Identifier.fsh"
* extension[0].extension[2].url = "url"
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1I_ImGmCakaAx2CuIvjhRzRNep62cYdL3FCfPaagu1FI/edit?gid=0#gid=0"
