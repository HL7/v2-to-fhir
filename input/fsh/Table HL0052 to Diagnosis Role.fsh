...
Instance: TableHL0052ToDiagnosisRole
InstanceOf: ConceptMap
Title: "Table HL0052 to Diagnosis Role Map"
* title = "Table HL0052 to Diagnosis Role Map"
* description = "This ConceptMap represents a mapping from the HL7 V2 Table HL0052 to the FHIR Diagnosis Role Value Set."
* id = "table-hl0052-to-diagnosis-role"
* url = "http://hl7.org/fhir/uv/v2mappings/table-hl0052-to-diagnosis-role"
* version = "1.0"
* name = "TableHL0052ToDiagnosisRole"
* status = #active
* experimental = true
* date = "2023-07-28"
...
* extension[0].extension[1].valueString = "Table HL0052 to Diagnosis Role.fsh"
