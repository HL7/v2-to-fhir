...
* group.element[0].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.7 NOT VALUED AND XTN.12 NOT VALUED"
* group.element[0].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.7 NOT VALUED AND XTN.12 NOT VALUED"
...
* group.element[3].target.dependsOn[0].value = "IF XTN.3 NOT VALUED AND XTN.4 VALUED"
* group.element[3].target.dependsOn[0].display = "IF XTN.3 NOT VALUED AND XTN.4 VALUED"
...
* group.element[4].target.dependsOn[0].value = "IF XTN.3 NOT VALUED AND XTN.4  NOT VALUED"
* group.element[4].target.dependsOn[0].display = "IF XTN.3 NOT VALUED AND XTN.4  NOT VALUED"
...
* group.element[5].target.dependsOn[0].value = "IF XTN.3 IN (\"Internet\", \"X.400\")"
* group.element[5].target.dependsOn[0].display = "IF XTN.3 IN (\"Internet\", \"X.400\")"
...
* group.element[10].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\")"
* group.element[10].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\")"
...
* group.element[11].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\")"
* group.element[11].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\")"
...
* group.element[12].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5 NOT VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 NOT VALUED"
* group.element[12].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5 NOT VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 NOT VALUED"
...
* group.element[13].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5  VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 NOT VALUED"
* group.element[13].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5  VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 NOT VALUED"
...
* group.element[14].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5  VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 VALUED"
* group.element[14].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5  VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 VALUED"
...
* group.element[15].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5  NOT VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 VALUED"
* group.element[15].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\") AND XTN.5  NOT VALUED AND XTN.6 VALUED AND XTN.7 VALUED AND XTN.8 VALUED"
...
* group.element[18].target.dependsOn[0].value = "IF XTN.3 NOT IN (\"Internet\", \"X.400\")"
* group.element[18].target.dependsOn[0].display = "IF XTN.3 NOT IN (\"Internet\", \"X.400\")"
