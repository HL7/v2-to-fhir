// HL7 Data Type - FHIR E2_ XON[Organization] - Sheet1.csv
...
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1I12uSlywrGKF7o-5oF8YBGDaRq1BRZW6_cB6FlThzjU/edit?gid=0#gid=0"
...
* group[0].element[8].target.code = #identifier.type.coding.code
...
* group[0].element[8].target.display = "identifier.type.coding.code"
...
* group[0].element[9].target.code = #identifier.type.coding.system
...
* group[0].element[9].target.display = "identifier.type.coding.system"
...
* group[0].element[10].target.code = #identifier.value
...
* group[0].element[10].target.display = "identifier.value"
