...
Title: "Message ADT_A02null to Bundle Map"
* title = "Message ADT_A02null to Bundle Map"
...
* group.element[18].target.code = #EncounterHistory
* group.element[18].target.display = "EncounterHistory"
* group.element[18].target.dependsOn[0].property = "segment-map"
* group.element[18].target.dependsOn[0].value = "PV1[EncounterHistory]"
* group.element[18].target.dependsOn[1].property = "references"
* group.element[18].target.dependsOn[1].value = "EncounterHistory.subject.reference=Patient[1].id"
* group.element[18].target.product[0].property = "antlr"
* group.element[18].target.product[0].value = "IF PV1-43 VALUED"
...
* group.element[20].target.dependsOn[0].value = "PV1[Coverage]"
* group.element[20].target.dependsOn[1].property = "references"
* group.element[20].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
* group.element[20].target.product[0].property = "antlr"
* group.element[20].target.product[0].value = "IF PV1-20 VALUE"
