...
* group.element[19].code = #ADT_A02.PV2
...
* group.element[20].code = #ADT_A02:follow:PV1.ROL
...
* group.element[20].target.dependsOn[0].value = "ROL[Encounter-PractitionerRole]"
...
* group.element[21].target.dependsOn[0].value = "OBX[Observation]"
...
* group.element[22].code = #ADT_A02.OBSERVATION.OBX
...
* group.element[22].target.dependsOn[0].value = "OBX[Observation-Component]"
