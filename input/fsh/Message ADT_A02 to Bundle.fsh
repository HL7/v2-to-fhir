...
* group.element[4].code = #ADT_A02.MSH
...
* group.element[6].code = #ADT_A02.SFT
...
* group.element[7].target.dependsOn[0].value = "EVN[Provenance-Activity]"
...
* group.element[8].code = #ADT_A02.EVN
...
* group.element[11].code = #ADT_A02.PID
...
* group.element[12].code = #ADT_A02.PID
...
* group.element[13].code = #ADT_A02.PID
...
* group.element[14].code = #ADT_A02.PD1
...
* group.element[15].code = #ADT_A02:follow:PID.ROL
...
* group.element[16].code = #ADT_A02:follow:PID.ROL
...
* group.element[17].code = #ADT_A02:follow:PID.PRT
...
* group.element[18].code = #ADT_A02:follow:PID.PRT
...
* group.element[21].code = #ADT_A02.PV1
...
* group.element[22].code = #ADT_A02.PV2
...
* group.element[23].code = #ADT_A02:follow:PV1.ROL
...
* group.element[25].code = #ADT_A02.OBSERVATION.OBX
