...
Title: "Segment ORCnull to Immunization Map"
* title = "Segment ORCnull to Immunization Map"
...
* group.element[6].target.dependsOn[0].value = "EIP[Identifier-FillerAssignedIdentifier]"
...
* group.element[7].target.dependsOn[0].value = "EIP[Identifier-PlacerAssignedIdentifier]"
...
* group.element[10].target.dependsOn[0].value = "\"OP\""
...
* group.element[11].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0443\""
