...
* group.element[0].display = "An Internet host name, in accordance with RFC 1035; or an IP address. Either in ASCII or as integers, with periods between components (â€œdottedâ€? notation)."
* group.element[0].target.equivalence = #equivalent
* group.element[0].target.code = #DNS
* group.element[0].target.display = "An Internet host name, in accordance with RFC 1035; or an IP address. Either in ASCII or as integers, with periods between components (â€œdottedâ€? notation)."
* group.element[1].code = #EUI64
* group.element[1].display = "IEEE 64-bit Extended Unique Identifier is comprised of a 24-bit company identifier and a 40-bit instance identifier. The value shall be formatted as 16 ASCII HEX digits, for example, â€œAABBCC1122334455â€?. The 24-bit company identifier, formally known as Organizationally Unique Identifier (OUI-24), is guaranteed to be globally unique. The 40-bit extensions are assigned by manufacturers. This identifier is often used in equipment interfaces (e.g., â€œMACâ€? address format for IPv4 & IPv6). [See http://standards.ieee.org/regauth/oui/tutorials/EUI64.html for a detailed explanation of the format.]"
...
* group.element[2].display = "Clinical Laboratory Improvement Amendments. Allows for the ability to designate organization identifier as a â€œCLIAâ€? assigned number (for labs)"
* group.element[2].target.equivalence = #equivalent
* group.element[2].target.code = #CLIA
* group.element[2].target.display = "Clinical Laboratory Improvement Amendments. Allows for the ability to designate organization identifier as a â€œCLIAâ€? assigned number (for labs)"
* group.element[3].code = #CLIP
* group.element[3].display = "Clinical laboratory Improvement Program. Allows for the ability to designate organization identifier as a â€œCLIPâ€? assigned number (for labs). Used by US Department of Defense."
* group.element[3].target.equivalence = #equivalent
* group.element[3].target.code = #CLIP
* group.element[3].target.display = "Clinical laboratory Improvement Program. Allows for the ability to designate organization identifier as a â€œCLIPâ€? assigned number (for labs). Used by US Department of Defense."
