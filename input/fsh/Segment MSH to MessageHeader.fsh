...
* group.element[1].target.code = #source[1]
* group.element[1].target.display = "source[1]"
* group.element[1].target.comment = "1"
* group.element[1].target.dependsOn[0].property = "references"
* group.element[1].target.dependsOn[0].value = "BackboneElement"
* group.element[1].target.product[0].property = "antlr"
* group.element[1].target.product[0].value = "IF MSH-24 IS VALUED AND MSH-24.1 NOT VALUED"
...
* group.element[14].target.code = #source[1]
* group.element[14].target.display = "source[1]"
* group.element[14].target.comment = "1"
* group.element[14].target.dependsOn[0].property = "references"
* group.element[14].target.dependsOn[0].value = "BackboneElement"
...
* group.element[15].target.code = #source[1].endpoint.extension-data-absent-reason
* group.element[15].target.display = "source[1].endpoint.extension-data-absent-reason"
...
* group.element[16].target.code = #destination[1]
* group.element[16].target.display = "destination[1]"
* group.element[16].target.comment = "-1"
* group.element[16].target.dependsOn[0].property = "references"
* group.element[16].target.dependsOn[0].value = "uri"
...
* group.element[17].target.code = #destination[1].endpoint.extension-data-absent-reason
* group.element[17].target.display = "destination[1].endpoint.extension-data-absent-reason"
* group.element[17].target.product[0].property = "antlr"
* group.element[17].target.product[0].value = "IF MSH-25 NOT VALUED AND MSH-5 NOT VALUED"
