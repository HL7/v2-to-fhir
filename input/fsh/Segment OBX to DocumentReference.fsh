...
Title: "Segment OBXnull to DocumentReference Map"
* title = "Segment OBXnull to DocumentReference Map"
...
* group.element[0].target.dependsOn[0].value = "ED[Attachment]"
* group.element[0].target.product[0].property = "antlr"
* group.element[0].target.product[0].value = "IF OBX-2=\"ED\""
...
* group.element[1].target.product[0].value = "IF OBX-2=\"FT\""
...
* group.element[2].target.dependsOn[0].value = "\"text/hl7v2\""
* group.element[2].target.product[0].property = "antlr"
* group.element[2].target.product[0].value = "IF OBX-2=\"FT\""
...
* group.element[3].target.product[0].value = "IF OBX-2=\"RP\""
...
* group.element[4].target.product[0].value = "IF OBX-2=\"TX\""
...
* group.element[5].target.dependsOn[0].value = "\"application/text\""
* group.element[5].target.product[0].property = "antlr"
* group.element[5].target.product[0].value = "IF OBX-2=\"TX\""
