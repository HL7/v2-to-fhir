...
* group.element[16].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[17].target.comment = "Need to add text on converting NA to SampledData"
...
* group.element[19].target.comment = "We are for now addressing Base64 that cover .pdf, pictures and other binaries.  If somebody does this, we will address those."
...
* group.element[21].target.comment = "To be resolved when we resolve DocumentReference and valueAttachment"
...
* group.element[22].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[23].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[28].target.comment = "If OBX-7 is sufficiently parseable, then the low, high, type, appliesTo, and/or age may be used."
...
* group.element[30].display = "Nature of Abnormal Test"
* group.element[30].target.equivalence = #equivalent
* group.element[30].target.code = #extension[2].uri
...
* group.element[30].target.display = "extension[2].uri"
* group.element[30].target.dependsOn[0].property = "value"
* group.element[30].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-nature-of-abnormal-test\""
...
* group.element[31].target.code = #extension[2].valueCodeableConcept
...
* group.element[31].target.display = "extension[2].valueCodeableConcept"
...
* group.element[31].target.dependsOn[1].value = "NatureOfAbnormalTesting"
...
* group.element[32].target.code = #status
...
* group.element[32].target.display = "status"
* group.element[32].target.dependsOn[0].property = "vocabulary-map"
* group.element[32].target.dependsOn[0].value = "ObservationStatus"
...
* group.element[33].target.code = #dataAbsentReason.coding[1].code
...
* group.element[33].target.display = "dataAbsentReason.coding[1].code"
* group.element[33].target.comment = "Needs to be requested"
* group.element[33].target.dependsOn[0].property = "value"
* group.element[33].target.dependsOn[0].value = "/cannot-be-obtained/"
* group.element[33].target.product[0].property = "antlr"
* group.element[33].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[34].target.code = #dataAbsentReason.coding[1].system
...
* group.element[35].target.code = #dataAbsentReason.coding[2].code
* group.element[35].target.display = "dataAbsentReason.coding[2].code"
* group.element[35].target.dependsOn[0].property = "value"
* group.element[35].target.dependsOn[0].value = "\"not-asked\""
* group.element[35].target.product[0].property = "antlr"
* group.element[35].target.product[0].value = "IF OBX-11 IS \"N\""
...
* group.element[36].target.code = #dataAbsentReason.coding[2].system
* group.element[36].target.display = "dataAbsentReason.coding[2].system"
...
* group.element[36].target.product[0].value = "IF OBX-11 IS \"N\""
* group.element[37].code = #OBX-14
...
* group.element[37].display = "Date/Time of the Observation"
* group.element[37].target.equivalence = #equivalent
* group.element[37].target.code = #effectiveDateTime
...
* group.element[37].target.display = "effectiveDateTime"
* group.element[38].code = #OBX-15
...
* group.element[38].display = "Producer's ID"
* group.element[38].target.equivalence = #equivalent
* group.element[38].target.code = #performer[2](Organization)
...
* group.element[38].target.display = "performer[2](Organization)"
...
* group.element[38].target.dependsOn[0].value = "CWE[Organization]"
* group.element[39].code = #OBX-15
...
* group.element[39].display = "Producer's ID"
* group.element[39].target.equivalence = #equivalent
* group.element[39].target.code = #performer[2](PractitionerRole)
* group.element[39].target.display = "performer[2](PractitionerRole)"
...
* group.element[40].target.code = #performer[1](PractitionerRole.practitioner(Practitioner))
...
* group.element[40].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[40].target.display = "performer[1](PractitionerRole.practitioner(Practitioner))"
* group.element[40].target.dependsOn[0].property = "data-type-map"
* group.element[40].target.dependsOn[0].value = "XCN[Practitioner]"
* group.element[41].code = #OBX-16
...
* group.element[41].extension[0].extension[0].valueCode = #"XCN"
...
* group.element[41].display = "Responsible Observer"
* group.element[41].target.equivalence = #equivalent
* group.element[41].target.code = #performer[1](PractitionerRole.code.coding.code)
...
* group.element[41].target.display = "performer[1](PractitionerRole.code.coding.code)"
* group.element[41].target.dependsOn[0].property = "value"
* group.element[41].target.dependsOn[0].value = "\"responsibleObserver\""
...
* group.element[42].target.code = #performer[1](PractitionerRole.code.coding.system)
...
* group.element[42].target.display = "performer[1](PractitionerRole.code.coding.system)"
* group.element[42].target.dependsOn[0].property = "value"
* group.element[42].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/practitioner-role\""
* group.element[43].code = #OBX-17
...
* group.element[43].display = "Observation Method"
* group.element[43].target.equivalence = #equivalent
* group.element[43].target.code = #method
...
* group.element[44].display = "Equipment Instance Identifier"
* group.element[44].target.equivalence = #equivalent
* group.element[44].target.code = #device(Device.identifier)
...
* group.element[44].target.display = "device(Device.identifier)"
...
* group.element[45].display = "Date/Time of the Analysis"
* group.element[45].target.equivalence = #equivalent
* group.element[45].target.code = #extension[2].url
...
* group.element[45].target.extension[0].extension[0].valueCode = #"uri"
...
* group.element[45].target.display = "extension[2].url"
* group.element[45].target.comment = "\"http://hl7.org/fhir/StructureDefinition/observation-analysis-date-time\""
* group.element[46].code = #OBX-19
...
* group.element[46].extension[0].extension[0].valueCode = #"DTM"
...
* group.element[46].display = "Date/Time of the Analysis"
* group.element[46].target.equivalence = #equivalent
* group.element[46].target.code = #extension[2].valueDateTime
...
* group.element[46].target.extension[0].extension[0].valueCode = #"dateTime"
...
* group.element[46].target.display = "extension[2].valueDateTime"
* group.element[47].code = #OBX-20
...
* group.element[47].display = "Observation Site"
* group.element[47].target.equivalence = #equivalent
* group.element[47].target.code = #bodySite
...
* group.element[48].display = "Observation Instance Identifier"
* group.element[48].target.equivalence = #equivalent
* group.element[48].target.code = #identifier
...
* group.element[48].target.display = "identifier"
...
* group.element[49].display = "Observation Instance Identifier"
* group.element[49].target.equivalence = #equivalent
* group.element[49].target.code = #identifier.type.coding.code
...
* group.element[49].target.extension[0].extension[0].valueCode = #"code"
...
* group.element[49].target.display = "identifier.type.coding.code"
* group.element[49].target.dependsOn[0].property = "value"
* group.element[49].target.dependsOn[0].value = "\"FILL\""
* group.element[50].code = #OBX-23
...
* group.element[50].extension[0].extension[0].valueCode = #"XON"
...
* group.element[50].display = "Performing Organization Name"
* group.element[50].target.equivalence = #equivalent
* group.element[50].target.code = #performer[2](Organization)
...
* group.element[50].target.extension[0].extension[0].valueCode = #"Reference(Organization)"
...
* group.element[50].target.display = "performer[2](Organization)"
* group.element[50].target.dependsOn[0].property = "data-type-map"
* group.element[50].target.dependsOn[0].value = "XON[Organization]"
* group.element[50].target.product[0].property = "antlr"
* group.element[50].target.product[0].value = "IF OBX-25 NOT VALUED"
* group.element[51].code = #OBX-23
...
* group.element[51].extension[0].extension[0].valueCode = #"XON"
...
* group.element[51].display = "Performing Organization Name"
* group.element[51].target.equivalence = #equivalent
* group.element[51].target.code = #performer[2](PractitionerRole[1].organization(Organization))
...
* group.element[51].target.extension[0].extension[0].valueCode = #"Reference(Organization)"
...
* group.element[51].target.display = "performer[2](PractitionerRole[1].organization(Organization))"
* group.element[51].target.dependsOn[0].property = "data-type-map"
* group.element[51].target.dependsOn[0].value = "XON[Organization]"
* group.element[51].target.product[0].property = "antlr"
* group.element[51].target.product[0].value = "IF OBX-25 VALUED"
* group.element[52].code = #OBX-24
...
* group.element[52].extension[0].extension[0].valueCode = #"XAD"
...
* group.element[52].display = "Performing Organization Address"
* group.element[52].target.equivalence = #equivalent
* group.element[52].target.code = #performer[2](Organization.address)
...
* group.element[52].target.extension[0].extension[0].valueCode = #"Address"
...
* group.element[53].extension[0].extension[0].valueCode = #"XAD"
...
* group.element[53].display = "Performing Organization Address"
* group.element[53].target.equivalence = #equivalent
* group.element[53].target.code = #performer[2](PractitionerRole[1].organization(Organization.address))
...
* group.element[53].target.extension[0].extension[0].valueCode = #"Address"
...
* group.element[53].target.display = "performer[2](PractitionerRole[1].organization(Organization.address))"
* group.element[53].target.dependsOn[0].property = "data-type-map"
* group.element[53].target.dependsOn[0].value = "XAD[Address]"
* group.element[53].target.product[0].property = "antlr"
* group.element[53].target.product[0].value = "IF OBX-25 VALUED"
* group.element[54].code = #OBX-25
...
* group.element[54].display = "Performing Organization Medical Director"
* group.element[54].target.equivalence = #equivalent
* group.element[54].target.code = #performer[2](PractitionerRole[1].practitioner)
...
* group.element[54].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[54].target.display = "performer[2](PractitionerRole[1].practitioner)"
* group.element[54].target.dependsOn[0].property = "data-type-map"
* group.element[54].target.dependsOn[0].value = "XCN[PractitionerRole]"
* group.element[55].code = #OBX-25
...
* group.element[55].display = "Performing Organization Medical Director"
* group.element[55].target.equivalence = #equivalent
* group.element[55].target.code = #performer[2](PractitionerRole[1].code.coding.code)
...
* group.element[55].target.display = "performer[2](PractitionerRole[1].code.coding.code)"
* group.element[55].target.dependsOn[0].property = "value"
* group.element[55].target.dependsOn[0].value = "\"MDIR\""
...
* group.element[56].target.code = #performer[2](PractitionerRole[1].code.coding.system)
* group.element[56].target.display = "performer[2](PractitionerRole[1].code.coding.system)"
* group.element[56].target.dependsOn[0].property = "value"
* group.element[56].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0912\""
...
* group.element[57].target.code = #extension[1].uri
...
* group.element[57].target.extension[0].extension[0].valueCode = #"Reference"
...
* group.element[58].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[58].display = "Observation Related Specimen Identifier"
* group.element[58].target.equivalence = #equivalent
* group.element[58].target.code = #extension[1].valueReference(Group.member.entity(Specimen.identifier[1])
* group.element[58].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[58].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[58].target.extension[0].extension[0].valueInteger = 0
* group.element[58].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[58].target.extension[0].extension[1].valueInteger = 1
* group.element[58].target.display = "extension[1].valueReference(Group.member.entity(Specimen.identifier[1])"
* group.element[58].target.product[0].property = "antlr"
* group.element[58].target.product[0].value = "IF OBX-33 COUNT>1"
...
* group.element[59].target.code = #extension[2].uri
* group.element[59].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[59].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[59].target.extension[0].extension[0].valueInteger = 0
* group.element[59].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[59].target.extension[0].extension[1].valueInteger = 1
* group.element[59].target.display = "extension[2].uri"
...
* group.element[60].target.code = #extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))
...
* group.element[60].target.display = "extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))"
...
* group.element[61].target.code = #specimen(Specimen.identifier[1])
...
* group.element[61].target.extension[0].extension[0].valueCode = #"Identifier"
* group.element[61].target.display = "specimen(Specimen.identifier[1])"
* group.element[61].target.dependsOn[0].property = "data-type-map"
* group.element[61].target.dependsOn[0].value = "EIP[Identifier-PlacerAssignedIdentifier]"
...
* group.element[62].target.code = #specimen(Specimen.identifier[2])
...
* group.element[62].target.extension[0].extension[0].valueCode = #"Identifier"
* group.element[62].target.display = "specimen(Specimen.identifier[2])"
* group.element[62].target.dependsOn[0].property = "data-type-map"
* group.element[62].target.dependsOn[0].value = "EIP[Identifier-FillerAssignedIdentifier]"
