...
* group.element[14].target.code = #valueRatio
...
* group.element[14].target.display = "valueRatio"
...
* group.element[15].target.code = #valueRange
...
* group.element[15].target.display = "valueRange"
...
* group.element[16].target.code = #valueString
...
* group.element[16].target.display = "valueString"
...
* group.element[17].target.code = #valueQuantity
...
* group.element[17].target.display = "valueQuantity"
* group.element[17].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[18].target.code = #valueString
...
* group.element[18].target.display = "valueString"
* group.element[18].target.dependsOn[0].property = "value"
* group.element[18].target.dependsOn[0].value = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4"
* group.element[18].target.product[0].property = "narrative"
* group.element[18].target.product[0].value = "If line 19 through 22 all fail while OBX-2 = SN"
...
* group.element[19].target.code = #valueSampledData
...
* group.element[19].target.extension[0].extension[0].valueCode = #"SampledData"
* group.element[19].target.display = "valueSampledData"
* group.element[19].target.comment = "Need to add text on converting NA to SampledData"
* group.element[19].target.product[0].property = "antlr"
* group.element[19].target.product[0].value = "IF OBX-2 EQUALS \"NA\""
...
* group.element[21].target.comment = "We are for now addressing Base64 that cover .pdf, pictures and other binaries.  If somebody does this, we will address those."
...
* group.element[22].target.code = #extension[1].url
...
* group.element[22].target.display = "extension[1].url"
* group.element[22].target.dependsOn[0].property = "value"
* group.element[22].target.dependsOn[0].value = "\"https://hl7.org/fhir/R5/StructureDefinition/extension-Observation.valueAttachment"
...
* group.element[23].target.code = #extension[1].valueAttachment
...
* group.element[23].target.extension[0].extension[0].valueCode = #"Attachment"
...
* group.element[23].target.display = "extension[1].valueAttachment"
* group.element[23].target.comment = "To be resolved when we resolve DocumentReference and valueAttachment"
* group.element[23].target.dependsOn[0].property = "data-type-map"
* group.element[23].target.dependsOn[0].value = "ED[Attachment]"
...
* group.element[24].target.code = #valueQuantity
...
* group.element[24].target.display = "valueQuantity"
* group.element[24].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[24].target.product[0].value = "IF OBX-2 EQUALS \"SN\" and OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[25].target.code = #valueQuantity
...
* group.element[25].target.display = "valueQuantity"
...
* group.element[26].target.code = #valueRange.low
...
* group.element[26].target.display = "valueRange.low"
...
* group.element[27].target.code = #valueRange.high
...
* group.element[27].target.display = "valueRange.high"
...
* group.element[27].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[28].target.code = #valueRatio.numerator
...
* group.element[28].target.display = "valueRatio.numerator"
...
* group.element[29].target.code = #valueRatio.denominator
...
* group.element[29].target.display = "valueRatio.denominator"
...
* group.element[29].target.product[0].value = "IF (OBX-2 EQUALS \"SN\" AND (OBX-5.3 IN (\":\", \"/\"))"
* group.element[30].code = #OBX-7
...
* group.element[30].display = "References Range"
* group.element[30].target.equivalence = #equivalent
* group.element[30].target.code = #referenceRange.text
...
* group.element[30].target.extension[0].extension[0].valueCode = #"string"
...
* group.element[30].target.display = "referenceRange.text"
* group.element[30].target.comment = "If OBX-7 is sufficiently parseable, then the low, high, type, appliesTo, and/or age may be used."
* group.element[31].code = #OBX-8
...
* group.element[31].display = "Interpretation Codes"
* group.element[31].target.equivalence = #equivalent
* group.element[31].target.code = #interpretation
...
* group.element[31].target.display = "interpretation"
* group.element[31].target.dependsOn[0].property = "data-type-map"
* group.element[31].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[31].target.dependsOn[1].property = "vocabulary-map"
* group.element[31].target.dependsOn[1].value = "InterpretationCode"
...
* group.element[32].target.code = #extension[2].uri
...
* group.element[32].target.display = "extension[2].uri"
* group.element[32].target.dependsOn[0].property = "value"
* group.element[32].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-nature-of-abnormal-test\""
...
* group.element[33].target.code = #extension[2].valueCodeableConcept
...
* group.element[33].target.display = "extension[2].valueCodeableConcept"
...
* group.element[33].target.dependsOn[1].value = "NatureOfAbnormalTesting"
...
* group.element[34].target.code = #status
...
* group.element[34].target.display = "status"
* group.element[34].target.dependsOn[0].property = "vocabulary-map"
* group.element[34].target.dependsOn[0].value = "ObservationStatus"
...
* group.element[35].target.code = #dataAbsentReason.coding[1].code
...
* group.element[35].target.display = "dataAbsentReason.coding[1].code"
* group.element[35].target.comment = "Needs to be requested"
* group.element[35].target.dependsOn[0].property = "value"
* group.element[35].target.dependsOn[0].value = "/cannot-be-obtained/"
* group.element[35].target.product[0].property = "antlr"
* group.element[35].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[36].target.code = #dataAbsentReason.coding[1].system
...
* group.element[36].target.display = "dataAbsentReason.coding[1].system"
* group.element[36].target.dependsOn[0].property = "value"
* group.element[36].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/data-absent-reason\""
...
* group.element[37].target.code = #dataAbsentReason.coding[2].code
* group.element[37].target.display = "dataAbsentReason.coding[2].code"
* group.element[37].target.dependsOn[0].property = "value"
* group.element[37].target.dependsOn[0].value = "\"not-asked\""
* group.element[37].target.product[0].property = "antlr"
* group.element[37].target.product[0].value = "IF OBX-11 IS \"N\""
...
* group.element[38].target.code = #dataAbsentReason.coding[2].system
* group.element[38].target.display = "dataAbsentReason.coding[2].system"
* group.element[38].target.dependsOn[0].property = "value"
* group.element[38].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/data-absent-reason\""
* group.element[38].target.product[0].property = "antlr"
* group.element[38].target.product[0].value = "IF OBX-11 IS \"N\""
* group.element[39].code = #OBX-14
...
* group.element[39].display = "Date/Time of the Observation"
* group.element[39].target.equivalence = #equivalent
* group.element[39].target.code = #effectiveDateTime
...
* group.element[39].target.extension[0].extension[0].valueCode = #"dateTime"
...
* group.element[39].target.display = "effectiveDateTime"
* group.element[40].code = #OBX-15
...
* group.element[40].display = "Producer's ID"
* group.element[40].target.equivalence = #equivalent
* group.element[40].target.code = #performer[2](Organization)
...
* group.element[40].target.display = "performer[2](Organization)"
* group.element[40].target.comment = "We are mapping this to an identifier considering the definition (used for a unique identifier of the producer), although that does not fit the use of the CWE data type in HL7 v2.  Depending on context (e.g., US CLIA or IHE LTW, or ILW) this may reflect a location (US CLIA) or an organization (IHE LTW or ILW)."
* group.element[40].target.dependsOn[0].property = "data-type-map"
* group.element[40].target.dependsOn[0].value = "CWE[Organization]"
* group.element[41].code = #OBX-15
...
* group.element[41].display = "Producer's ID"
* group.element[41].target.equivalence = #equivalent
* group.element[41].target.code = #performer[2](PractitionerRole)
* group.element[41].target.display = "performer[2](PractitionerRole)"
* group.element[42].code = #OBX-16
...
* group.element[42].extension[0].extension[0].valueCode = #"XCN"
...
* group.element[42].display = "Responsible Observer"
* group.element[42].target.equivalence = #equivalent
* group.element[42].target.code = #performer[1](PractitionerRole.practitioner(Practitioner))
...
* group.element[42].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[42].target.display = "performer[1](PractitionerRole.practitioner(Practitioner))"
* group.element[42].target.dependsOn[0].property = "data-type-map"
* group.element[42].target.dependsOn[0].value = "XCN[Practitioner]"
* group.element[43].code = #OBX-16
...
* group.element[43].extension[0].extension[0].valueCode = #"XCN"
...
* group.element[43].display = "Responsible Observer"
* group.element[43].target.equivalence = #equivalent
* group.element[43].target.code = #performer[1](PractitionerRole.code.coding.code)
...
* group.element[43].target.display = "performer[1](PractitionerRole.code.coding.code)"
* group.element[43].target.dependsOn[0].property = "value"
* group.element[43].target.dependsOn[0].value = "\"responsibleObserver\""
...
* group.element[44].target.code = #performer[1](PractitionerRole.code.coding.system)
...
* group.element[44].target.extension[0].extension[0].valueCode = #"CodeableConcept"
...
* group.element[44].target.display = "performer[1](PractitionerRole.code.coding.system)"
* group.element[44].target.dependsOn[0].property = "value"
* group.element[44].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/practitioner-role\""
* group.element[45].code = #OBX-17
...
* group.element[45].display = "Observation Method"
* group.element[45].target.equivalence = #equivalent
* group.element[45].target.code = #method
...
* group.element[46].display = "Equipment Instance Identifier"
* group.element[46].target.equivalence = #equivalent
* group.element[46].target.code = #device(Device.identifier)
...
* group.element[46].target.display = "device(Device.identifier)"
* group.element[46].target.dependsOn[0].property = "data-type-map"
* group.element[46].target.dependsOn[0].value = "EI[Identifier-Extension]"
* group.element[47].code = #OBX-19
...
* group.element[47].extension[0].extension[0].valueCode = #"DTM"
...
* group.element[47].display = "Date/Time of the Analysis"
* group.element[47].target.equivalence = #equivalent
* group.element[47].target.code = #extension[2].url
...
* group.element[47].target.display = "extension[2].url"
* group.element[47].target.comment = "\"http://hl7.org/fhir/StructureDefinition/observation-analysis-date-time\""
* group.element[48].code = #OBX-19
...
* group.element[48].display = "Date/Time of the Analysis"
* group.element[48].target.equivalence = #equivalent
* group.element[48].target.code = #extension[2].valueDateTime
...
* group.element[48].target.display = "extension[2].valueDateTime"
* group.element[49].code = #OBX-20
...
* group.element[49].display = "Observation Site"
* group.element[49].target.equivalence = #equivalent
* group.element[49].target.code = #bodySite
...
* group.element[49].target.display = "bodySite"
* group.element[49].target.comment = "The cardinality of Observation.bodySite is 0..1 while the source allows for multiple body sites.  As we are not aware of anybody populating multiples in HL7 v2, we did not provide further mapping guidance.  If you need to support multiples, please submit a gForge to OO for the HL7 v2 to FHIR mapping Implementation Guide."
* group.element[49].target.dependsOn[0].property = "data-type-map"
* group.element[49].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[50].code = #OBX-21
...
* group.element[50].display = "Observation Instance Identifier"
* group.element[50].target.equivalence = #equivalent
* group.element[50].target.code = #identifier
...
* group.element[50].target.display = "identifier"
* group.element[50].target.dependsOn[0].property = "data-type-map"
* group.element[50].target.dependsOn[0].value = "EI[Identifier-Extension]"
* group.element[51].code = #OBX-21
...
* group.element[51].display = "Observation Instance Identifier"
* group.element[51].target.equivalence = #equivalent
* group.element[51].target.code = #identifier.type.coding.code
...
* group.element[51].target.display = "identifier.type.coding.code"
* group.element[51].target.dependsOn[0].property = "value"
* group.element[51].target.dependsOn[0].value = "\"FILL\""
* group.element[52].code = #OBX-23
...
* group.element[52].extension[0].extension[0].valueCode = #"XON"
...
* group.element[52].display = "Performing Organization Name"
* group.element[52].target.equivalence = #equivalent
* group.element[52].target.code = #performer[2](Organization)
...
* group.element[52].target.extension[0].extension[0].valueCode = #"Reference(Organization)"
...
* group.element[52].target.display = "performer[2](Organization)"
* group.element[52].target.dependsOn[0].property = "data-type-map"
* group.element[52].target.dependsOn[0].value = "XON[Organization]"
* group.element[52].target.product[0].property = "antlr"
* group.element[52].target.product[0].value = "IF OBX-25 NOT VALUED"
* group.element[53].code = #OBX-23
...
* group.element[53].extension[0].extension[0].valueCode = #"XON"
...
* group.element[53].display = "Performing Organization Name"
* group.element[53].target.equivalence = #equivalent
* group.element[53].target.code = #performer[2](PractitionerRole[1].organization(Organization))
...
* group.element[53].target.extension[0].extension[0].valueCode = #"Reference(Organization)"
...
* group.element[53].target.display = "performer[2](PractitionerRole[1].organization(Organization))"
* group.element[53].target.dependsOn[0].property = "data-type-map"
* group.element[53].target.dependsOn[0].value = "XON[Organization]"
* group.element[53].target.product[0].property = "antlr"
* group.element[53].target.product[0].value = "IF OBX-25 VALUED"
* group.element[54].code = #OBX-24
...
* group.element[54].extension[0].extension[0].valueCode = #"XAD"
...
* group.element[54].display = "Performing Organization Address"
* group.element[54].target.equivalence = #equivalent
* group.element[54].target.code = #performer[2](Organization.address)
...
* group.element[54].target.extension[0].extension[0].valueCode = #"Address"
...
* group.element[55].extension[0].extension[0].valueCode = #"XAD"
...
* group.element[55].display = "Performing Organization Address"
* group.element[55].target.equivalence = #equivalent
* group.element[55].target.code = #performer[2](PractitionerRole[1].organization(Organization.address))
...
* group.element[55].target.extension[0].extension[0].valueCode = #"Address"
...
* group.element[55].target.display = "performer[2](PractitionerRole[1].organization(Organization.address))"
* group.element[55].target.dependsOn[0].property = "data-type-map"
* group.element[55].target.dependsOn[0].value = "XAD[Address]"
* group.element[55].target.product[0].property = "antlr"
* group.element[55].target.product[0].value = "IF OBX-25 VALUED"
* group.element[56].code = #OBX-25
...
* group.element[56].extension[0].extension[0].valueCode = #"XCN"
...
* group.element[56].display = "Performing Organization Medical Director"
* group.element[56].target.equivalence = #equivalent
* group.element[56].target.code = #performer[2](PractitionerRole[1].practitioner)
...
* group.element[56].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[56].target.display = "performer[2](PractitionerRole[1].practitioner)"
* group.element[56].target.dependsOn[0].property = "data-type-map"
* group.element[56].target.dependsOn[0].value = "XCN[PractitionerRole]"
* group.element[57].code = #OBX-25
...
* group.element[57].extension[0].extension[0].valueCode = #"XCN"
...
* group.element[57].display = "Performing Organization Medical Director"
* group.element[57].target.equivalence = #equivalent
* group.element[57].target.code = #performer[2](PractitionerRole[1].code.coding.code)
...
* group.element[57].target.extension[0].extension[0].valueCode = #"code"
* group.element[57].target.display = "performer[2](PractitionerRole[1].code.coding.code)"
* group.element[57].target.dependsOn[0].property = "value"
* group.element[57].target.dependsOn[0].value = "\"MDIR\""
...
* group.element[58].target.code = #performer[2](PractitionerRole[1].code.coding.system)
* group.element[58].target.display = "performer[2](PractitionerRole[1].code.coding.system)"
* group.element[58].target.dependsOn[0].property = "value"
* group.element[58].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0912\""
* group.element[59].code = #OBX-33
...
* group.element[59].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[59].display = "Observation Related Specimen Identifier"
* group.element[59].target.equivalence = #equivalent
* group.element[59].target.code = #extension[1].uri
...
* group.element[59].target.extension[0].extension[0].valueCode = #"Reference"
...
* group.element[59].target.display = "extension[1].uri"
...
* group.element[59].target.dependsOn[0].value = "\"http://hl7.org/fhir/5.0/StructureDefinition/extension-Observation.specimen"
* group.element[59].target.product[0].property = "antlr"
* group.element[59].target.product[0].value = "IF OBX-33 COUNT>1"
* group.element[60].code = #OBX-33
...
* group.element[60].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[60].display = "Observation Related Specimen Identifier"
* group.element[60].target.equivalence = #equivalent
* group.element[60].target.code = #extension[1].valueReference(Group.member.entity(Specimen.identifier[1])
* group.element[60].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[60].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[60].target.extension[0].extension[0].valueInteger = 0
* group.element[60].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[60].target.extension[0].extension[1].valueInteger = 1
* group.element[60].target.display = "extension[1].valueReference(Group.member.entity(Specimen.identifier[1])"
* group.element[60].target.product[0].property = "antlr"
* group.element[60].target.product[0].value = "IF OBX-33 COUNT>1"
* group.element[61].code = #OBX-33
...
* group.element[61].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[61].display = "Observation Related Specimen Identifier"
* group.element[61].target.equivalence = #equivalent
* group.element[61].target.code = #extension[2].uri
* group.element[61].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[61].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[61].target.extension[0].extension[0].valueInteger = 0
* group.element[61].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[61].target.extension[0].extension[1].valueInteger = 1
* group.element[61].target.display = "extension[2].uri"
* group.element[61].target.dependsOn[0].property = "value"
* group.element[61].target.dependsOn[0].value = "\"http://hl7.org/fhir/5.0/StructureDefinition/extension-Observation.specimen"
* group.element[61].target.product[0].property = "antlr"
* group.element[61].target.product[0].value = "IF OBX-33 COUNT>1"
* group.element[62].code = #OBX-33
...
* group.element[62].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[62].display = "Observation Related Specimen Identifier"
* group.element[62].target.equivalence = #equivalent
* group.element[62].target.code = #extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))
* group.element[62].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[62].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[62].target.extension[0].extension[0].valueInteger = 0
* group.element[62].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[62].target.extension[0].extension[1].valueInteger = 1
* group.element[62].target.display = "extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))"
* group.element[62].target.product[0].property = "antlr"
* group.element[62].target.product[0].value = "IF OBX-33 COUNT>1"
* group.element[63].code = #OBX-33
...
* group.element[63].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[63].display = "Observation Related Specimen Identifier"
* group.element[63].target.equivalence = #equivalent
* group.element[63].target.code = #specimen(Specimen.identifier[1])
...
* group.element[63].target.extension[0].extension[0].valueCode = #"Identifier"
* group.element[63].target.display = "specimen(Specimen.identifier[1])"
* group.element[63].target.dependsOn[0].property = "data-type-map"
* group.element[63].target.dependsOn[0].value = "EIP[Identifier-PlacerAssignedIdentifier]"
* group.element[63].target.product[0].property = "antlr"
* group.element[63].target.product[0].value = "IF OBX-33 COUNT=1"
* group.element[64].code = #OBX-33
...
* group.element[64].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[64].display = "Observation Related Specimen Identifier"
* group.element[64].target.equivalence = #equivalent
* group.element[64].target.code = #specimen(Specimen.identifier[2])
...
* group.element[64].target.extension[0].extension[0].valueCode = #"Identifier"
* group.element[64].target.display = "specimen(Specimen.identifier[2])"
* group.element[64].target.dependsOn[0].property = "data-type-map"
* group.element[64].target.dependsOn[0].value = "EIP[Identifier-FillerAssignedIdentifier]"
* group.element[64].target.product[0].property = "antlr"
* group.element[64].target.product[0].value = "IF OBX-33 COUNT=1"
