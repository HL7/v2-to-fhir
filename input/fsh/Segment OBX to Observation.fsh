...
* group.element[24].target.code = #valueQuantity[1]
...
* group.element[24].target.display = "valueQuantity[1]"
...
* group.element[26].target.code = #valueRange[1].low
...
* group.element[26].target.display = "valueRange[1].low"
...
* group.element[27].target.code = #valueRange[1].high
...
* group.element[27].target.display = "valueRange[1].high"
...
* group.element[28].target.code = #valueRatio[1].numerator
...
* group.element[28].target.display = "valueRatio[1].numerator"
...
* group.element[29].target.code = #valueRatio[1].denominator
...
* group.element[29].target.display = "valueRatio[1].denominator"
...
* group.element[35].target.code = #status.extension[1].url
...
* group.element[35].target.display = "status.extension[1].url"
...
* group.element[36].target.code = #status.extension[1].valueCodeableConcept.coding.code
...
* group.element[36].target.display = "status.extension[1].valueCodeableConcept.coding.code"
...
* group.element[37].target.code = #status.extension[1].valueCodeableConcept.coding.system
...
* group.element[37].target.display = "status.extension[1].valueCodeableConcept.coding.system"
...
* group.element[38].target.code = #dataAbsentReason.coding[2].code
* group.element[38].target.display = "dataAbsentReason.coding[2].code"
...
* group.element[39].target.code = #dataAbsentReason.coding[2].system
* group.element[39].target.display = "dataAbsentReason.coding[2].system"
* group.element[40].code = #OBX-14
...
* group.element[40].display = "Date/Time of the Observation"
* group.element[40].target.equivalence = #equivalent
* group.element[40].target.code = #effectiveDateTime
...
* group.element[40].target.display = "effectiveDateTime"
...
* group.element[42].target.code = #performer[2](PractitionerRole)
* group.element[42].target.display = "performer[2](PractitionerRole)"
...
* group.element[43].target.code = #performer[1](PractitionerRole.practitioner(Practitioner))
...
* group.element[43].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[43].target.display = "performer[1](PractitionerRole.practitioner(Practitioner))"
...
* group.element[44].target.code = #performer[1](PractitionerRole.code.coding.code)
...
* group.element[44].target.display = "performer[1](PractitionerRole.code.coding.code)"
...
* group.element[45].target.code = #performer[1](PractitionerRole.code.coding.system)
...
* group.element[45].target.display = "performer[1](PractitionerRole.code.coding.system)"
* group.element[46].code = #OBX-17
...
* group.element[46].display = "Observation Method"
* group.element[46].target.equivalence = #equivalent
* group.element[46].target.code = #method
...
* group.element[46].target.display = "method"
* group.element[46].target.comment = "The cardinality of Observation.method is 0..1 while the source allows for multiple methods.  As we are not aware of anybody populating multiples in HL7 v2, we did not provide further mapping guidance.  If you need to support multiples, please submit a gForge to OO for the HL7 v2 to FHIR mapping Implementation Guide."
* group.element[47].code = #OBX-18
...
* group.element[47].display = "Equipment Instance Identifier"
* group.element[47].target.equivalence = #equivalent
* group.element[47].target.code = #device(Device.identifier)
...
* group.element[47].target.display = "device(Device.identifier)"
...
* group.element[48].target.code = #extension[2].url
...
* group.element[48].target.display = "extension[2].url"
* group.element[48].target.comment = "\"http://hl7.org/fhir/StructureDefinition/observation-analysis-date-time\""
...
* group.element[49].target.code = #extension[2].valueDateTime
...
* group.element[49].target.display = "extension[2].valueDateTime"
* group.element[50].code = #OBX-20
...
* group.element[50].display = "Observation Site"
* group.element[50].target.equivalence = #equivalent
* group.element[50].target.code = #bodySite
...
* group.element[50].target.extension[0].extension[0].valueCode = #"CodeableConcept"
...
* group.element[50].target.display = "bodySite"
* group.element[50].target.comment = "The cardinality of Observation.bodySite is 0..1 while the source allows for multiple body sites.  As we are not aware of anybody populating multiples in HL7 v2, we did not provide further mapping guidance.  If you need to support multiples, please submit a gForge to OO for the HL7 v2 to FHIR mapping Implementation Guide."
...
* group.element[51].target.code = #identifier
...
* group.element[51].target.display = "identifier"
...
* group.element[52].target.code = #identifier.type.coding.code
...
* group.element[52].target.extension[0].extension[0].valueCode = #"code"
...
* group.element[52].target.display = "identifier.type.coding.code"
...
* group.element[53].target.code = #performer[2](Organization)
...
* group.element[53].target.display = "performer[2](Organization)"
...
* group.element[54].target.code = #performer[2](PractitionerRole[1].organization(Organization))
...
* group.element[54].target.display = "performer[2](PractitionerRole[1].organization(Organization))"
...
* group.element[55].target.code = #performer[2](Organization.address)
...
* group.element[55].target.display = "performer[2](Organization.address)"
...
* group.element[56].target.code = #performer[2](PractitionerRole[1].organization(Organization.address))
...
* group.element[56].target.display = "performer[2](PractitionerRole[1].organization(Organization.address))"
...
* group.element[57].target.code = #performer[2](PractitionerRole[1].practitioner)
...
* group.element[57].target.extension[0].extension[0].valueCode = #"Reference(PractitionerRole)"
...
* group.element[57].target.display = "performer[2](PractitionerRole[1].practitioner)"
...
* group.element[58].target.code = #performer[2](PractitionerRole[1].code.coding.code)
...
* group.element[58].target.extension[0].extension[0].valueCode = #"code"
* group.element[58].target.display = "performer[2](PractitionerRole[1].code.coding.code)"
...
* group.element[59].target.code = #performer[2](PractitionerRole[1].code.coding.system)
* group.element[59].target.display = "performer[2](PractitionerRole[1].code.coding.system)"
* group.element[60].code = #OBX-29
...
* group.element[60].extension[0].extension[0].valueCode = #"ID"
...
* group.element[60].display = "Observation Type"
* group.element[60].target.equivalence = #equivalent
* group.element[60].target.code = #category[1].coding.code
...
* group.element[60].target.extension[0].extension[0].valueCode = #"code"
...
* group.element[60].target.display = "category[1].coding.code"
...
* group.element[61].target.code = #category[1].coding.system
...
* group.element[61].target.display = "category[1].coding.system"
* group.element[62].code = #OBX-30
...
* group.element[62].display = "Observation Sub-Type"
* group.element[62].target.equivalence = #equivalent
* group.element[62].target.code = #extension[2].url
...
* group.element[62].target.display = "extension[2].url"
* group.element[62].target.comment = "The sub type was necessary in v2 to distinguish purpose of the observation when it appears in a message in the same group (e.g., answers to ask at order entry questions with actual results ).  Within FHIR flagging the observation may not be necessary, but that is not yet clear.  Until then, we will keep the thought of needing an extension, but not create it yet."
...
* group.element[63].target.code = #extension[2].valueCodeableConcept.coding.code
...
* group.element[63].target.display = "extension[2].valueCodeableConcept.coding.code"
...
* group.element[64].target.code = #extension[2].valueCodeableConcept.coding.system
...
* group.element[64].target.display = "extension[2].valueCodeableConcept.coding.system"
* group.element[65].code = #OBX-33
...
* group.element[65].extension[0].extension[0].valueCode = #"EIP"
...
* group.element[65].display = "Observation Related Specimen Identifier"
* group.element[65].target.equivalence = #equivalent
* group.element[65].target.code = #extension[1].uri
...
* group.element[65].target.extension[0].extension[0].valueCode = #"Reference"
...
* group.element[66].target.code = #extension[1].valueReference(Group.member.entity(Specimen.identifier[1])
* group.element[66].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[66].target.extension[0].extension[0].url = "cardinalityMin"
* group.element[66].target.extension[0].extension[0].valueInteger = 0
* group.element[66].target.extension[0].extension[1].url = "cardinalityMax"
* group.element[66].target.extension[0].extension[1].valueInteger = 1
* group.element[66].target.display = "extension[1].valueReference(Group.member.entity(Specimen.identifier[1])"
...
* group.element[67].target.code = #extension[2].uri
...
* group.element[67].target.display = "extension[2].uri"
...
* group.element[68].target.code = #extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))
...
* group.element[68].target.display = "extension[2].valueReference(Group.member.entity(Specimen.identifier[2]))"
...
* group.element[69].target.code = #specimen(Specimen.identifier[1])
* group.element[69].target.extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[69].target.extension[0].extension[0].url = "type"
* group.element[69].target.extension[0].extension[0].valueCode = #"Identifier"
* group.element[69].target.display = "specimen(Specimen.identifier[1])"
...
* group.element[70].target.code = #specimen(Specimen.identifier[2])
...
* group.element[70].target.display = "specimen(Specimen.identifier[2])"
