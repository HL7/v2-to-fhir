...
* group.element[2].target.dependsOn[0].value = "IF OBX-2 EQUALS \"NM\""
* group.element[2].target.dependsOn[0].display = "IF OBX-2 EQUALS \"NM\""
...
* group.element[3].target.dependsOn[0].value = "IF OBX-2 IN (\"ST\", \"FT\", \"TX\")"
* group.element[3].target.dependsOn[0].display = "IF OBX-2 IN (\"ST\", \"FT\", \"TX\")"
...
* group.element[4].target.dependsOn[0].value = "IF OBX-2 EQUALS \"CF\""
* group.element[4].target.dependsOn[0].display = "IF OBX-2 EQUALS \"CF\""
...
* group.element[5].target.dependsOn[0].value = "IF OBX-2 EQUALS \"CNE\""
* group.element[5].target.dependsOn[0].display = "IF OBX-2 EQUALS \"CNE\""
...
* group.element[6].target.dependsOn[0].value = "IF OBX-2 EQUALS \"CE\""
* group.element[6].target.dependsOn[0].display = "IF OBX-2 EQUALS \"CE\""
...
* group.element[7].target.dependsOn[0].value = "IF OBX-2 EQUALS \"CWE\""
* group.element[7].target.dependsOn[0].display = "IF OBX-2 EQUALS \"CWE\""
...
* group.element[8].target.dependsOn[0].value = "IF OBX-2 EQUALS \"IS\""
* group.element[8].target.dependsOn[0].display = "IF OBX-2 EQUALS \"IS\""
...
* group.element[9].target.dependsOn[0].value = "IF OBX-2 EQUALS \"DR\""
* group.element[9].target.dependsOn[0].display = "IF OBX-2 EQUALS \"DR\""
...
* group.element[10].target.dependsOn[0].value = "IF OBX-2 IN (\"DTM\", \"DT\")"
* group.element[10].target.dependsOn[0].display = "IF OBX-2 IN (\"DTM\", \"DT\")"
...
* group.element[11].target.dependsOn[0].value = "IF OBX-2 EQUALS \"NR\""
* group.element[11].target.dependsOn[0].display = "IF OBX-2 EQUALS \"NR\""
...
* group.element[12].target.extension[0].extension[3].valueString = "OBX-5.1+\"-\"+OBX-5.2"
...
* group.element[12].target.dependsOn[0].value = "IF OBX-2 EQUALS \"VR\""
* group.element[12].target.dependsOn[0].display = "IF OBX-2 EQUALS \"VR\""
...
* group.element[13].target.dependsOn[0].value = "IF OBX-2 EQUALS \"TM\""
* group.element[13].target.dependsOn[0].display = "IF OBX-2 EQUALS \"TM\""
...
* group.element[14].target.extension[0].extension[3].valueString = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
...
* group.element[14].target.dependsOn[0].value = "IF (OBX-2 EQUALS \"SN\"  AND OBX-5.1  EQUALS \"<>\""
* group.element[14].target.dependsOn[0].display = "IF (OBX-2 EQUALS \"SN\"  AND OBX-5.1  EQUALS \"<>\""
...
* group.element[15].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
* group.element[15].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
...
* group.element[16].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
* group.element[16].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[17].target.extension[0].extension[3].valueString = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
...
* group.element[18].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
* group.element[18].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[19].target.extension[0].extension[3].valueString = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
...
* group.element[20].target.code = #valueSampedData
...
* group.element[20].target.display = "valueSampedData"
* group.element[20].target.comment = "Full guidance on how to populate SampledData based on a single vector or an array will be provided in a future version based on interest.  Please submit a JIRA if you are interested."
...
* group.element[20].target.dependsOn[0].value = "IF OBX-2 EQUALS \"NA\""
* group.element[20].target.dependsOn[0].display = "IF OBX-2 EQUALS \"NA\""
...
* group.element[23].target.extension[0].extension[3].valueString = "\"https://hl7.org/fhir/5.0/StructureDefinition/extension-Observation.valueAttachment\""
...
* group.element[23].target.dependsOn[0].value = "IF OBX-2 EQUALS \"RP\""
* group.element[23].target.dependsOn[0].display = "IF OBX-2 EQUALS \"RP\""
...
* group.element[25].target.dependsOn[0].value = "IF OBX-2 IN (\"NA\", \"NM\")"
* group.element[25].target.dependsOn[0].display = "IF OBX-2 IN (\"NA\", \"NM\")"
...
* group.element[26].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
* group.element[26].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[27].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
* group.element[27].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[28].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
* group.element[28].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[29].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
* group.element[29].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
...
* group.element[30].target.dependsOn[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
* group.element[30].target.dependsOn[0].display = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
...
* group.element[32].target.extension[0].extension[3].url = "mappedVia"
* group.element[32].target.extension[0].extension[3].valueUrl = "ConceptMap/table-hl70078-to-v3-observationinterpretation"
...
* group.element[33].target.extension[0].extension[3].url = "fixedValue"
* group.element[33].target.extension[0].extension[3].valueString = "\"http://hl7.org/fhir/StructureDefinition/observation-nature-of-abnormal-test\""
...
* group.element[34].target.extension[0].extension[3].valueUrl = "ConceptMap/table-hl70080-to-v2-0080"
...
* group.element[35].target.extension[0].extension[3].url = "mappedVia"
* group.element[35].target.extension[0].extension[3].valueUrl = "ConceptMap/table-hl70085-to-observation-status"
...
* group.element[36].target.extension[0].extension[1].url = "fixedValue"
* group.element[36].target.extension[0].extension[1].valueString = "\"http://hl7.org/fhir/StructureDefinition/alternate-codes\""
...
* group.element[36].target.dependsOn[0].value = "IF OBX-11 IS \"X\""
* group.element[36].target.dependsOn[0].display = "IF OBX-11 IS \"X\""
...
* group.element[37].target.extension[0].extension[1].url = "fixedValue"
* group.element[37].target.extension[0].extension[1].valueString = "\"X\""
...
* group.element[37].target.dependsOn[0].value = "IF OBX-11 IS \"X\""
* group.element[37].target.dependsOn[0].display = "IF OBX-11 IS \"X\""
...
* group.element[38].target.extension[0].extension[1].valueString = "\"http://terminology.hl7.org/CodeSystem/v2-0085\""
...
* group.element[39].target.extension[0].extension[0].url = "fixedValue"
* group.element[39].target.extension[0].extension[0].valueString = "\"not-asked\""
...
* group.element[39].target.dependsOn[0].value = "IF OBX-11 IS \"N\""
* group.element[39].target.dependsOn[0].display = "IF OBX-11 IS \"N\""
...
* group.element[40].target.extension[0].extension[0].url = "fixedValue"
* group.element[40].target.extension[0].extension[0].valueString = "\"http://terminology.hl7.org/CodeSystem/data-absent-reason\""
...
* group.element[40].target.dependsOn[0].value = "IF OBX-11 IS \"N\""
* group.element[40].target.dependsOn[0].display = "IF OBX-11 IS \"N\""
...
* group.element[46].target.extension[0].extension[3].valueString = "\"http://terminology.hl7.org/CodeSystem/practitioner-role\""
...
* group.element[54].target.dependsOn[0].property = "Computable-ANTLR"
* group.element[54].target.dependsOn[0].system = "http://hl7.org/fhir/uv/v2mappings/antlr_condition_syntax.html"
* group.element[54].target.dependsOn[0].value = "IF OBX-25 NOT VALUED"
* group.element[54].target.dependsOn[0].display = "IF OBX-25 NOT VALUED"
...
* group.element[56].target.dependsOn[0].property = "Computable-ANTLR"
* group.element[56].target.dependsOn[0].system = "http://hl7.org/fhir/uv/v2mappings/antlr_condition_syntax.html"
* group.element[56].target.dependsOn[0].value = "IF OBX-25 NOT VALUED"
* group.element[56].target.dependsOn[0].display = "IF OBX-25 NOT VALUED"
...
* group.element[60].target.extension[0].extension[0].url = "fixedValue"
* group.element[60].target.extension[0].extension[0].valueString = "\"http://terminology.hl7.org/CodeSystem/v2-0912\""
