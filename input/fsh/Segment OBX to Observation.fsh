...
Title: "Segment OBXnull to Observation Map"
* title = "Segment OBXnull to Observation Map"
...
* group.element[0].target.comment = "Note that in Observation there is category field that depending on implementation guide and/or realm is required.   MSH-9.2 Trigger Event, the MSH-3 Sending Application and OBX-3 Observation Identifier's code system ontology  would inform how to value Observation.category."
* group.element[0].target.dependsOn[0].property = "data-type-map"
* group.element[0].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[1].code = #OBX-4
* group.element[1].extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/TypeInfo"
* group.element[1].extension[0].extension[0].url = "type"
* group.element[1].extension[0].extension[0].valueCode = #"OG"
* group.element[1].extension[0].extension[1].url = "cardinalityMin"
* group.element[1].extension[0].extension[1].valueInteger = 1
* group.element[1].extension[0].extension[2].url = "cardinalityMax"
* group.element[1].extension[0].extension[2].valueInteger = 1
* group.element[1].display = "Observation Sub-ID"
* group.element[1].target.equivalence = #equivalent
* group.element[1].target.code = #$this
* group.element[1].target.display = "$this"
* group.element[1].target.comment = "OBX-4 Sub Identifier would determine how to use Observation.partOf or Observation.hasMember or Observation.DerivedFrom, but is highly dependent on the local implementation of OBX-4 or an implementation guide (e.g., LRI, Clinical Genomics).  That is not known at the standard level, so we cannot provide specific mapping guidance here.  However, if the mapper does not have access to the syntax used and its meaning, we need to be able to pass on OBX-4 Sub Identifier to the final destination that should know how to then structure it using FHIR attributes."
* group.element[1].target.dependsOn[0].property = "data-type-map"
* group.element[1].target.dependsOn[0].value = "OG[Extension-Subidentifier]"
* group.element[1].target.product[0].property = "narrative"
* group.element[1].target.product[0].value = "Map to Observation.partOf or Observation.hasMember or Observation.DerivedFrom according to the implementation guidance for the v2 message at hand, otherwise map to the extension-sub-id to enable the final destination to determine how to structure the observations."
...
* group.element[2].target.code = #valueQuantity.value
...
* group.element[2].target.display = "valueQuantity.value"
...
* group.element[3].target.code = #valueString
...
* group.element[3].target.display = "valueString"
...
* group.element[4].target.code = #valueCodeableConcept[1]
...
* group.element[4].target.display = "valueCodeableConcept[1]"
...
* group.element[8].target.code = #valueCodeableConcept
...
* group.element[8].target.display = "valueCodeableConcept"
...
* group.element[9].target.code = #valuePeriod
...
* group.element[9].target.display = "valuePeriod"
...
* group.element[10].target.code = #valueDateTime
...
* group.element[10].target.display = "valueDateTime"
...
* group.element[11].target.code = #valueRange
...
* group.element[11].target.display = "valueRange"
...
* group.element[12].target.code = #valueString
...
* group.element[12].target.display = "valueString"
...
* group.element[13].target.code = #valueTime
...
* group.element[13].target.display = "valueTime"
...
* group.element[14].target.code = #valueString
...
* group.element[14].target.display = "valueString"
* group.element[14].target.dependsOn[0].property = "value"
* group.element[14].target.dependsOn[0].value = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
* group.element[14].target.product[0].property = "antlr"
* group.element[14].target.product[0].value = "IF (OBX-2 EQUALS \"SN\"  AND OBX-5.1  EQUALS \"<>\""
...
* group.element[15].target.code = #valueRatio[1]
...
* group.element[15].target.extension[0].extension[0].valueCode = #"Ratio"
...
* group.element[15].target.display = "valueRatio[1]"
* group.element[15].target.dependsOn[0].property = "data-type-map"
* group.element[15].target.dependsOn[0].value = "SN[Ratio]"
* group.element[15].target.product[0].property = "antlr"
* group.element[15].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
...
* group.element[16].target.code = #valueRange[1]
...
* group.element[16].target.extension[0].extension[0].valueCode = #"Range"
...
* group.element[16].target.display = "valueRange[1]"
* group.element[16].target.dependsOn[0].property = "data-type-map"
* group.element[16].target.dependsOn[0].value = "SN[Range]"
* group.element[16].target.product[0].property = "antlr"
* group.element[16].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[17].target.code = #valueString
...
* group.element[17].target.display = "valueString"
* group.element[17].target.dependsOn[0].property = "value"
* group.element[17].target.dependsOn[0].value = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
* group.element[17].target.product[0].property = "antlr"
* group.element[17].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"+\""
...
* group.element[18].target.code = #valueQuantity[1]
...
* group.element[18].target.display = "valueQuantity[1]"
* group.element[18].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
* group.element[18].target.dependsOn[0].property = "data-type-map"
* group.element[18].target.dependsOn[0].value = "SN[Quantity]"
* group.element[18].target.product[0].property = "antlr"
* group.element[18].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[19].target.code = #valueString
...
* group.element[19].target.display = "valueString"
* group.element[19].target.dependsOn[0].property = "value"
* group.element[19].target.dependsOn[0].value = "OBX-5.1+\" \"+OBX-5.2+\" \"+OBX-5.3+\" \"+OBX-5.4\" \"OBX-6\""
* group.element[19].target.product[0].property = "narrative"
* group.element[19].target.product[0].value = "If line 19 through 23 all fail while OBX-2 = SN"
...
* group.element[20].target.code = #valueSampledData
...
* group.element[20].target.extension[0].extension[0].valueCode = #"SampledData"
* group.element[20].target.display = "valueSampledData"
* group.element[20].target.comment = "Need to add text on converting NA to SampledData"
* group.element[20].target.product[0].property = "antlr"
* group.element[20].target.product[0].value = "IF OBX-2 EQUALS \"NA\""
...
* group.element[21].target.code = #extension[1].url
...
* group.element[21].target.display = "extension[1].url"
...
* group.element[21].target.product[0].value = "IF OBX-2 EQUALS \"ED\" AND IF OBX-5.4 EQUALS \"Base64\""
...
* group.element[22].target.code = #extension[1].valueAttachment
...
* group.element[22].target.display = "extension[1].valueAttachment"
...
* group.element[22].target.dependsOn[0].value = "ED[Attachment]"
* group.element[22].target.product[0].property = "antlr"
* group.element[22].target.product[0].value = "IF OBX-2 EQUALS \"ED\" AND IF OBX-5.4 EQUALS \"Base64\""
...
* group.element[23].target.code = #extension[1].url
...
* group.element[23].target.display = "extension[1].url"
* group.element[23].target.dependsOn[0].property = "value"
* group.element[23].target.dependsOn[0].value = "\"https://hl7.org/fhir/R5/StructureDefinition/extension-Observation.valueAttachment"
* group.element[23].target.product[0].property = "antlr"
* group.element[23].target.product[0].value = "IF OBX-2 EQUALS \"RP\""
...
* group.element[24].target.code = #extension[1].valueAttachment
...
* group.element[24].target.extension[0].extension[0].valueCode = #"Attachment"
...
* group.element[24].target.display = "extension[1].valueAttachment"
* group.element[24].target.comment = "To be resolved when we resolve DocumentReference and valueAttachment"
* group.element[24].target.dependsOn[0].property = "data-type-map"
* group.element[24].target.dependsOn[0].value = "ED[Attachment]"
* group.element[24].target.product[0].property = "antlr"
* group.element[24].target.product[0].value = "IF OBX-2 EQUALS \"RP\""
...
* group.element[25].target.code = #valueQuantity[1]
...
* group.element[25].target.extension[0].extension[0].valueCode = #"Quantity"
* group.element[25].target.display = "valueQuantity[1]"
* group.element[25].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[25].target.product[0].value = "IF OBX-2 IN (\"NA\", \"NM\")"
...
* group.element[26].target.code = #valueQuantity[1]
...
* group.element[26].target.display = "valueQuantity[1]"
* group.element[26].target.comment = "Note that OBX-5 and OBX-6 resolve to different components for the same Quantity data type."
...
* group.element[26].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 NOT IN (\":\", \"/\", \"-\", \"+\")"
...
* group.element[27].target.code = #valueRange[1].low
...
* group.element[27].target.extension[0].extension[0].valueCode = #"SimpleQuantity"
* group.element[27].target.display = "valueRange[1].low"
...
* group.element[27].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[28].target.code = #valueRange[1].high
...
* group.element[28].target.extension[0].extension[0].valueCode = #"SimpleQuantity"
* group.element[28].target.display = "valueRange[1].high"
...
* group.element[28].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 EQUALS \"-\""
...
* group.element[29].target.code = #valueRatio[1].numerator
...
* group.element[29].target.extension[0].extension[0].valueCode = #"Quantity"
* group.element[29].target.display = "valueRatio[1].numerator"
* group.element[29].target.dependsOn[0].property = "data-type-map"
* group.element[29].target.dependsOn[0].value = "CWE[Quantity]"
* group.element[29].target.product[0].property = "antlr"
* group.element[29].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
...
* group.element[30].target.code = #valueRatio[1].denominator
...
* group.element[30].target.extension[0].extension[0].valueCode = #"Quantity"
* group.element[30].target.display = "valueRatio[1].denominator"
* group.element[30].target.dependsOn[0].property = "data-type-map"
* group.element[30].target.dependsOn[0].value = "CWE[Quantity]"
* group.element[30].target.product[0].property = "antlr"
* group.element[30].target.product[0].value = "IF OBX-2 EQUALS \"SN\" AND OBX-5.1  NOT EQUALS \"<>\" AND OBX-5.3 IN (\":\", \"/\")"
* group.element[31].code = #OBX-7
...
* group.element[31].display = "References Range"
* group.element[31].target.equivalence = #equivalent
* group.element[31].target.code = #referenceRange.text
...
* group.element[31].target.display = "referenceRange.text"
* group.element[31].target.comment = "If OBX-7 is sufficiently parseable, then the low, high, type, appliesTo, and/or age may be used."
* group.element[32].code = #OBX-8
...
* group.element[32].display = "Interpretation Codes"
* group.element[32].target.equivalence = #equivalent
* group.element[32].target.code = #interpretation
...
* group.element[32].target.display = "interpretation"
...
* group.element[32].target.dependsOn[1].value = "InterpretationCode"
* group.element[33].code = #OBX-10
...
* group.element[33].display = "Nature of Abnormal Test"
* group.element[33].target.equivalence = #equivalent
* group.element[33].target.code = #extension[2].uri
...
* group.element[33].target.display = "extension[2].uri"
* group.element[33].target.dependsOn[0].property = "value"
* group.element[33].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-nature-of-abnormal-test\""
* group.element[34].code = #OBX-10
...
* group.element[34].display = "Nature of Abnormal Test"
* group.element[34].target.equivalence = #equivalent
* group.element[34].target.code = #extension[2].valueCodeableConcept
...
* group.element[34].target.display = "extension[2].valueCodeableConcept"
* group.element[34].target.dependsOn[0].property = "data-type-map"
* group.element[34].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[34].target.dependsOn[1].property = "vocabulary-map"
* group.element[34].target.dependsOn[1].value = "NatureOfAbnormalTesting"
...
* group.element[35].display = "Observation Result Status"
* group.element[35].target.equivalence = #equivalent
* group.element[35].target.code = #status
...
* group.element[35].target.display = "status"
* group.element[35].target.dependsOn[0].property = "vocabulary-map"
* group.element[35].target.dependsOn[0].value = "ObservationStatus"
* group.element[36].code = #OBX-11
...
* group.element[36].display = "Observation Result Status"
* group.element[36].target.equivalence = #equivalent
* group.element[36].target.code = #status.extension[1].url
...
* group.element[36].target.display = "status.extension[1].url"
* group.element[36].target.dependsOn[0].property = "value"
* group.element[36].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/alternate-codes\""
* group.element[36].target.product[0].property = "antlr"
* group.element[36].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[37].target.code = #status.extension[1].valueCodeableConcept.coding.code
...
* group.element[37].target.display = "status.extension[1].valueCodeableConcept.coding.code"
* group.element[37].target.dependsOn[0].property = "value"
* group.element[37].target.dependsOn[0].value = "\"X\""
* group.element[37].target.product[0].property = "antlr"
* group.element[37].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[38].target.code = #status.extension[1].valueCodeableConcept.coding.system
...
* group.element[38].target.extension[0].extension[0].valueCode = #"string"
* group.element[38].target.display = "status.extension[1].valueCodeableConcept.coding.system"
* group.element[38].target.dependsOn[0].property = "value"
* group.element[38].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0085\""
* group.element[38].target.product[0].property = "antlr"
* group.element[38].target.product[0].value = "IF OBX-11 IS \"X\""
...
* group.element[39].target.code = #dataAbsentReason.coding[2].code
* group.element[39].target.display = "dataAbsentReason.coding[2].code"
* group.element[39].target.dependsOn[0].property = "value"
* group.element[39].target.dependsOn[0].value = "\"not-asked\""
* group.element[39].target.product[0].property = "antlr"
* group.element[39].target.product[0].value = "IF OBX-11 IS \"N\""
...
* group.element[40].target.code = #dataAbsentReason.coding[2].system
* group.element[40].target.display = "dataAbsentReason.coding[2].system"
* group.element[40].target.dependsOn[0].property = "value"
* group.element[40].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/data-absent-reason\""
* group.element[40].target.product[0].property = "antlr"
* group.element[40].target.product[0].value = "IF OBX-11 IS \"N\""
* group.element[41].code = #OBX-14
...
* group.element[41].display = "Date/Time of the Observation"
* group.element[41].target.equivalence = #equivalent
* group.element[41].target.code = #effectiveDateTime
...
* group.element[41].target.display = "effectiveDateTime"
* group.element[42].code = #OBX-15
...
* group.element[42].display = "Producer's ID"
* group.element[42].target.equivalence = #equivalent
* group.element[42].target.code = #performer[2](Organization)
...
* group.element[42].target.display = "performer[2](Organization)"
* group.element[42].target.comment = "We are mapping this to an identifier considering the definition (used for a unique identifier of the producer), although that does not fit the use of the CWE data type in HL7 v2.  Depending on context (e.g., US CLIA or IHE LTW, or ILW) this may reflect a location (US CLIA) or an organization (IHE LTW or ILW)."
* group.element[42].target.dependsOn[0].property = "data-type-map"
* group.element[42].target.dependsOn[0].value = "CWE[Organization]"
* group.element[43].code = #OBX-15
...
* group.element[43].display = "Producer's ID"
* group.element[43].target.equivalence = #equivalent
* group.element[43].target.code = #performer[2](PractitionerRole)
* group.element[43].target.display = "performer[2](PractitionerRole)"
...
* group.element[44].target.dependsOn[0].value = "XCN[Practitioner]"
...
* group.element[45].target.dependsOn[0].value = "\"responsibleObserver\""
...
* group.element[46].target.extension[0].extension[0].valueCode = #"CodeableConcept"
...
* group.element[46].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/practitioner-role\""
...
* group.element[47].target.dependsOn[0].value = "CWE[CodeableConcept]"
...
* group.element[48].target.dependsOn[0].value = "EI[Identifier-Extension]"
...
* group.element[49].target.code = #extension[2].url
...
* group.element[49].target.display = "extension[2].url"
...
* group.element[50].target.code = #extension[2].valueDateTime
...
* group.element[50].target.display = "extension[2].valueDateTime"
...
* group.element[52].target.dependsOn[0].value = "EI[Identifier-Extension]"
...
* group.element[53].target.dependsOn[0].value = "\"FILL\""
...
* group.element[54].target.dependsOn[0].value = "XON[Organization]"
* group.element[54].target.product[0].property = "antlr"
* group.element[54].target.product[0].value = "IF OBX-25 NOT VALUED"
...
* group.element[55].target.code = #performer[2](PractitionerRole[1].organization(Organization))
...
* group.element[55].target.display = "performer[2](PractitionerRole[1].organization(Organization))"
* group.element[55].target.dependsOn[0].property = "data-type-map"
* group.element[55].target.dependsOn[0].value = "XON[Organization]"
* group.element[55].target.product[0].property = "antlr"
* group.element[55].target.product[0].value = "IF OBX-25 VALUED"
...
* group.element[56].target.dependsOn[0].value = "XAD[Address]"
* group.element[56].target.product[0].property = "antlr"
* group.element[56].target.product[0].value = "IF OBX-25 NOT VALUED"
...
* group.element[57].target.code = #performer[2](PractitionerRole[1].organization(Organization.address))
...
* group.element[57].target.display = "performer[2](PractitionerRole[1].organization(Organization.address))"
* group.element[57].target.dependsOn[0].property = "data-type-map"
* group.element[57].target.dependsOn[0].value = "XAD[Address]"
* group.element[57].target.product[0].property = "antlr"
* group.element[57].target.product[0].value = "IF OBX-25 VALUED"
...
* group.element[58].target.code = #performer[2](PractitionerRole[1].practitioner)
...
* group.element[58].target.display = "performer[2](PractitionerRole[1].practitioner)"
* group.element[58].target.dependsOn[0].property = "data-type-map"
* group.element[58].target.dependsOn[0].value = "XCN[PractitionerRole]"
...
* group.element[59].target.code = #performer[2](PractitionerRole[1].code.coding.code)
...
* group.element[59].target.extension[0].extension[0].valueCode = #"code"
* group.element[59].target.display = "performer[2](PractitionerRole[1].code.coding.code)"
* group.element[59].target.dependsOn[0].property = "value"
* group.element[59].target.dependsOn[0].value = "\"MDIR\""
...
* group.element[60].target.code = #performer[2](PractitionerRole[1].code.coding.system)
* group.element[60].target.display = "performer[2](PractitionerRole[1].code.coding.system)"
* group.element[60].target.dependsOn[0].property = "value"
* group.element[60].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0912\""
...
* group.element[63].target.comment = "The sub type was necessary in v2 to distinguish purpose of the observation when it appears in a message in the same group (e.g., answers to ask at order entry questions with actual results ).  Within FHIR flagging the observation may not be necessary, but that is not yet clear.  Until then, we will keep the thought of needing an extension, but not create it yet."
* group.element[63].target.dependsOn[0].property = "value"
* group.element[63].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-structure-type\""
...
* group.element[65].target.dependsOn[0].property = "value"
* group.element[65].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/observation-structure-type\""
...
* group.element[66].target.dependsOn[0].property = "value"
* group.element[66].target.dependsOn[0].value = "\"http://hl7.org/fhir/5.0/StructureDefinition/extension-Observation.specimen"
* group.element[66].target.product[0].property = "antlr"
* group.element[66].target.product[0].value = "IF OBX-33 COUNT>1"
...
* group.element[67].target.product[0].property = "antlr"
* group.element[67].target.product[0].value = "IF OBX-33 COUNT>1"
...
* group.element[68].target.dependsOn[0].property = "value"
* group.element[68].target.dependsOn[0].value = "\"http://hl7.org/fhir/5.0/StructureDefinition/extension-Observation.specimen"
* group.element[68].target.product[0].property = "antlr"
* group.element[68].target.product[0].value = "IF OBX-33 COUNT>1"
...
* group.element[69].target.product[0].property = "antlr"
* group.element[69].target.product[0].value = "IF OBX-33 COUNT>1"
...
* group.element[70].target.dependsOn[0].property = "data-type-map"
* group.element[70].target.dependsOn[0].value = "EIP[Identifier-PlacerAssignedIdentifier]"
* group.element[70].target.product[0].property = "antlr"
* group.element[70].target.product[0].value = "IF OBX-33 COUNT=1"
...
* group.element[71].target.dependsOn[0].property = "data-type-map"
* group.element[71].target.dependsOn[0].value = "EIP[Identifier-FillerAssignedIdentifier]"
* group.element[71].target.product[0].property = "antlr"
* group.element[71].target.product[0].value = "IF OBX-33 COUNT=1"
