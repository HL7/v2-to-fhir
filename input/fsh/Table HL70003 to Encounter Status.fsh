...
* group[0].element[4].display = "Pre-Admit"
...
* group[0].element[5].display = "Update Patient Information"
...
* group[0].element[6].display = "Cancel admit/visit notification"
...
* group[0].element[7].display = "Cancel discharge/end visit"
