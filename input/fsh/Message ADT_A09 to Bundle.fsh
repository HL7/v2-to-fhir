// HL7 Message - FHIR E2_ ADT_A09 - Sheet1.csv
...
* url = "http://hl7.org/fhir/uv/v2mappings/ConceptMap/message-adt-a09-to-bundle"
...
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1k9zRQEBw7szbw6I92wqz-61c_ahZr8q69xz1DD1VnUE/edit?gid=0#gid=0"
* group[0].element[0].code = #ADT_A09.MSH
...
* group[0].element[1].code = #ADT_A09.MSH
...
* group[0].element[2].code = #ADT_A09.MSH
...
* group[0].element[3].code = #ADT_A09.MSH
...
* group[0].element[4].code = #ADT_A09.SFT
...
* group[0].element[5].code = #ADT_A09.SFT
...
* group[0].element[6].code = #ADT_A09.EVN
...
* group[0].element[7].code = #ADT_A09.EVN
...
* group[0].element[8].code = #ADT_A09.PID
...
* group[0].element[9].code = #ADT_A09.PID
...
* group[0].element[10].code = #ADT_A09.PID
...
* group[0].element[11].code = #ADT_A09.PD1
...
* group[0].element[13].code = #ADT_A09.PV1
...
* group[0].element[14].code = #ADT_A09.PV1
...
* group[0].element[14].target.code = #Basic
* group[0].element[14].target.display = "Basic"
* group[0].element[14].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[14].target.dependsOn[0].value = "IF PV1-43 VALUED"
* group[0].element[15].code = #ADT_A09.PV1
...
* group[0].element[16].code = #ADT_A09.PV1
...
* group[0].element[16].target.code = #Coverage[1]
* group[0].element[16].target.display = "Coverage[1]"
* group[0].element[16].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[16].target.dependsOn[0].value = "IF PV1-20 VALUE"
* group[0].element[17].code = #ADT_A09.PV2
...
* group[0].element[17].display = "Patient Visit - Additional Info."
...
* group[0].element[17].target.comment = "Incorporate PV2 content into the Encounter created from the PV1 segment."
* group[0].element[18].code = #ADT_A09.OBSERVATION.OBX
...
* group[0].element[18].target.code = #Observation[2]
* group[0].element[18].target.display = "Observation[2]"
* group[0].element[18].target.comment = "One cannot determine whether this observation made during the PV1/PV2 communicated above, or from a prior visit/stay. It is therefore up to the implementer whether to populate Observation.encounter.reference with the Encounter[1].id or not.  Only when the ADT message involves an event before the encounter occurs, e.g., the intiial registration, it is clear that the observation is NOT associated with Encounter[1]."
* group[0].element[18].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[18].target.dependsOn[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1 OR OBX-2 IS \"NA\""
* group[0].element[19].code = #ADT_A09.OBSERVATION.OBX
...
* group[0].element[19].target.code = #Observation[2]
* group[0].element[19].target.display = "Observation[2]"
...
* group[0].element[19].target.dependsOn[0].value = "IF  OBX-5 LST.count GREATER THAN 1 AND OBX-2 IS NOT \"NA\""
