...
* group.element[14].target.dependsOn[0].value = "PV1[EncounterHistory]"
* group.element[14].target.dependsOn[1].property = "references"
* group.element[14].target.dependsOn[1].value = "EncounterHistory.subject.reference=Patient[1].id"
* group.element[14].target.product[0].property = "antlr"
* group.element[14].target.product[0].value = "IF PV1-43 VALUED"
...
* group.element[16].code = #ADT_A09.PV1
...
* group.element[16].target.dependsOn[0].value = "PV1[Coverage]"
* group.element[16].target.dependsOn[1].property = "references"
* group.element[16].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
* group.element[16].target.product[0].property = "antlr"
* group.element[16].target.product[0].value = "IF PV1-20 VALUE"
...
* group.element[18].code = #ADT_A09.OBSERVATION.OBX
...
* group.element[18].target.dependsOn[0].value = "OBX[Observation]"
* group.element[18].target.dependsOn[1].property = "references"
* group.element[18].target.dependsOn[1].value = "Observation[2].subject.reference=Patient[1].id"
...
* group.element[19].target.dependsOn[0].value = "OBX[Observation-Component]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "Observation[2].subject.reference=Patient[1].id"
