...
* group[0].element[2].target.display = "psychiatry disorder information sensitivity"
...
* group[0].element[3].target.display = "HIV/AIDS information sensitivity"
...
* group[0].element[4].target.display = "HIV/AIDS information sensitivity"
