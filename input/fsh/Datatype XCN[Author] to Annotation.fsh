...
* group[0].element[0].target.code = #authorReference(Practitioner.identifier[1].value)
...
* group[0].element[0].target.display = "authorReference(Practitioner.identifier[1].value)"
...
* group[0].element[1].target.code = #authorReference(Practitioner.name)
...
* group[0].element[1].target.display = "authorReference(Practitioner.name)"
...
* group[0].element[2].target.code = #authorReference(Practitioner.name.given[1])
...
* group[0].element[2].target.display = "authorReference(Practitioner.name.given[1])"
...
* group[0].element[3].target.code = #authorReference(Practitioner.name.given[2])
...
* group[0].element[3].target.display = "authorReference(Practitioner.name.given[2])"
...
* group[0].element[4].target.code = #authorReference(Practitioner.name.suffix[1])
...
* group[0].element[4].target.display = "authorReference(Practitioner.name.suffix[1])"
...
* group[0].element[5].target.code = #authorReference(Practitioner.name.prefix)
...
* group[0].element[5].target.display = "authorReference(Practitioner.name.prefix)"
...
* group[0].element[6].target.code = #authorReference(Practitioner.name.suffix[2])
...
* group[0].element[6].target.display = "authorReference(Practitioner.name.suffix[2])"
...
* group[0].element[7].target.code = #authorReference(Practitioner.identifier[1].assigner(Organization))
...
* group[0].element[7].target.display = "authorReference(Practitioner.identifier[1].assigner(Organization))"
...
* group[0].element[8].target.code = #authorReference(Practitioner.identifier[1].system)
...
* group[0].element[8].target.display = "authorReference(Practitioner.identifier[1].system)"
...
* group[0].element[9].target.code = #authorReference(Practitioner.name.use)
...
* group[0].element[9].target.display = "authorReference(Practitioner.name.use)"
...
* group[0].element[10].target.code = #authorReference(Practitioner.extension[1].url)
...
* group[0].element[10].target.display = "authorReference(Practitioner.extension[1].url)"
...
* group[0].element[11].target.code = #authorReference(Practitioner.extension[1].valueString)
...
* group[0].element[11].target.display = "authorReference(Practitioner.extension[1].valueString)"
...
* group[0].element[12].target.code = #authorReference(Practitioner.extension[2].url)
...
* group[0].element[12].target.display = "authorReference(Practitioner.extension[2].url)"
...
* group[0].element[13].target.code = #authorReference(Practitioner.extension[2].valueString)
...
* group[0].element[13].target.display = "authorReference(Practitioner.extension[2].valueString)"
...
* group[0].element[14].target.code = #authorReference(Practitioner.identifier[1].type.coding.code)
...
* group[0].element[14].target.display = "authorReference(Practitioner.identifier[1].type.coding.code)"
...
* group[0].element[15].target.code = #authorReference(Practitioner.name.period)
...
* group[0].element[15].target.display = "authorReference(Practitioner.name.period)"
...
* group[0].element[16].target.code = #authorReference(Practitioner.name.family.extension.url)
...
* group[0].element[16].target.display = "authorReference(Practitioner.name.family.extension.url)"
...
* group[0].element[17].target.code = #authorReference(Practitioner.name.family.extension.valueCode)
...
* group[0].element[17].target.display = "authorReference(Practitioner.name.family.extension.valueCode)"
...
* group[0].element[18].target.code = #authorReference(Practitioner.name.period.start)
...
* group[0].element[18].target.display = "authorReference(Practitioner.name.period.start)"
...
* group[0].element[19].target.code = #authorReference(Practitioner.name.period.end)
...
* group[0].element[19].target.display = "authorReference(Practitioner.name.period.end)"
...
* group[0].element[20].target.code = #authorReference(Practitioner.name.suffix)
...
* group[0].element[20].target.display = "authorReference(Practitioner.name.suffix)"
