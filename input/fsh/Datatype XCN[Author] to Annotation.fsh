...
* group.element[11].target.code = #authorReference(Practitioner.extension[2].url)
...
* group.element[11].target.display = "authorReference(Practitioner.extension[2].url)"
...
* group.element[12].target.code = #authorReference(Practitioner.identifier[1].type.coding.code)
...
* group.element[12].target.display = "authorReference(Practitioner.identifier[1].type.coding.code)"
...
* group.element[13].target.code = #authorReference(Practitioner.name.period)
...
* group.element[13].target.display = "authorReference(Practitioner.name.period)"
...
* group.element[13].target.product[0].value = "IF XCN.19 DOES NOT EXIST AND IF XCN.20 DOES NOT EXIST"
...
* group.element[14].target.code = #authorReference(Practitioner.name.family.extension.url)
...
* group.element[14].target.display = "authorReference(Practitioner.name.family.extension.url)"
...
* group.element[15].target.code = #authorReference(Practitioner.name.family.extension.valueCode)
...
* group.element[15].target.display = "authorReference(Practitioner.name.family.extension.valueCode)"
...
* group.element[16].target.code = #authorReference(Practitioner.name.period.start)
...
* group.element[16].target.display = "authorReference(Practitioner.name.period.start)"
...
* group.element[17].target.code = #authorReference(Practitioner.name.period.end)
...
* group.element[17].target.display = "authorReference(Practitioner.name.period.end)"
...
* group.element[18].target.code = #authorReference(Practitioner.name.suffix)
...
* group.element[18].target.display = "authorReference(Practitioner.name.suffix)"
