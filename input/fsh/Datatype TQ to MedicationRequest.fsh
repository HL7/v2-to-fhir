// HL7 Data Type - FHIR E2_ TQ[MedicationRequest] - Sheet1.csv
...
* url = "http://hl7.org/fhir/uv/v2mappings/ConceptMap/datatype-tq-to-medicationrequest"
...
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1FzNa6zatNciUDD4CJmgpcC81nle7w3HbCZ55b4b3wBM/edit?gid=0#gid=0"
...
* group[0].element[1].target.code = #dosageInstruction.doseAndRate.timing
...
* group[0].element[1].target.display = "dosageInstruction.doseAndRate.timing"
...
* group[0].element[2].target.code = #dosageInstruction.doseAndRate.timing.repeat.duration
...
* group[0].element[2].target.display = "dosageInstruction.doseAndRate.timing.repeat.duration"
