...
* group.element[1].target.extension[0].extension[0].valueString = "/v2.txt or v2.xml into base 64/"
...
* group.element[2].target.extension[0].extension[0].valueString = "\"current\""
...
* group.element[3].target.extension[0].extension[0].valueString = "\"source\""
...
* group.element[4].target.dependsOn[0].value = "IF MSH-3 AND MSH-24 VALUED"
* group.element[4].target.dependsOn[0].display = "IF MSH-3 AND MSH-24 VALUED"
...
* group.element[5].target.dependsOn[0].value = "IF MSH-3 AND MSH-24 VALUED"
* group.element[5].target.dependsOn[0].display = "IF MSH-3 AND MSH-24 VALUED"
...
* group.element[6].target.dependsOn[0].value = "IF MSH-22 NOT VALUED"
* group.element[6].target.dependsOn[0].display = "IF MSH-22 NOT VALUED"
...
* group.element[7].target.dependsOn[0].value = "IF MSH-22 NOT VALUED"
* group.element[7].target.dependsOn[0].display = "IF MSH-22 NOT VALUED"
...
* group.element[8].target.dependsOn[0].value = "IF MSH-22 NOT VALUED"
* group.element[8].target.dependsOn[0].display = "IF MSH-22 NOT VALUED"
