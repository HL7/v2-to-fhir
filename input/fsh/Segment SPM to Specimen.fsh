...
* group.element[2].target.dependsOn[1].value = "SpecimenType"
...
* group.element[3].target.dependsOn[1].value = "Addition/Preservative"
...
* group.element[4].target.dependsOn[1].value = "SpecimenCollectionMethod"
...
* group.element[5].target.dependsOn[1].value = "SpecimenSourceSite"
...
* group.element[11].target.dependsOn[0].value = "Yes/No"
...
* group.element[12].target.dependsOn[1].value = "SpecimenCondition"
...
* group.element[13].target.dependsOn[1].value = "ContainerType"
