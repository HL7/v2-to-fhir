// HL7 Data Type - FHIR R4_ HD[MessageHeader.source-endpoint with name] - Sheet1.csv
Instance: DatatypeHDendpointwithnametoMessageHeader.source
...
* id = "datatype-hdendpointwithname-to-messageheader.source"
* url = "http://hl7.org/fhir/uv/v2mappings/datatype-hdendpointwithname-to-messageheader.source"
* version = "1.0"
* name = "DatatypeHDendpointwithnametoMessageHeader.source"
* status = #active
* experimental = true
* date = "2022-02-28"
...
* extension[0].extension[1].valueString = "Datatype HD[endpointwithname] to MessageHeader.source.fsh"
...
* group.element[6].target.product[0].value = "IF NOT VALUED"
