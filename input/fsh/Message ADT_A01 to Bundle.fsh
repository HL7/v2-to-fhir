// HL7 Message - FHIR E2_ ADT_A01 - Sheet1.csv
...
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1QFZSxihDdClZrRUGNt_Le3JI0TWZJxy-qkdY-hsV77o/edit?gid=0#gid=0"
* group[0].element[0].code = #ADT_A01.MSH
...
* group[0].element[1].code = #ADT_A01.MSH
...
* group[0].element[2].code = #ADT_A01.MSH
...
* group[0].element[3].code = #ADT_A01.MSH
...
* group[0].element[4].code = #ADT_A01.SFT
...
* group[0].element[5].code = #ADT_A01.SFT
...
* group[0].element[6].code = #ADT_A01.EVN
...
* group[0].element[7].code = #ADT_A01.EVN
...
* group[0].element[8].code = #ADT_A01.PID
...
* group[0].element[9].code = #ADT_A01.PID
...
* group[0].element[10].code = #ADT_A01.PID
...
* group[0].element[11].code = #ADT_A01.PD1
...
* group[0].element[13].code = #ADT_A01:follow:PID.ROL
...
* group[0].element[14].code = #ADT_A01:follow:PID.ROL
...
* group[0].element[15].code = #ADT_A01:follow:PID.PRT
...
* group[0].element[15].target.dependsOn[1].property = "Narrative-Condition"
* group[0].element[15].target.dependsOn[1].value = "If only person information"
* group[0].element[16].code = #ADT_A01:follow:PID.PRT
...
* group[0].element[17].code = #ADT_A01.NEXT_OF_KIN.NK1
...
* group[0].element[17].display = "Next of Kin / Associated Parties"
* group[0].element[17].target.equivalence = #equivalent
* group[0].element[17].target.code = #RelatedPerson[2]
* group[0].element[17].target.display = "RelatedPerson[2]"
* group[0].element[17].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[17].target.dependsOn[0].value = "IF NK1-3.1 NOT IN (\"EMR\", \"NON\", \"OTH\", \"UNK\") OR NK1-7 NOT IN (\"E\", \"F\", \"I\", \"S\", \"O\", \"U\")"
* group[0].element[17].target.dependsOn[1].property = "Narrative-Condition"
* group[0].element[17].target.dependsOn[1].value = "Based on whether the relationship in NK1-3 or NK1-7 represents a person if NK1-3 is in (\"NON\", \"UNK\", \"OTH\") or if NK1-7 is in \"(\"O\", \"U\") use NK1(RelatedPerson) or NK1(Patient) mapping"
* group[0].element[18].code = #ADT_A01.NEXT_OF_KIN.NK1
...
* group[0].element[18].target.code = #Patient[1]
* group[0].element[18].target.display = "Patient[1]"
* group[0].element[18].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[18].target.dependsOn[0].value = "IF NK1-3.1 IN (\"EMR\") OR NK1-7 IN (\"E\", \"F\", \"I\", \"S\")"
* group[0].element[18].target.dependsOn[1].property = "Narrative-Condition"
* group[0].element[18].target.dependsOn[1].value = "Based on whether the relationship in NK1-3 or NK1-7 represents an organization if NK1-3 is in (\"NON\", \"UNK\", \"OTH\") or if NK1-7 is in \"(\"O\", \"U\") use NK1(RelatedPerson) or NK1(Patient) mapping"
* group[0].element[19].code = #ADT_A01.PV1
...
* group[0].element[20].code = #ADT_A01.PV1
...
* group[0].element[21].code = #ADT_A01.PV1
...
* group[0].element[22].code = #ADT_A01.PV1
...
* group[0].element[23].code = #ADT_A01.PV2
...
* group[0].element[24].code = #ADT_A01:follow:PV1.ROL
...
* group[0].element[24].display = "Role"
...
* group[0].element[25].code = #ADT_A01.OBSERVATION.OBX
...
* group[0].element[25].display = "Observation/Result"
* group[0].element[25].target.equivalence = #equivalent
* group[0].element[25].target.code = #Observation[3]
* group[0].element[25].target.display = "Observation[3]"
* group[0].element[25].target.comment = "One cannot determine whether this observation made during the PV1/PV2 communicated above, or from a prior visit/stay. It is therefore up to the implementer whether to populate Observation.encounter.reference with the Encounter[1].id or not.  Only when the ADT message involves an event before the encounter occurs, e.g., the intiial registration, it is clear that the observation is NOT associated with Encounter[1]."
* group[0].element[25].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[25].target.dependsOn[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1 OR OBX-2 IS \"NA\""
* group[0].element[26].code = #ADT_A01.OBSERVATION.OBX
...
* group[0].element[26].target.dependsOn[0].value = "IF  OBX-5 LST.count GREATER THAN 1 AND OBX-2 IS NOT \"NA\""
* group[0].element[27].code = #ADT_A01.AL1
...
* group[0].element[27].display = "Allergy Information"
* group[0].element[27].target.equivalence = #equivalent
* group[0].element[27].target.code = #AllergyIntolerance
* group[0].element[27].target.display = "AllergyIntolerance"
* group[0].element[27].target.comment = "Processing of the AL1 segment results in the creation of a new AllergyIntolerance resource"
* group[0].element[28].code = #ADT_A01.DG1
...
* group[0].element[28].display = "Diagnosis Information"
* group[0].element[28].target.equivalence = #equivalent
* group[0].element[28].target.code = #Condition[1]
* group[0].element[28].target.display = "Condition[1]"
* group[0].element[28].target.comment = "Processing of the DG1 segment results in the creation of a new Condition resource"
* group[0].element[28].target.dependsOn[0].property = "Narrative-Condition"
* group[0].element[28].target.dependsOn[0].value = "If in context of the patient"
* group[0].element[29].code = #ADT_A01.DG1
...
* group[0].element[29].target.code = #Encounter[1]
* group[0].element[29].target.display = "Encounter[1]"
* group[0].element[29].target.dependsOn[0].property = "Narrative-Condition"
* group[0].element[29].target.dependsOn[0].value = "If in context of an encounter"
* group[0].element[30].code = #ADT_A01.DG1
...
* group[0].element[30].target.code = #EpisodeOfCare[1]
* group[0].element[30].target.display = "EpisodeOfCare[1]"
* group[0].element[30].target.dependsOn[0].property = "Narrative-Condition"
* group[0].element[30].target.dependsOn[0].value = "If in context of a episode of care"
* group[0].element[31].code = #ADT_A01.PROCEDURE.PR1
...
* group[0].element[31].display = "Procedures"
* group[0].element[31].target.equivalence = #equivalent
* group[0].element[31].target.code = #Procedure
* group[0].element[31].target.display = "Procedure"
* group[0].element[32].code = #ADT_A01.INSURANCE.IN1
...
* group[0].element[32].display = "Insurance"
* group[0].element[32].target.equivalence = #equivalent
* group[0].element[32].target.code = #Coverage[1]
* group[0].element[32].target.display = "Coverage[1]"
* group[0].element[32].target.comment = "Processing of the IN1 segment results in the creation of a new Coverage resource"
* group[0].element[33].code = #ADT_A01.INSURANCE.IN3
...
* group[0].element[33].display = "Insurance Additional Info - Cert."
* group[0].element[33].target.equivalence = #equivalent
* group[0].element[33].target.code = #CareTeam[1]
* group[0].element[33].target.display = "CareTeam[1]"
* group[0].element[33].target.comment = "Incorporate IN3 content into the Coverage created from the IN1 segment."
