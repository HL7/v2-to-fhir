...
* group.element[33].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
...
* group.element[34].target.dependsOn[1].value = "CareTeam.subject.reference=Patient[1].id"
