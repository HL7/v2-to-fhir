...
* group.element[14].code = #ADT_A01:follow:PID.PRT
...
* group.element[14].target.product[1].value = "If only person information"
...
* group.element[18].target.product[0].value = "IF NK1-3.1 IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
...
* group.element[30].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
