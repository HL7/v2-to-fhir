...
* group[0].element[17].target.comment = "Typically, each NK1 will be translated to either a new RelatedPerson resource or added as a new occurrence of Patient.contact, but it's possible to insert the NK1 data into both structures."
* group[0].element[17].target.dependsOn[0].property = "Computable-ANTLR"
* group[0].element[17].target.dependsOn[0].value = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
...
* group[0].element[18].target.dependsOn[0].value = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
* group[0].element[19].code = #ADT_A01.NEXT_OF_KIN.NK1
...
* group[0].element[19].target.dependsOn[0].value = "IF NK1-3.1 IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
...
* group[0].element[20].target.comment = "Processing of the PV1 segment results in the creation of a new Encounter resource"
...
* group[0].element[23].code = #ADT_A01.PV1
...
* group[0].element[24].code = #ADT_A01.PV2
...
* group[0].element[25].code = #ADT_A01:follow:PV1.ROL
...
* group[0].element[27].code = #ADT_A01.OBSERVATION.OBX
...
* group[0].element[28].code = #ADT_A01.AL1
...
* group[0].element[31].code = #ADT_A01.DG1
...
* group[0].element[32].code = #ADT_A01.PROCEDURE.PR1
...
* group[0].element[33].code = #ADT_A01.INSURANCE.IN1
...
* group[0].element[34].code = #ADT_A01.INSURANCE.IN3
...
* group[0].element[34].target.code = #CareTeam[1]
* group[0].element[34].target.display = "CareTeam[1]"
