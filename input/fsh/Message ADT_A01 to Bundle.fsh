...
* group.element[17].target.dependsOn[0].value = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
* group.element[17].target.dependsOn[0].display = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
...
* group.element[18].target.dependsOn[0].value = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
* group.element[18].target.dependsOn[0].display = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
...
* group.element[19].target.dependsOn[0].value = "IF NK1-3.1 IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
* group.element[19].target.dependsOn[0].display = "IF NK1-3.1 IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
