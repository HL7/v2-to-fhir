...
* group.element[4].code = #ADT_A01.MSH
...
* group.element[6].code = #ADT_A01.SFT
...
* group.element[8].code = #ADT_A01.EVN
...
* group.element[10].target.code = #RelatedPerson
* group.element[10].target.display = "RelatedPerson"
...
* group.element[11].target.code = #Account
* group.element[11].target.display = "Account"
...
* group.element[11].target.dependsOn[1].value = "Account.subject.reference=Patient[1].id"
* group.element[12].code = #ADT_A01.PID
...
* group.element[12].target.code = #CareTeam[1]
* group.element[12].target.display = "CareTeam[1]"
* group.element[12].target.dependsOn[0].property = "segment-map"
* group.element[12].target.dependsOn[0].value = "PID[CareTeam]"
* group.element[12].target.dependsOn[1].property = "references"
* group.element[12].target.dependsOn[1].value = "CareTeam[1].subject.reference=Patient[1].id"
* group.element[12].target.product[0].property = "antlr"
* group.element[12].target.product[0].value = "IF IN3.21 IS VALUED"
* group.element[13].code = #ADT_A01.PID
...
* group.element[13].display = "Patient Identification"
* group.element[13].target.equivalence = #equivalent
* group.element[13].target.code = #Provenance[4]
* group.element[13].target.display = "Provenance[4]"
* group.element[13].target.dependsOn[0].property = "segment-map"
* group.element[13].target.dependsOn[0].value = "PID[Provenance-Patient]"
* group.element[13].target.dependsOn[1].property = "references"
* group.element[13].target.dependsOn[1].value = "Provenance.target.reference=Patient[1].id"
* group.element[13].target.product[0].property = "antlr"
* group.element[13].target.product[0].value = "IF PID-33 AND PID-34 VALUED"
* group.element[13].target.product[1].property = "narrative"
* group.element[13].target.product[1].value = "One  may drop PID-33 from the condition if PID-34 Last Update Facility is still sufficient without a date."
* group.element[14].code = #ADT_A01.PD1
...
* group.element[14].display = "Additional Demographics"
* group.element[14].target.equivalence = #equivalent
* group.element[14].target.code = #Patient[1]
* group.element[14].target.display = "Patient[1]"
* group.element[14].target.comment = "Incorporate PD1 content into the Patient created from the PID segment."
* group.element[14].target.dependsOn[0].property = "segment-map"
* group.element[14].target.dependsOn[0].value = "PD1[Patient]"
* group.element[15].code = #ADT_A01:follow:PID.ROL
...
* group.element[15].target.dependsOn[0].value = "ROL[Patient-GeneralPractitioner]"
* group.element[15].target.product[0].property = "antlr"
* group.element[15].target.product[0].value = "IF ROL-3.1 EQUALS \"PP\" AND ROL-3.3 EQUALS \"HL70443\""
* group.element[15].target.product[1].property = "fhirpath"
* group.element[15].target.product[1].value = "(element(\"3.1\")=\"PP\")and(element(\"3.3\")=\"HL70443\")"
* group.element[16].code = #ADT_A01:follow:PID.ROL
...
* group.element[16].target.dependsOn[0].value = "ROL[CareTeam]"
...
* group.element[16].target.product[0].value = "IF ROL-3.3 EQUALS \"HL70443\" AND ROL-3.1 IS NOT \"PP\""
* group.element[16].target.product[1].property = "fhirpath"
* group.element[16].target.product[1].value = "(element(\"3.1\")!=\"PP\")or(element(\"3.3\")!=\"HL70443\")"
* group.element[16].target.product[2].property = "narrative"
* group.element[16].target.product[2].value = "When the ROL includes entries with roles in Table HL70443 other than \"PP\", then they may be candidates for CareTeam, but not all.  That is implementation specific."
* group.element[17].code = #ADT_A01:follow:PID.PRT
...
* group.element[17].display = "Participation"
...
* group.element[17].target.dependsOn[0].value = "PRT[Patient-GeneralPractitioner]"
* group.element[17].target.product[0].property = "antlr"
* group.element[17].target.product[0].value = "IF PRT-4 IS \"PP\""
* group.element[18].code = #ADT_A01:follow:PID.PRT
...
* group.element[18].display = "Participation"
* group.element[18].target.equivalence = #equivalent
* group.element[18].target.code = #CareTeam[1]
* group.element[18].target.display = "CareTeam[1]"
* group.element[18].target.dependsOn[0].property = "segment-map"
* group.element[18].target.dependsOn[0].value = "PRT[CareTeam]"
* group.element[18].target.product[0].property = "antlr"
* group.element[18].target.product[0].value = "IF PRT-4 IS NOT \"PP\""
...
* group.element[19].target.code = #RelatedPerson[2]
* group.element[19].target.display = "RelatedPerson[2]"
* group.element[19].target.comment = "Typically, each NK1 will be translated to either a new RelatedPerson resource or added as a new occurrence of Patient.contact, but it's possible to insert the NK1 data into both structures."
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "NK1[RelatedPerson]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "RelatedPerson[2].patient.reference=Patient[1].id"
* group.element[19].target.product[0].property = "antlr"
* group.element[19].target.product[0].value = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
* group.element[20].code = #ADT_A01.NEXT_OF_KIN.NK1
...
* group.element[20].display = "Next of Kin / Associated Parties"
...
* group.element[20].target.dependsOn[0].value = "NK1[Patient]"
* group.element[20].target.product[0].property = "antlr"
* group.element[20].target.product[0].value = "IF NK1-3.1 NOT IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
* group.element[21].code = #ADT_A01.NEXT_OF_KIN.NK1
...
* group.element[21].display = "Next of Kin / Associated Parties"
...
* group.element[21].target.dependsOn[0].value = "NK1[Patient]"
* group.element[21].target.product[0].property = "antlr"
* group.element[21].target.product[0].value = "IF NK1-3.1 IN (\"EMR\", \"E\", \"F\", \"I\", \"S\")"
...
* group.element[22].target.dependsOn[0].value = "PV1[Encounter]"
* group.element[22].target.dependsOn[1].property = "references"
* group.element[22].target.dependsOn[1].value = "Encounter[1].subject.reference=Patient[1].id"
...
* group.element[23].target.code = #Patient[1]
* group.element[23].target.display = "Patient[1]"
* group.element[23].target.dependsOn[0].property = "segment-map"
* group.element[23].target.dependsOn[0].value = "PV1[Patient]"
* group.element[24].code = #ADT_A01.PV1
...
* group.element[24].target.code = #CareTeam[1]
* group.element[24].target.display = "CareTeam[1]"
* group.element[24].target.dependsOn[0].property = "segment-map"
* group.element[24].target.dependsOn[0].value = "PV1[CareTeam]"
* group.element[24].target.dependsOn[1].property = "references"
* group.element[24].target.dependsOn[1].value = "CareTeam[1].encounter.reference=Encounter[1].id"
* group.element[24].target.product[0].property = "antlr"
* group.element[24].target.product[0].value = "IF IN3.21 IS VALUED"
* group.element[25].code = #ADT_A01.PV2
...
* group.element[25].display = "Patient Visit - Additional Info."
...
* group.element[25].target.comment = "Incorporate PV2 content into the Encounter created from the PV1 segment."
* group.element[25].target.dependsOn[0].property = "segment-map"
* group.element[25].target.dependsOn[0].value = "PV2[Encounter]"
* group.element[26].code = #ADT_A01:follow:PV1.ROL
...
* group.element[26].target.dependsOn[0].value = "ROL[Encounter-PractitionerRole]"
...
* group.element[27].target.dependsOn[1].value = "Observation[3].subject.reference=Patient[1].id"
...
* group.element[28].code = #ADT_A01.OBSERVATION.OBX
...
* group.element[28].target.code = #Observation[3]
* group.element[28].target.display = "Observation[3]"
...
* group.element[28].target.dependsOn[1].value = "Observation[3].subject.reference=Patient[1].id"
...
* group.element[29].code = #ADT_A01.AL1
...
* group.element[29].display = "Allergy Information"
* group.element[29].target.equivalence = #equivalent
* group.element[29].target.code = #AllergyIntolerance
* group.element[29].target.display = "AllergyIntolerance"
* group.element[29].target.comment = "Processing of the AL1 segment results in the creation of a new AllergyIntolerance resource"
* group.element[29].target.dependsOn[0].property = "segment-map"
* group.element[29].target.dependsOn[0].value = "AL1[AllergyIntolerance]"
* group.element[29].target.dependsOn[1].property = "references"
* group.element[29].target.dependsOn[1].value = "AllergyIntolerance.patient.reference=Patient[1].id"
...
* group.element[30].target.comment = "Processing of the DG1 segment results in the creation of a new Condition resource"
...
* group.element[30].target.dependsOn[1].value = "Condition[1].subject.reference=Patient[1].id"
* group.element[30].target.product[0].property = "narrative"
* group.element[30].target.product[0].value = "If in context of the patient"
...
* group.element[31].target.code = #Encounter[1]
* group.element[31].target.display = "Encounter[1]"
* group.element[31].target.dependsOn[0].property = "segment-map"
* group.element[31].target.dependsOn[0].value = "DG1[Encounter]"
* group.element[31].target.dependsOn[1].property = "references"
* group.element[31].target.dependsOn[1].value = "Encounter[1].diagnosis.reference=Condition[1].id"
* group.element[31].target.product[0].property = "narrative"
* group.element[31].target.product[0].value = "If in context of an encounter"
* group.element[32].code = #ADT_A01.DG1
...
* group.element[32].display = "Diagnosis Information"
* group.element[32].target.equivalence = #equivalent
* group.element[32].target.code = #EpisodeOfCare[1]
* group.element[32].target.display = "EpisodeOfCare[1]"
* group.element[32].target.dependsOn[0].property = "segment-map"
* group.element[32].target.dependsOn[0].value = "DG1[EpisodeOfCare]"
...
"""
* group.element[32].target.product[0].property = "narrative"
* group.element[32].target.product[0].value = "If in context of a episode of care"
* group.element[33].code = #ADT_A01.PROCEDURE.PR1
...
* group.element[33].display = "Procedures"
* group.element[33].target.equivalence = #equivalent
* group.element[33].target.code = #Procedure
* group.element[33].target.display = "Procedure"
* group.element[33].target.dependsOn[0].property = "segment-map"
* group.element[33].target.dependsOn[0].value = "PR1[Procedure]"
* group.element[33].target.dependsOn[1].property = "references"
* group.element[33].target.dependsOn[1].value = "Procedure.subject.reference=Patient[1].id"
* group.element[34].code = #ADT_A01.INSURANCE.IN1
...
* group.element[34].display = "Insurance"
* group.element[34].target.equivalence = #equivalent
* group.element[34].target.code = #Coverage[1]
* group.element[34].target.display = "Coverage[1]"
* group.element[34].target.comment = "Processing of the IN1 segment results in the creation of a new Coverage resource"
* group.element[34].target.dependsOn[0].property = "segment-map"
* group.element[34].target.dependsOn[0].value = "IN1[Coverage]"
* group.element[34].target.dependsOn[1].property = "references"
* group.element[34].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
* group.element[35].code = #ADT_A01.INSURANCE.IN2
...
* group.element[35].display = "Insurance Additional Info."
* group.element[35].target.equivalence = #equivalent
* group.element[35].target.code = #Coverage[1]
* group.element[35].target.display = "Coverage[1]"
* group.element[35].target.comment = "Incorporate IN2 content into the Coverage created from the IN1 segment."
* group.element[35].target.dependsOn[0].property = "segment-map"
* group.element[35].target.dependsOn[0].value = "IN2[Coverage]"
* group.element[36].code = #ADT_A01.INSURANCE.IN3
...
* group.element[36].display = "Insurance Additional Info - Cert."
* group.element[36].target.equivalence = #equivalent
* group.element[36].target.code = #CareTeam[1]
* group.element[36].target.display = "CareTeam[1]"
* group.element[36].target.comment = "Incorporate IN3 content into the Coverage created from the IN1 segment."
* group.element[36].target.dependsOn[0].property = "segment-map"
* group.element[36].target.dependsOn[0].value = "IN3[CareTeam]"
* group.element[36].target.dependsOn[1].property = "references"
* group.element[36].target.dependsOn[1].value = "CareTeam.subject.reference=Patient[1].id"
