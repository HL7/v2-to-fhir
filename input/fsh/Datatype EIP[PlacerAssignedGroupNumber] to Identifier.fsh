// HL7 Data Type - FHIR E2_ EIP[Identifier-PlacerAssignedGroupNumber] - Sheet1.csv
Instance: DatatypeEIPPlacerAssignedGroupNumberToIdentifier
InstanceOf: ConceptMap
Title: "Datatype EIP [PlacerAssignedGroupNumber] to Identifier Map"
Usage: #definition
* title = "Datatype EIP [PlacerAssignedGroupNumber] to Identifier Map"
* description = "This ConceptMap represents a mapping from the HL7 V2 Datatype EIP to the FHIR Identifier Data Type."
* id = "datatype-eip-placerassignedgroupnumber-to-identifier"
* url = "http://hl7.org/fhir/uv/v2mappings/ConceptMap/datatype-eip-placerassignedgroupnumber-to-identifier"
* name = "DatatypeEIPPlacerAssignedGroupNumberToIdentifier"
* insert PublicationData
* extension[0].url = "http://hl7.org/fhir/uv/v2mappings/StructureDefinition/RelatedArtifact"
* extension[0].extension[0].url = "type"
* extension[0].extension[0].valueCode = #derived-from
* extension[0].extension[1].url = "label"
* extension[0].extension[1].valueString = "Datatype EIP[PlacerAssignedGroupNumber] to Identifier.fsh"
* extension[0].extension[2].url = "url"
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1_GXRWDbJtj5znmQudH5yM2duILlbyqtOBRIaCMLpjdk/edit?gid=0#gid=0"
