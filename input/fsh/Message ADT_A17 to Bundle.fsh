...
Title: "Message ADT_A17null to Bundle Map"
* title = "Message ADT_A17null to Bundle Map"
...
* group.element[12].target.dependsOn[1].value = "Observation[3].subject.reference=Patient[1].id"
...
* group.element[18].target.dependsOn[0].value = "PID[Patient]"
...
* group.element[19].target.dependsOn[0].value = "PID[Account]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "Account[2].subject.reference=Patient[2].id"
...
* group.element[20].target.dependsOn[0].value = "PID[Provenance-Patient]"
* group.element[20].target.dependsOn[1].property = "references"
* group.element[20].target.dependsOn[1].value = "Provenance[5].target.reference=Patient[2].id"
* group.element[20].target.product[0].property = "antlr"
* group.element[20].target.product[0].value = "IF PID-33 AND PID-34 VALUED"
* group.element[20].target.product[1].property = "narrative"
* group.element[20].target.product[1].value = "One  may drop PID-33 from the condition if PID-34 Last Update Facility is still sufficient without a date."
...
* group.element[21].target.dependsOn[0].value = "PD1[Patient]"
...
* group.element[22].target.dependsOn[1].value = "Encounter[2].subject.reference=Patient[2].id"
...
* group.element[24].code = #ADT_A17.PV2
...
* group.element[26].code = #ADT_A17.OBSERVATION.OBX
...
* group.element[26].target.dependsOn[1].value = "Observation[2].subject.reference=Patient[2].id"
