...
* group.element[12].code = #ADT_A17.PD1
...
* group.element[19].target.dependsOn[0].value = "PID[RelatedPerson-Mother]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "RelatedPerson[2].patient.reference=Patient[2].id"
...
* group.element[20].target.code = #Account[2]
* group.element[20].target.display = "Account[2]"
* group.element[20].target.dependsOn[0].property = "segment-map"
* group.element[20].target.dependsOn[0].value = "PID[Account]"
* group.element[20].target.dependsOn[1].property = "references"
* group.element[20].target.dependsOn[1].value = "Account[2].subject.reference=Patient[2].id"
...
* group.element[21].target.code = #Provenance[5]
* group.element[21].target.display = "Provenance[5]"
* group.element[21].target.dependsOn[0].property = "segment-map"
* group.element[21].target.dependsOn[0].value = "PID[Provenance-Patient]"
* group.element[21].target.dependsOn[1].property = "references"
* group.element[21].target.dependsOn[1].value = "Provenance[5].target.reference=Patient[2].id"
* group.element[21].target.product[0].property = "antlr"
* group.element[21].target.product[0].value = "IF PID-33 AND PID-34 VALUED"
* group.element[21].target.product[1].property = "narrative"
* group.element[21].target.product[1].value = "One  may drop PID-33 from the condition if PID-34 Last Update Facility is still sufficient without a date."
* group.element[22].code = #ADT_A17.PD1
...
* group.element[22].display = "Additional Demographics"
...
* group.element[22].target.comment = "Incorporate PD1 content into the Patient created from the PID segment."
* group.element[22].target.dependsOn[0].property = "segment-map"
* group.element[22].target.dependsOn[0].value = "PD1[Patient]"
...
* group.element[23].target.comment = "Processing of the PV1 segment results in the creation of a new Encounter resource"
* group.element[23].target.dependsOn[0].property = "segment-map"
* group.element[23].target.dependsOn[0].value = "PV1[Encounter]"
* group.element[23].target.dependsOn[1].property = "references"
* group.element[23].target.dependsOn[1].value = "Encounter[2].subject.reference=Patient[2].id"
...
* group.element[24].target.code = #Patient[2]
* group.element[24].target.display = "Patient[2]"
* group.element[24].target.dependsOn[0].property = "segment-map"
* group.element[24].target.dependsOn[0].value = "PV1[Patient]"
* group.element[25].code = #ADT_A17.PV2
...
* group.element[25].target.code = #Encounter[2]
* group.element[25].target.display = "Encounter[2]"
