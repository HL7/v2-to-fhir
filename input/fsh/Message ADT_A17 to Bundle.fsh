...
* group.element[23].target.dependsOn[0].value = "PV1[EncounterHistory]"
* group.element[23].target.dependsOn[1].property = "references"
* group.element[23].target.dependsOn[1].value = "EncounterHistory.subject.reference=Patient[1].id"
* group.element[23].target.product[0].property = "antlr"
* group.element[23].target.product[0].value = "IF PV1-43 VALUED"
...
* group.element[25].target.dependsOn[0].value = "PV1[Coverage]"
* group.element[25].target.dependsOn[1].property = "references"
* group.element[25].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
* group.element[25].target.product[0].property = "antlr"
* group.element[25].target.product[0].value = "IF PV1-20 VALUE"
