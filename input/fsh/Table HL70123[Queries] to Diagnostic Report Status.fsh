...
* group[0].element[3].display = "Preliminary: A verified early result is available, final results not yet obtained"
...
* group[0].element[4].display = "Correction to results"
...
* group[0].element[6].display = "Final results; results stored and verified.Can only be changed with a corrected result."
...
* group[1].element[1].display = "No order on record for this test.(Used only on queries)"
* group[1].element[1].target.equivalence = #unmatched
* group[1].element[2].code = #Z
* group[1].element[2].display = "No record of this patient. (Used only on queries)"
