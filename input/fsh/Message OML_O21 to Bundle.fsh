...
* group.element[15].target.code = #EncounterHistory
* group.element[15].target.display = "EncounterHistory"
* group.element[15].target.dependsOn[0].property = "segment-map"
* group.element[15].target.dependsOn[0].value = "PV1[EncounterHistory]"
* group.element[15].target.dependsOn[1].property = "references"
* group.element[15].target.dependsOn[1].value = "EncounterHistory.subject.reference=Patient[1].id"
* group.element[15].target.product[0].property = "antlr"
* group.element[15].target.product[0].value = "IF PV1-43 VALUED"
...
* group.element[17].target.dependsOn[0].value = "PV1[Coverage]"
* group.element[17].target.dependsOn[1].property = "references"
* group.element[17].target.dependsOn[1].value = "Coverage.beneficiary.reference=Patient[1].id"
* group.element[17].target.product[0].property = "antlr"
* group.element[17].target.product[0].value = "IF PV1-20 VALUE"
...
* group.element[20].target.dependsOn[0].value = "IN1[Coverage]"
* group.element[20].target.dependsOn[1].property = "references"
* group.element[20].target.dependsOn[1].value = "Coverage.subscriber=Patient[PID]"
...
* group.element[21].target.dependsOn[0].value = "IN3[CareTeam]"
...
* group.element[22].target.dependsOn[0].value = "AL1[AllergyIntolerance]"
* group.element[22].target.dependsOn[1].property = "references"
* group.element[22].target.dependsOn[1].value = "AllergyIntolerance.patient=Patient[PID]"
...
* group.element[23].target.dependsOn[1].value = "ServiceRequest.subject=Patient[PID]"
...
* group.element[24].target.dependsOn[0].value = "ORC[Provenance]"
* group.element[24].target.dependsOn[1].property = "references"
* group.element[24].target.dependsOn[1].value = "Provenance.target=ServiceRequest[ORC]"
...
* group.element[25].target.dependsOn[1].value = "ServiceRequest[1].requester.reference=PractitionerRole[3].id"
...
* group.element[26].target.dependsOn[0].value = "TQ1[ServiceRequest]"
...
* group.element[28].target.dependsOn[0].value = "OBR[Specimen]"
...
* group.element[29].target.dependsOn[0].value = "NTE[ServiceRequest]"
...
* group.element[30].target.dependsOn[1].value = "ServiceRequest[1].specimen[1](Specimen.collection.collector.reference)=PractitionerRole[4].id"
...
* group.element[31].target.dependsOn[1].value = "ServiceRequest[1].requester.reference=PractitionerRole[3].id"
...
* group.element[32].target.dependsOn[0].value = "DG1[Condition]"
* group.element[32].target.dependsOn[1].property = "references"
* group.element[32].target.dependsOn[1].value = "ServiceRequest[1].reasonReference.reference=Condition[1].id; Condition[1].subject.reference=Patient[1].id"
...
* group.element[33].target.product[0].value = "IF  OBX-5 LST.count GREATER THAN 1"
...
* group.element[34].target.product[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1"
...
* group.element[37].target.dependsOn[1].value = "Observation[1].performer.reference=PractitionerRole[7].id"
...
* group.element[38].target.dependsOn[0].value = "NTE[Observation]"
...
* group.element[39].target.dependsOn[1].value = "ServiceRequest[1].specimen.reference=Specimen[SPM].id"
