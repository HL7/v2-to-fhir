...
* group.element[17].code = #OML_O21.PATIENT.INSURANCE.IN2
...
* group.element[17].display = "Insurance Additional Information"
* group.element[17].target.equivalence = #equivalent
* group.element[17].target.code = #Coverage[1]
* group.element[17].target.display = "Coverage[1]"
* group.element[17].target.comment = "Incorporate IN2 content into the Coverage created from the IN1 segment."
* group.element[17].target.dependsOn[0].property = "segment-map"
* group.element[17].target.dependsOn[0].value = "IN2[Coverage]"
...
* group.element[18].target.comment = "Incorporate IN3 content into the Coverage created from the IN1 segment."
* group.element[18].target.dependsOn[0].property = "segment-map"
* group.element[18].target.dependsOn[0].value = "IN3[Coverage]"
...
* group.element[24].code = #OML_O21.ORDER.TIMING.TQ2
...
* group.element[24].display = "Billing Segment"
...
* group.element[24].target.dependsOn[0].value = "TQ2[ServiceRequest]"
...
* group.element[31].target.product[0].value = "IF OBX-29 IN (\"QST\", \"SCI\")"
