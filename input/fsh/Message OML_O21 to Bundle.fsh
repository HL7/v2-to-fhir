...
Title: "Message OML_O21null to Bundle Map"
* title = "Message OML_O21null to Bundle Map"
...
* group.element[9].target.dependsOn[1].value = "Observation[2].subject.reference=Patient[1].id"
...
* group.element[10].target.product[1].value = "(element(\"4.1\")=\"PP\")and(element(\"4.3\")=\"HL70443\")"
...
* group.element[11].target.dependsOn[1].value = "RelatedPerson[1].patient.reference=Patient[1].id"
...
* group.element[11].target.product[1].value = "(element(\"4.1\"!)=\"PP\")or(element(\"4.3\")!=\"HL70443\")"
...
* group.element[12].target.dependsOn[1].value = "RelatedPerson[2].patient.reference=Patient[1].id"
...
* group.element[14].target.dependsOn[1].value = "Encounter.subject=Patient[PID]"
...
* group.element[16].code = #OML_O21.PATIENT.PATIENT_VISIT.PV2
...
* group.element[17].code = #OML_O21.PATIENT.PATIENT_VISIT.PRT
...
* group.element[17].target.comment = "Incorporate PRT content into the Encounter created from the PV1 segment."
...
* group.element[17].target.dependsOn[1].value = "Encounter[1].participant.individual.reference=PractitionerRole[2].id"
* group.element[18].code = #OML_O21.PATIENT.INSURANCE.IN1
...
* group.element[18].display = "Insurance"
* group.element[18].target.equivalence = #equivalent
* group.element[18].target.code = #Coverage[1]
* group.element[18].target.display = "Coverage[1]"
* group.element[18].target.comment = "Processing of the IN1 segment results in the creation of a new Coverage resource"
* group.element[18].target.dependsOn[0].property = "segment-map"
* group.element[18].target.dependsOn[0].value = "IN1[Coverage]"
* group.element[18].target.dependsOn[1].property = "references"
* group.element[18].target.dependsOn[1].value = "Coverage.subscriber=Patient[PID]"
* group.element[19].code = #OML_O21.PATIENT.INSURANCE.IN3
...
* group.element[19].display = "Insurance Additional Information, Certification"
* group.element[19].target.equivalence = #equivalent
* group.element[19].target.code = #Coverage[1]
* group.element[19].target.display = "Coverage[1]"
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "IN3[CareTeam]"
* group.element[20].code = #OML_O21.PATIENT.AL1
...
* group.element[20].display = "Allergy Information"
* group.element[20].target.equivalence = #equivalent
* group.element[20].target.code = #AllergyIntolerance
* group.element[20].target.display = "AllergyIntolerance"
* group.element[20].target.comment = "Processing of the AL1 segment results in the creation of a new AllergyIntolerance resource"
* group.element[20].target.dependsOn[0].property = "segment-map"
* group.element[20].target.dependsOn[0].value = "AL1[AllergyIntolerance]"
* group.element[20].target.dependsOn[1].property = "references"
* group.element[20].target.dependsOn[1].value = "AllergyIntolerance.patient=Patient[PID]"
* group.element[21].code = #OML_O21.ORDER.ORC
...
* group.element[21].target.comment = "Processing of each ORC segment results in the creation of a new ServiceRequest resource"
...
* group.element[21].target.dependsOn[1].value = "ServiceRequest.subject=Patient[PID]"
* group.element[22].code = #OML_O21.ORDER.ORC
...
* group.element[22].display = "Common Order"
* group.element[22].target.equivalence = #equivalent
* group.element[22].target.code = #Provenance[3]
* group.element[22].target.display = "Provenance[3]"
* group.element[22].target.comment = "Using Provenance is the preferred way, but a local implementation may decide to add extensions to the main resource.  As the use and guidance of Provenance matures we wil revisit this later."
* group.element[22].target.dependsOn[0].property = "segment-map"
* group.element[22].target.dependsOn[0].value = "ORC[Provenance]"
* group.element[22].target.dependsOn[1].property = "references"
* group.element[22].target.dependsOn[1].value = "Provenance.target=ServiceRequest[ORC]"
* group.element[23].code = #OML_O21.ORDER.PRT
...
* group.element[23].display = "Participation (for Common Order)"
...
* group.element[24].code = #OML_O21.ORDER.TIMING.TQ1
...
* group.element[24].display = "Timing/Quantity"
...
* group.element[24].target.dependsOn[0].value = "TQ1[ServiceRequest]"
...
* group.element[25].target.comment = "Incorporate OBR content into the ServiceRequest created from the ORC segment in the same segment group."
* group.element[25].target.dependsOn[0].property = "segment-map"
* group.element[25].target.dependsOn[0].value = "OBR[ServiceRequest]"
* group.element[26].code = #OML_O21.ORDER.OBSERVATION_REQUEST.OBR
...
* group.element[26].display = "Observation Request"
* group.element[26].target.equivalence = #equivalent
* group.element[26].target.code = #Specimen[each]
* group.element[26].target.display = "Specimen[each]"
* group.element[26].target.dependsOn[0].property = "segment-map"
* group.element[26].target.dependsOn[0].value = "OBR[Specimen]"
* group.element[27].code = #OML_O21.ORDER.OBSERVATION_REQUEST.NTE
...
* group.element[27].display = "Notes and Comments (for Detail)"
...
* group.element[27].target.dependsOn[0].value = "NTE[ServiceRequest]"
...
* group.element[28].target.dependsOn[1].value = "ServiceRequest[1].specimen[1](Specimen.collection.collector.reference)=PractitionerRole[4].id"
...
* group.element[29].code = #OML_O21.ORDER.OBSERVATION_REQUEST.PRT
...
* group.element[29].display = "Participation (for Observation Request)"
...
* group.element[29].target.dependsOn[1].value = "ServiceRequest[1].requester.reference=PractitionerRole[3].id"
...
* group.element[30].code = #OML_O21.ORDER.OBSERVATION_REQUEST.DG1
...
* group.element[30].display = "Diagnosis"
* group.element[30].target.equivalence = #equivalent
* group.element[30].target.code = #Condition[1]
* group.element[30].target.display = "Condition[1]"
* group.element[30].target.comment = "Processing of the DG1 segment results in the creation of a new Condition resource which is referenced in the ServiceRequest created by the ORC segment"
* group.element[30].target.dependsOn[0].property = "segment-map"
* group.element[30].target.dependsOn[0].value = "DG1[Condition]"
* group.element[30].target.dependsOn[1].property = "references"
* group.element[30].target.dependsOn[1].value = "ServiceRequest[1].reasonReference.reference=Condition[1].id; Condition[1].subject.reference=Patient[1].id"
* group.element[31].code = #OML_O21.ORDER.OBSERVATION_REQUEST.OBSERVATION.OBX
...
* group.element[31].target.code = #Observation[1]
* group.element[31].target.display = "Observation[1]"
...
* group.element[31].target.dependsOn[1].value = "ServiceRequest[1].supportingInfo.reference=Observation[1].id; Observation[1].subject.id=Patient[1].id"
...
* group.element[32].code = #OML_O21.ORDER.OBSERVATION_REQUEST.OBSERVATION.OBX
...
* group.element[32].display = "Observation/Result"
...
* group.element[32].target.dependsOn[1].value = "ServiceRequest[1].supportingInfo.reference=Observation[1].id; Observation[1].subject.id=Patient[1].id"
* group.element[32].target.product[0].property = "antlr"
* group.element[32].target.product[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1"
...
* group.element[33].target.code = #Device[1]
* group.element[33].target.display = "Device[1]"
* group.element[33].target.dependsOn[0].property = "segment-map"
* group.element[33].target.dependsOn[0].value = "PRT[Device]"
* group.element[33].target.dependsOn[1].property = "references"
* group.element[33].target.dependsOn[1].value = "Observation[1].device.reference=Device.id"
* group.element[33].target.product[0].property = "antlr"
* group.element[33].target.product[0].value = "IF PRT-10 VALUED"
* group.element[34].code = #OML_O21.ORDER.OBSERVATION_REQUEST.OBSERVATION.PRT
...
* group.element[34].display = "Participation (for OBX)"
...
* group.element[34].target.comment = "Incorporate PRT content into the Observation created from the OBX segment in the same segment group when it represents observation location information."
* group.element[34].target.dependsOn[0].property = "segment-map"
* group.element[34].target.dependsOn[0].value = "PRT[Observation-Location]"
* group.element[34].target.product[0].property = "antlr"
* group.element[34].target.product[0].value = "IF PRT-9 VALUED OR IF PRT-14 VALUED"
...
* group.element[35].target.code = #PractitionerRole[7]
* group.element[35].target.display = "PractitionerRole[7]"
* group.element[35].target.comment = "Incorporate PRT content into the Observation created from the OBX segment in the same segment group when it represents observation practitioner information."
* group.element[35].target.dependsOn[0].property = "segment-map"
* group.element[35].target.dependsOn[0].value = "PRT[PractitionerRole]"
* group.element[35].target.dependsOn[1].property = "references"
* group.element[35].target.dependsOn[1].value = "Observation[1].performer.reference=PractitionerRole[7].id"
* group.element[35].target.product[0].property = "antlr"
* group.element[35].target.product[0].value = "IF PRT-5 VALUED"
* group.element[36].code = #OML_O21.ORDER.OBSERVATION_REQUEST.OBSERVATION.NTE
...
* group.element[36].display = "Notes and Comments (for Results)"
...
* group.element[36].target.dependsOn[0].value = "NTE[Observation]"
* group.element[37].code = #OML_O21.ORDER.OBSERVATION_REQUEST.SPECIMEN.SPM
...
* group.element[37].display = "Specimen"
* group.element[37].target.equivalence = #equivalent
* group.element[37].target.code = #Specimen
* group.element[37].target.display = "Specimen"
* group.element[37].target.dependsOn[0].property = "segment-map"
* group.element[37].target.dependsOn[0].value = "SPM[Specimen]"
* group.element[37].target.dependsOn[1].property = "references"
* group.element[37].target.dependsOn[1].value = "ServiceRequest[1].specimen.reference=Specimen[SPM].id"
