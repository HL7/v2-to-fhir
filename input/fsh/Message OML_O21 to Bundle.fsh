...
* group.element[9].target.comment = "Incorporate PRT content into the Patient created from the PID segment when the PRT contains practitioner related data."
...
* group.element[9].target.product[1].value = "(element(\"4.1\")=\"PP\")and(element(\"4.3\")=\"HL70443\")"
...
* group.element[10].target.product[1].value = "(element(\"4.1\"!)=\"PP\")or(element(\"4.3\")!=\"HL70443\")"
...
* group.element[13].target.dependsOn[1].value = "Encounter.subject=Patient[PID]"
...
* group.element[15].code = #OML_O21.PATIENT.PATIENT_VISIT.PV2
...
* group.element[16].code = #OML_O21.PATIENT.PATIENT_VISIT.PRT
...
* group.element[16].display = "Participation (for Patient Visit)"
* group.element[16].target.equivalence = #equivalent
* group.element[16].target.code = #PractitionerRole[2]
* group.element[16].target.display = "PractitionerRole[2]"
* group.element[16].target.comment = "Incorporate PRT content into the Encounter created from the PV1 segment."
...
* group.element[16].target.dependsOn[1].value = "Encounter[1].participant.individual.reference=PractitionerRole[2].id"
* group.element[17].code = #OML_O21.PATIENT.INSURANCE.IN1
...
* group.element[17].display = "Insurance"
* group.element[17].target.equivalence = #equivalent
* group.element[17].target.code = #Coverage[1]
* group.element[17].target.display = "Coverage[1]"
* group.element[17].target.comment = "Processing of the IN1 segment results in the creation of a new Coverage resource"
* group.element[17].target.dependsOn[0].property = "segment-map"
* group.element[17].target.dependsOn[0].value = "IN1[Coverage]"
* group.element[17].target.dependsOn[1].property = "references"
* group.element[17].target.dependsOn[1].value = "Coverage.subscriber=Patient[PID]"
* group.element[18].code = #OML_O21.PATIENT.INSURANCE.IN3
...
* group.element[18].display = "Insurance Additional Information, Certification"
...
* group.element[18].target.dependsOn[0].value = "IN3[CareTeam]"
* group.element[19].code = #OML_O21.PATIENT.AL1
...
* group.element[19].target.dependsOn[1].value = "AllergyIntolerance.patient=Patient[PID]"
...
* group.element[20].target.comment = "Processing of each ORC segment results in the creation of a new ServiceRequest resource"
* group.element[20].target.dependsOn[0].property = "segment-map"
* group.element[20].target.dependsOn[0].value = "ORC[ServiceRequest]"
* group.element[20].target.dependsOn[1].property = "references"
* group.element[20].target.dependsOn[1].value = "ServiceRequest.subject=Patient[PID]"
...
* group.element[21].target.code = #Provenance[3]
* group.element[21].target.display = "Provenance[3]"
* group.element[21].target.comment = "Using Provenance is the preferred way, but a local implementation may decide to add extensions to the main resource.  As the use and guidance of Provenance matures we wil revisit this later."
* group.element[21].target.dependsOn[0].property = "segment-map"
* group.element[21].target.dependsOn[0].value = "ORC[Provenance]"
* group.element[21].target.dependsOn[1].property = "references"
* group.element[21].target.dependsOn[1].value = "Provenance.target=ServiceRequest[ORC]"
* group.element[22].code = #OML_O21.ORDER.PRT
...
* group.element[22].display = "Participation (for Common Order)"
...
* group.element[23].code = #OML_O21.ORDER.TIMING.TQ1
...
* group.element[23].display = "Timing/Quantity"
...
* group.element[23].target.dependsOn[0].value = "TQ1[ServiceRequest]"
...
* group.element[30].target.product[0].value = "IF  OBX-5 LST.count GREATER THAN 1"
...
* group.element[31].target.product[0].value = "IF OBX-5 LST.count LESS THAN OR EQUALS 1"
...
* group.element[32].target.code = #Device[1]
* group.element[32].target.display = "Device[1]"
...
* group.element[33].target.comment = "Incorporate PRT content into the Observation created from the OBX segment in the same segment group when it represents observation location information."
...
* group.element[34].target.comment = "Incorporate PRT content into the Observation created from the OBX segment in the same segment group when it represents observation practitioner information."
...
* group.element[35].code = #OML_O21.ORDER.OBSERVATION_REQUEST.OBSERVATION.NTE
...
* group.element[35].display = "Notes and Comments (for Results)"
* group.element[35].target.equivalence = #equivalent
* group.element[35].target.code = #Observation[1]
* group.element[35].target.display = "Observation[1]"
* group.element[35].target.dependsOn[0].property = "segment-map"
* group.element[35].target.dependsOn[0].value = "NTE[Observation]"
* group.element[36].code = #OML_O21.ORDER.OBSERVATION_REQUEST.SPECIMEN.SPM
...
* group.element[36].target.code = #Specimen
* group.element[36].target.display = "Specimen"
...
* group.element[36].target.dependsOn[1].value = "ServiceRequest[1].specimen.reference=Specimen[SPM].id"
