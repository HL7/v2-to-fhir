...
* group.element[25].target.dependsOn[0].value = "\"SB\""
...
* group.element[26].target.code = #identifier[4].type.coding.system
...
* group.element[26].target.display = "identifier[4].type.coding.system"
* group.element[26].target.dependsOn[0].property = "value"
* group.element[26].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0203\""
...
* group.element[27].target.code = #identifier[4].system
...
* group.element[27].target.display = "identifier[4].system"
* group.element[27].target.dependsOn[0].property = "value"
* group.element[27].target.dependsOn[0].value = "\"http://hl7.org/fhir/sid/us-ssn.\""
* group.element[28].code = #PID-20
...
* group.element[28].display = "Driver's License Number - Patient"
* group.element[28].target.equivalence = #equivalent
* group.element[28].target.code = #identifier[5]
...
* group.element[28].target.display = "identifier[5]"
* group.element[28].target.dependsOn[0].property = "data-type-map"
* group.element[28].target.dependsOn[0].value = "DLN[Identifier]"
* group.element[29].code = #PID-23
...
* group.element[29].display = "Birth Place"
* group.element[29].target.equivalence = #equivalent
* group.element[29].target.code = #extension[3].url
...
* group.element[29].target.display = "extension[3].url"
* group.element[29].target.dependsOn[0].property = "value"
* group.element[29].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/patient-birthPlace\""
...
* group.element[30].target.code = #extension[3].valueAddress.text
...
* group.element[30].target.display = "extension[3].valueAddress.text"
* group.element[31].code = #PID-24
...
* group.element[31].display = "Multiple Birth Indicator"
* group.element[31].target.equivalence = #equivalent
* group.element[31].target.code = #multipleBirthBoolean
...
* group.element[31].target.extension[0].extension[0].valueCode = #"boolean"
...
* group.element[31].target.display = "multipleBirthBoolean"
* group.element[31].target.dependsOn[0].property = "data-type-map"
* group.element[31].target.dependsOn[0].value = "ID[Boolean]"
* group.element[31].target.dependsOn[1].property = "vocabulary-map"
* group.element[31].target.dependsOn[1].value = "Yes/No"
* group.element[31].target.product[0].property = "antlr"
* group.element[31].target.product[0].value = "IF PID-25 NOT VALUED"
* group.element[32].code = #PID-25
...
* group.element[32].extension[0].extension[0].valueCode = #"NM"
...
* group.element[32].display = "Birth Order"
* group.element[32].target.equivalence = #equivalent
* group.element[32].target.code = #multipleBirthInteger
...
* group.element[32].target.extension[0].extension[0].valueCode = #"integer"
...
* group.element[32].target.display = "multipleBirthInteger"
* group.element[33].code = #PID-26
...
* group.element[33].display = "Citizenship"
* group.element[33].target.equivalence = #equivalent
* group.element[33].target.code = #extension[4].url
...
* group.element[33].target.display = "extension[4].url"
* group.element[33].target.dependsOn[0].property = "value"
* group.element[33].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/patient-citizenship\""
...
* group.element[34].target.code = #extension[4].extension[1].url
...
* group.element[34].target.display = "extension[4].extension[1].url"
* group.element[34].target.dependsOn[0].property = "value"
* group.element[34].target.dependsOn[0].value = "\"code\""
...
* group.element[35].target.code = #extension[4].extension[1].valueCodeableConcept
...
* group.element[35].target.display = "extension[4].extension[1].valueCodeableConcept"
...
* group.element[36].target.code = #extension[5].url
...
* group.element[36].target.display = "extension[5].url"
* group.element[36].target.dependsOn[0].property = "value"
* group.element[36].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/patient-nationality\""
...
* group.element[37].target.code = #extension[5].extension[1].url
...
* group.element[37].target.display = "extension[5].extension[1].url"
...
* group.element[38].target.code = #extension[5].extension[1].valueCodeableConcept
...
* group.element[39].display = "Patient Death Date and Time"
* group.element[39].target.equivalence = #equivalent
* group.element[39].target.code = #deceasedDateTime
...
* group.element[39].target.display = "deceasedDateTime"
* group.element[40].code = #PID-30
...
* group.element[40].display = "Patient Death Indicator"
* group.element[40].target.equivalence = #equivalent
* group.element[40].target.code = #deceasedBoolean
...
* group.element[40].target.extension[0].extension[0].valueCode = #"boolean"
...
* group.element[40].target.display = "deceasedBoolean"
* group.element[40].target.dependsOn[0].property = "data-type-map"
* group.element[40].target.dependsOn[0].value = "ID[Boolean]"
* group.element[40].target.dependsOn[1].property = "vocabulary-map"
* group.element[40].target.dependsOn[1].value = "Yes/No"
* group.element[40].target.product[0].property = "antlr"
* group.element[40].target.product[0].value = "IF PID-29 NOT VALUED"
* group.element[41].code = #PID-33
...
* group.element[41].display = "Last Update Date/Time"
* group.element[41].target.equivalence = #equivalent
* group.element[41].target.code = #meta.lastUpdated
...
* group.element[41].target.extension[0].extension[0].valueCode = #"instant"
...
* group.element[41].target.display = "meta.lastUpdated"
* group.element[42].code = #PID-35
...
* group.element[42].display = "Taxonomic Classification Code"
* group.element[42].target.equivalence = #equivalent
* group.element[42].target.code = #extension[6].url
...
* group.element[42].target.display = "extension[6].url"
* group.element[42].target.dependsOn[0].property = "value"
* group.element[42].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/patient-animal\""
...
* group.element[43].target.code = #extension[6].extension[1].url
...
* group.element[43].target.display = "extension[6].extension[1].url"
* group.element[43].target.dependsOn[0].property = "value"
* group.element[43].target.dependsOn[0].value = "\"species\""
...
* group.element[44].target.code = #extension[6].extension.valueCodeableConcept
...
* group.element[45].display = "Breed Code"
* group.element[45].target.equivalence = #equivalent
* group.element[45].target.code = #extension[6].url
...
* group.element[45].target.extension[0].extension[1].valueInteger = 1
...
* group.element[45].target.display = "extension[6].url"
* group.element[45].target.dependsOn[0].property = "value"
* group.element[45].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/patient-animal\""
...
* group.element[46].target.code = #extension[6].extension[2].url
...
* group.element[46].target.display = "extension[6].extension[2].url"
* group.element[46].target.dependsOn[0].property = "value"
* group.element[46].target.dependsOn[0].value = "\"breed\""
...
* group.element[47].target.code = #extension[6].extension[2].valueCodeableConcept
...
* group.element[48].display = "Tribal Citizenship"
* group.element[48].target.equivalence = #equivalent
* group.element[48].target.code = #extension[7].url
...
* group.element[48].target.extension[0].extension[1].valueInteger = 1
...
* group.element[48].target.display = "extension[7].url"
* group.element[48].target.dependsOn[0].property = "value"
* group.element[48].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/patient-citizenship\""
...
* group.element[49].target.code = #extension[7].extension[1].url
...
* group.element[49].target.display = "extension[7].extension[1].url"
* group.element[49].target.dependsOn[0].property = "value"
* group.element[49].target.dependsOn[0].value = "\"code\""
...
* group.element[50].target.code = #extension[7].extension[1].valueCodeableConcept
...
* group.element[50].target.display = "extension[7].extension[1].valueCodeableConcept"
* group.element[50].target.dependsOn[0].property = "data-type-map"
* group.element[50].target.dependsOn[0].value = "CWE[CodeableConcept]"
* group.element[51].code = #PID-40
...
* group.element[51].extension[0].extension[0].valueCode = #"XTN"
...
* group.element[51].display = "Patient Telecommunication Information"
* group.element[51].target.equivalence = #equivalent
* group.element[51].target.code = #telecom[3]
...
* group.element[51].target.extension[0].extension[0].valueCode = #"ContactPoint"
...
* group.element[51].target.display = "telecom[3]"
* group.element[51].target.dependsOn[0].property = "data-type-map"
* group.element[51].target.dependsOn[0].value = "XTN[ContactPoint]"
