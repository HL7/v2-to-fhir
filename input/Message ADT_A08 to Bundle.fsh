// HL7 Message - FHIR R4_ ADT_A08 - Sheet1.csv
Instance: MessageADT_A08toBundle
...
* extension[0].extension[1].valueString = "Message ADT:A08 to Bundle.fsh"
...
* group.element[20].target.dependsOn[0].value = "DG1"
...
* group.element[21].target.dependsOn[0].value = "DG1"
...
* group.element[22].target.dependsOn[0].value = "DG1"
...
* group.element[23].target.dependsOn[0].value = "DG1"
