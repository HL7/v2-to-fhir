Instance: ConceptMapHL70480toV3RoleCode
InstanceOf: ConceptMap
Title: "ConceptMap HL70480 to V3 RoleCode Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70480 to the FHIR V3 RoleCode Value Set."
* id = "conceptmap-hl70480-to-v3-rolecode"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70480-to-v3-rolecode"
* version = "1.0"
* name = "ConceptMap_HL70480_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
