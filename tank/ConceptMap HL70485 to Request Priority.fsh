Instance: ConceptMapHL70485toRequestPriority
InstanceOf: ConceptMap
Title: "ConceptMap HL70485 to Request Priority Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70485 to the FHIR Request Priority Value Set."
* id = "conceptmap-hl70485-to-request-priority"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70485-to-request-priority"
* version = "1.0"
* name = "ConceptMap_HL70485_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
