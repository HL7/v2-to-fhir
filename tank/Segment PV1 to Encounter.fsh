...
* group.element[2].target.display = "Encounter.location[1].location(Location)"
...
* group.element[5].target.display = "Encounter.type"
...
* group.element[6].target.display = "Encounter.hospitalization.preAdmissionIdentifier"
...
* group.element[7].target.display = "Encounter.location[2].location(Location)"
...
* group.element[9].target.display = "Encounter.participant[1].individual(Practitioner)"
...
* group.element[13].target.display = "Encounter.participant[2].individual(Practitioner)"
...
* group.element[17].target.display = "Encounter.participant[3].individual(Practitioner)"
...
* group.element[21].target.display = "Encounter.serviceType"
...
* group.element[22].target.display = "Encounter.hospitalization.reAdmission"
...
* group.element[23].target.display = "Encounter.hospitalization.admitSource"
...
* group.element[24].target.display = "Patient.extension-patient-importance"
...
* group.element[25].target.display = "Encounter.participant[4].individual(Practitioner)"
...
* group.element[29].target.display = "Encounter.identifier[1]"
...
* group.element[33].target.display = "Encounter.hospitalization.dischargeDisposition"
...
* group.element[34].target.display = "Encounter.hospitalization.destination(Location)"
...
* group.element[35].target.display = "Encounter.hospitalization.dietPreference"
...
* group.element[36].target.display = "Encounter.period.start"
...
* group.element[37].target.display = "Encounter.period.end"
...
* group.element[39].target.display = "Encounter.identifier[2]"
...
* group.element[40].target.display = "Encounter.participant[5].individual(Practitioner)"
...
* group.element[44].target.code = #Encounter.episodeOfCare(EpisodeOfCare.identifier)
* group.element[44].target.display = "Encounter.episodeOfCare(EpisodeOfCare.identifier)"
