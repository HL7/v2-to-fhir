Instance: ConceptMapHL70136toSpecimenStatus
InstanceOf: ConceptMap
Title: "ConceptMap HL70136 to Specimen Status Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70136 to the FHIR Specimen Status Value Set."
* id = "conceptmap-hl70136-to-specimen-status"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70136-to-specimen-status"
* version = "1.0"
* name = "ConceptMap_HL70136_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
