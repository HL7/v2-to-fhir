Instance: ConceptMapHL70078toV3ObservationInterpretation
InstanceOf: ConceptMap
Title: "ConceptMap HL70078 to V3 ObservationInterpretation Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70078 to the FHIR V3 ObservationInterpretation Value Set."
* id = "conceptmap-hl70078-to-v3-observationinterpretation"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70078-to-v3-observationinterpretation"
* version = "1.0"
* name = "ConceptMap_HL70078_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
