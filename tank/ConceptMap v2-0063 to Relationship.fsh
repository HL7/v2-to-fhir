Instance: ConceptMapv2-0063toRelationship
InstanceOf: ConceptMap
Title: "ConceptMap v2-0063 to Relationship Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table v2-0063 to the FHIR Relationship Value Set."
* id = "conceptmap-v2-0063-to-relationship"
* url = "http://hl7.org/fhir/v2-tofhir"
* version = "1.0"
* name = "ConceptMap_v2-0063_Map"
* status = #active
* experimental = true
* date = "2020-03-01"
...
* sourceUri = "http://terminology.hl7.org/CodeSystem/v2-0063"
