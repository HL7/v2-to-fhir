Instance: SegmentOBR!DiagnosticReporttoDiagnosticReport
InstanceOf: ConceptMap
Title: "Segment OBR!DiagnosticReport to DiagnosticReport Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 OBR!DiagnosticReport Segment to the FHIR DiagnosticReport Resource representing that segment."
* id = "segment-obr-diagnosticreport-to-diagnosticreport"
* url = "http://hl7.org/fhir/v2-tofhir"
* version = "1.0"
* name = "Segment_OBR!DiagnosticReport_Map"
* status = #active
* experimental = true
* date = "2020-03-01"
