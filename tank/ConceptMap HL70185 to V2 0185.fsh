Instance: ConceptMapHL70185toV20185
InstanceOf: ConceptMap
Title: "ConceptMap HL70185 to V2 0185 Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70185 to the FHIR V2 0185 Value Set."
* id = "conceptmap-hl70185-to-v2-0185"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70185-to-v2-0185"
* version = "1.0"
* name = "ConceptMap_HL70185_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
