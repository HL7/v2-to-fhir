Instance: SegmentORC!ServiceRequesttoServiceRequest
InstanceOf: ConceptMap
Title: "Segment ORC!ServiceRequest to ServiceRequest Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 ORC!ServiceRequest Segment to the FHIR ServiceRequest Resource representing that segment."
* id = "segment-orc-servicerequest-to-servicerequest"
* url = "http://hl7.org/fhir/v2-tofhir"
* version = "1.0"
* name = "Segment_ORC!ServiceRequest_Map"
* status = #active
* experimental = true
* date = "2020-03-01"
