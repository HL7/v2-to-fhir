Instance: SegmentORC!ImmunizationtoImmunization
InstanceOf: ConceptMap
Title: "Segment ORC!Immunization to Immunization Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 ORC!Immunization Segment to the FHIR Immunization Resource representing that segment."
* id = "segment-orc-immunization-to-immunization"
* url = "http://hl7.org/fhir/v2-tofhir"
* version = "1.0"
* name = "Segment_ORC!Immunization_Map"
* status = #active
* experimental = true
* date = "2020-03-01"
