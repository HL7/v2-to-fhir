Instance: ConceptMapHL70444toV20444
InstanceOf: ConceptMap
Title: "ConceptMap HL70444 to V2 0444 Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70444 to the FHIR V2 0444 Value Set."
* id = "conceptmap-hl70444-to-v2-0444"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70444-to-v2-0444"
* version = "1.0"
* name = "ConceptMap_HL70444_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
