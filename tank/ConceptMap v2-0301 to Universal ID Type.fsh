Instance: ConceptMapv2-0301toUniversalIDType
InstanceOf: ConceptMap
Title: "ConceptMap v2-0301 to Universal ID Type Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table v2-0301 to the FHIR Universal ID Type Value Set."
* id = "conceptmap-v2-0301-to-universal-id-type"
* url = "http://hl7.org/fhir/v2-tofhir"
* version = "1.0"
* name = "ConceptMap_v2-0301_Map"
* status = #active
* experimental = true
* date = "2020-03-01"
...
* sourceUri = "http://terminology.hl7.org/CodeSystem/v2-0301"
...
* group.element[9].display = "Usually a base64 encoded string of random bits.
...
* group.element[9].target.display = "Usually a base64 encoded string of random bits.
 Note: Random IDs are typically used for instance identifiers, rather than an identifier of an Assigning Authority that issues instance identifiers"
