Instance: ConceptMapHL70322toEventStatus
InstanceOf: ConceptMap
Title: "ConceptMap HL70322 to Event Status Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70322 to the FHIR Event Status Value Set."
* id = "conceptmap-hl70322-to-event-status"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70322-to-event-status"
* version = "1.0"
* name = "ConceptMap_HL70322_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
