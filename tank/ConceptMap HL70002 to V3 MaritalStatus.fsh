Instance: ConceptMapHL70002toV3MaritalStatus
InstanceOf: ConceptMap
Title: "ConceptMap HL70002 to V3 MaritalStatus Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 Table HL70002 to the FHIR V3 MaritalStatus Value Set."
* id = "conceptmap-hl70002-to-v3-maritalstatus"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70002-to-v3-maritalstatus"
* version = "1.0"
* name = "ConceptMap_HL70002_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
