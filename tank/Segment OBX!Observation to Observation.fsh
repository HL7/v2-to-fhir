Instance: SegmentOBX!ObservationtoObservation
InstanceOf: ConceptMap
Title: "Segment OBX!Observation to Observation Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 OBX!Observation Segment to the FHIR Observation Resource representing that segment."
* id = "segment-obx-observation-to-observation"
* url = "http://hl7.org/fhir/v2-tofhir"
* version = "1.0"
* name = "Segment_OBX!Observation_Map"
* status = #active
* experimental = true
* date = "2020-03-01"
