...
* group.element[0].target.comment = "Example: MSH|^~%|LAB^2.16.840.1.113883.3.987.1^ISO|...
Example: MSH|^~%|LAB|…
...
* group.element[1].target.comment = "How do we populate this if MSH-4 is not valued?
...
* group.element[7].target.comment = "Need a gForge to request a MessageHeader.identifier (https://gforge.hl7.org/gf/project/fhir/tracker/?action=TrackerItemEdit&tracker_item_id=20704&start=0)
