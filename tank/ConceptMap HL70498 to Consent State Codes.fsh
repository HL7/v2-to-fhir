Instance: ConceptMapHL70498toConsentStateCodes
InstanceOf: ConceptMap
Title: "ConceptMap HL70498 to Consent State Codes Map"
...
* id = "conceptmap-hl70498-to-consent-state-codes"
* url = "http://hl7.org/fhir/v2-tofhir/conceptmap-hl70498-to-consent-state-codes"
* version = "1.0"
* name = "ConceptMap_HL70498_Map"
* status = #active
* experimental = true
* date = "2020-03-07"
