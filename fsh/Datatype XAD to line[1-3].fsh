Instance: DatatypeXADtoline[1-3]
InstanceOf: ConceptMap
Title: "Datatype XAD to line[1-3] Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 null to the FHIR null."
* id = "datatype-xad-to-line1-3"
* url = "http://hl7.org/fhir/v2-tofhir/datatype-xad-to-line1-3"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Datatype XAD to line[1-3].fsh"
...
* group.element[0].target.dependsOn[0].value = "SAD[AddressLines]"
...
* group.element[11].target.dependsOn[0].value = "DR"
