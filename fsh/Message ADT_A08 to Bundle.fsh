...
* group.element[3].code = #ADT_A08.MSH
...
* group.element[4].code = #ADT_A08.SFT
...
* group.element[5].code = #ADT_A08.EVN
...
* group.element[6].code = #ADT_A08.PID
...
* group.element[7].code = #ADT_A08.PD1
...
* group.element[8].code = #ADT_A08:follow:PID.ARV
...
* group.element[10].code = #ADT_A08:follow:PID.ROL
...
* group.element[12].code = #ADT_A08.NEXT_OF_KIN.NK1
