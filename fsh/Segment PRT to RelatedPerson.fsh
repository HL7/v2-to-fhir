...
* url = "http://hl7.org/fhir/v2-tofhir/segment-prt-to-relatedperson"
* version = "1.0"
...
* group.element[1].display = "Begin Date/Time (arrival time)"
...
* group.element[2].display = "End Date/Time (departure time)"
...
* group.element[3].target.code = #address
...
* group.element[4].display = "Telecommunication Address"
* group.element[4].target.equivalence = #equivalent
* group.element[4].target.code = #telecom
...
* group.element[5].target.dependsOn[0].value = "PLN[Location]"
