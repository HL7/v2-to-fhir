...
* url = "http://hl7.org/fhir/v2-tofhir/datatype-xcn-to-practitionerrole"
* version = "1.0"
...
* group.element[0].target.code = #practitioner(Practitioner.identifier.value)
...
* group.element[0].target.display = "practitioner(Practitioner.identifier.value)"
...
* group.element[7].target.code = #practitioner(Practitioner.identifier.#ext-assigningAuthority#)
* group.element[7].target.display = "practitioner(Practitioner.identifier.#ext-assigningAuthority#)"
...
* group.element[8].target.code = #practitioner(Practitioner.name.use)
...
* group.element[8].target.display = "practitioner(Practitioner.name.use)"
...
* group.element[9].target.code = #practitioner(Practitioner.identifier.type.coding.code)
...
* group.element[9].target.display = "practitioner(Practitioner.identifier.type.coding.code)"
...
* group.element[10].target.code = #practitioner(Practitioner.name.period)
...
* group.element[10].target.display = "practitioner(Practitioner.name.period)"
...
* group.element[12].target.code = #practitioner(Practitioner.name.period.start)
...
* group.element[12].target.display = "practitioner(Practitioner.name.period.start)"
...
* group.element[13].target.code = #practitioner(Practitioner.name.period.end)
...
* group.element[13].target.display = "practitioner(Practitioner.name.period.end)"
...
* group.element[14].target.code = #practitioner(Practitioner.name.suffix)
...
* group.element[14].target.display = "practitioner(Practitioner.name.suffix)"
