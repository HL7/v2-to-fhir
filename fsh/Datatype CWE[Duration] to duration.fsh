...
* id = "datatype-cweduration-to-duration"
* url = "http://hl7.org/fhir/v2-tofhir/datatype-cweduration-to-duration"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Datatype CWE[Duration] to duration.fsh"
