Instance: DatatypeDTtodateTime
InstanceOf: ConceptMap
Title: "Datatype DT to dateTime Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 null to the FHIR null."
* id = "datatype-dt-to-datetime"
* url = "http://hl7.org/fhir/v2-tofhir/datatype-dt-to-datetime"
* version = "1.0"
* name = "Datatype_DT_Map"
* status = #active
* experimental = true
* date = "2020-07-30"
...
* extension[0].extension[1].valueString = "Datatype DT to dateTime.fsh"
* extension[0].extension[2].url = "url"
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1S2DwlTV1eenc9v38w7AB33YZkbSY5-QKEFQd2GGo3uM/edit#gid=0"
* group.element[0].code = #DT.(p1)(1-4)
...
* group.element[1].code = #DT.(p1)(5-6)
...
* group.element[2].code = #DT.(p1)(5-6)
...
* group.element[3].code = #DT.(p1)(7-8)
...
* group.element[4].code = #DT.(p1)(7-8)
