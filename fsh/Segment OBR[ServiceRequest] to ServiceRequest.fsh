...
* extension[0].extension[1].valueString = "Segment OBR[ServiceRequest] to ServiceRequest.fsh"
...
* group.element[0].target.code = #ServiceRequest.intent
* group.element[0].target.display = "ServiceRequest.intent"
...
* group.element[1].target.code = #ServiceRequest.identifier
...
* group.element[1].target.display = "ServiceRequest.identifier"
...
* group.element[2].target.code = #ServiceRequest.identifier.type.coding.code
...
* group.element[2].target.display = "ServiceRequest.identifier.type.coding.code"
...
* group.element[3].target.code = #ServiceRequest.identifier.type.coding.system
...
* group.element[3].target.display = "ServiceRequest.identifier.type.coding.system"
...
* group.element[4].target.code = #ServiceRequest.identifier
...
* group.element[4].target.display = "ServiceRequest.identifier"
...
* group.element[5].target.code = #ServiceRequest.identifier.type.coding.code
...
* group.element[6].target.code = #ServiceRequest.identifier.type.coding.system
...
* group.element[6].target.display = "ServiceRequest.identifier.type.coding.system"
...
* group.element[7].target.code = #ServiceRequest.code
...
* group.element[7].target.display = "ServiceRequest.code"
...
* group.element[8].target.code = #ServiceRequest.priority
...
* group.element[8].target.display = "ServiceRequest.priority"
...
* group.element[9].target.code = #ServiceRequest.occurrenceDateTime
...
* group.element[9].target.display = "ServiceRequest.occurrenceDateTime"
...
* group.element[10].target.code = #ServiceRequest.specimen[1](Specimen.collection.quantity)
...
* group.element[10].target.display = "ServiceRequest.specimen[1](Specimen.collection.quantity)"
...
* group.element[11].target.code = #ServiceRequest.specimen[1](Specimen.collection.collector(Practitioner))
...
* group.element[11].target.display = "ServiceRequest.specimen[1](Specimen.collection.collector(Practitioner))"
* group.element[11].target.dependsOn[0].property = "data-type-map"
* group.element[11].target.dependsOn[0].value = "XCN"
...
* group.element[12].target.display = "ServiceRequest.intent"
...
* group.element[13].target.code = #ServiceRequest.intent
* group.element[13].target.display = "ServiceRequest.intent"
...
* group.element[14].target.code = #ServiceRequest.specimen[1](Specimen.receivedTime)
...
* group.element[14].target.display = "ServiceRequest.specimen[1](Specimen.receivedTime)"
* group.element[14].target.dependsOn[0].property = "data-type-map"
* group.element[14].target.dependsOn[0].value = "TS"
...
* group.element[15].target.code = #ServiceRequest.specimen[1](Specimen)
...
* group.element[15].target.display = "ServiceRequest.specimen[1](Specimen)"
* group.element[15].target.dependsOn[0].property = "data-type-map"
* group.element[15].target.dependsOn[0].value = "CM[SpecimenSource]"
...
* group.element[16].target.code = #ServiceRequest.requester(Practitioner)
...
* group.element[16].target.display = "ServiceRequest.requester(Practitioner)"
* group.element[16].target.dependsOn[0].property = "data-type-map"
* group.element[16].target.dependsOn[0].value = "XCN"
...
* group.element[17].target.code = #ServiceRequest.quantity
...
* group.element[17].target.display = "ServiceRequest.quantity"
...
* group.element[18].target.code = #ServiceRequest.basedOn.identifier
* group.element[18].target.display = "ServiceRequest.basedOn.identifier"
...
* group.element[19].target.code = #ServiceRequest.basedOn.type
...
* group.element[20].target.code = #ServiceRequest.basedOn.identifier
* group.element[20].target.display = "ServiceRequest.basedOn.identifier"
...
* group.element[21].target.code = #ServiceRequest.basedOn.type
* group.element[21].target.display = "ServiceRequest.basedOn.type"
...
* group.element[22].target.code = #ServiceRequest.reasonCode
...
* group.element[22].target.display = "ServiceRequest.reasonCode"
...
* group.element[23].target.code = #SpecimenRequest.specimen[1](Specimen.note)
...
* group.element[23].target.display = "SpecimenRequest.specimen[1](Specimen.note)"
...
* group.element[24].target.code = #ServiceRequest.orderDetail[1]??
...
* group.element[24].target.display = "ServiceRequest.orderDetail[1]??"
...
* group.element[25].target.code = #ServiceRequest.orderDetail[2]??
...
* group.element[25].target.display = "ServiceRequest.orderDetail[2]??"
...
* group.element[26].target.code = #ServiceRequest.identifier
...
* group.element[26].target.display = "ServiceRequest.identifier"
...
* group.element[27].target.code = #ServiceRequest.identifier.type.coding.code
...
* group.element[27].target.display = "ServiceRequest.identifier.type.coding.code"
...
* group.element[28].target.code = #ServiceRequest.identifier.type.coding.system
...
* group.element[28].target.display = "ServiceRequest.identifier.type.coding.system"
