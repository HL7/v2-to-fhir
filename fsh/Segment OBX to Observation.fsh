...
* group.element[14].target.code = #valueQuantity
...
* group.element[14].target.display = "valueQuantity"
...
* group.element[16].target.code = #valueRange.low
...
* group.element[16].target.display = "valueRange.low"
...
* group.element[17].target.code = #valueRange.high
...
* group.element[17].target.display = "valueRange.high"
...
* group.element[18].target.code = #valueRatio.numerator
...
* group.element[18].target.display = "valueRatio.numerator"
...
* group.element[19].target.code = #valueRatio.denominator
...
* group.element[19].target.display = "valueRatio.denominator"
...
* group.element[20].target.code = #referenceRange.text
...
* group.element[20].target.display = "referenceRange.text"
...
* group.element[21].target.code = #interpretation
...
* group.element[21].target.display = "interpretation"
...
* group.element[22].target.code = #status
...
* group.element[22].target.display = "status"
...
* group.element[23].target.code = #effectiveDateTime
...
* group.element[23].target.display = "effectiveDateTime"
...
* group.element[24].target.code = #performer[1](PractitionerRole.practitioner(Practitioner))
...
* group.element[24].target.display = "performer[1](PractitionerRole.practitioner(Practitioner))"
...
* group.element[25].target.code = #performer[1](PractitionerRole.code)
...
* group.element[25].target.display = "performer[1](PractitionerRole.code)"
...
* group.element[26].target.code = #performer[1](PractitionerRole.system)
...
* group.element[26].target.display = "performer[1](PractitionerRole.system)"
