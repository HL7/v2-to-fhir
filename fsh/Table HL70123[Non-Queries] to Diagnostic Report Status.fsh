Instance: TableHL70123toDiagnosticReportStatus
...
* id = "table-hl70123non-queries-to-diagnostic-report-status"
* url = "http://hl7.org/fhir/v2-tofhir/table-hl70123non-queries-to-diagnostic-report-status"
* version = "1.0"
* name = "Table_HL70123_Map"
* status = #active
* experimental = true
* date = "2020-07-29"
...
* extension[0].extension[1].valueString = "Table HL70123[Non-Queries] to Diagnostic Report Status.fsh"
