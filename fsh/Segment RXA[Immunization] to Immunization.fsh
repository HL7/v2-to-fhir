...
* extension[0].extension[1].valueString = "Segment RXA[Immunization] to Immunization.fsh"
...
* group.element[2].target.code = #Immunization.doseQuantity.value
...
* group.element[2].target.display = "Immunization.doseQuantity.value"
...
* group.element[3].target.code = #Immunization.doseQuantity
...
* group.element[3].target.display = "Immunization.doseQuantity"
...
* group.element[5].target.display = "Immunization.performer.function.coding.code"
...
* group.element[6].target.display = "Immunization.performer.function.coding.system"
...
* group.element[13].target.display = "Immunization.status"
* group.element[13].target.dependsOn[0].property = "value"
* group.element[13].target.dependsOn[0].value = "\"entered-in-error\""
* group.element[13].target.product[0].property = "antlr"
* group.element[13].target.product[0].value = "IF RXA-21 EQUALS \"D\""
...
* group.element[14].target.extension[0].extension[0].valueCode = #"instant"
...
* group.element[14].target.dependsOn[0].value = "DTM[instant]"
...
* group.element[15].target.extension[0].extension[0].valueCode = #"id"
...
* group.element[15].target.display = "Immunization.meta.versionId"
* group.element[15].target.dependsOn[0].property = "value"
* group.element[15].target.dependsOn[0].value = "next"
...
* group.element[16].target.dependsOn[0].value = "PL"
