...
* extension[0].extension[1].valueString = "Datatype HD[Organization] to Organization.fsh"
* extension[0].extension[2].url = "url"
* extension[0].extension[2].valueUri = "https://docs.google.com/spreadsheets/d/1aTLS5pJ1g9zxO6wXuVg-HyB45QOLtMqY7L0QamTnHSg/edit#gid=0"
...
* group.element[2].target.dependsOn[0].value = "ID[CodeableConcept]"
...
* group.element[3].target.display = "Organization.identifier[2].system"
...
* group.element[3].target.dependsOn[1].value = "UniversalIDType"
