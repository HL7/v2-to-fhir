...
Instance: DatatypeHDtoMessageHeader.destination
...
* url = "http://hl7.org/fhir/v2-tofhir/datatype-hd-to-messageheader.destination"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Datatype HD to MessageHeader.destination.fsh"
