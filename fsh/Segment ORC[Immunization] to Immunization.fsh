...
* extension[0].extension[1].valueString = "Segment ORC[Immunization] to Immunization.fsh"
...
* group.element[2].target.display = "Immunization.identifier[1].type.coding.system"
...
* group.element[4].target.display = "Immunization.identifier[2].type.coding.code"
...
* group.element[5].target.display = "Immunization.identifier[2].type.coding.system"
...
* group.element[8].target.display = "Immunization.performer.function.coding.code"
* group.element[8].target.dependsOn[0].property = "value"
* group.element[8].target.dependsOn[0].value = "\"OP\""
...
* group.element[9].target.display = "Immunization.performer.function.coding.system"
* group.element[9].target.dependsOn[0].property = "value"
* group.element[9].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0443\""
