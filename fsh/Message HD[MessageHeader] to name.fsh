Instance: MessageHDtoname
InstanceOf: ConceptMap
Title: "Message HD to name Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 HD Message to the FHIR Message Bundle."
* id = "message-hdmessageheader-to-name"
* url = "http://hl7.org/fhir/v2-tofhir/message-hdmessageheader-to-name"
* version = "1.0"
* name = "Message_HD_Map"
* status = #active
* experimental = true
...
* extension[0].extension[1].valueString = "Message HD[MessageHeader] to name.fsh"
...
* group.element[3].target.product[0].value = "IF HD-3 NOT IN (\"ISO\", \"UUID\")"
