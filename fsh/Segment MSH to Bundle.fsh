...
* url = "http://hl7.org/fhir/v2-tofhir/segment-msh-to-bundle"
* version = "1.0"
...
* group.element[2].target.code = #identifier
...
* group.element[2].target.display = "identifier"
...
* group.element[3].target.dependsOn[0].value = "\"message\""
