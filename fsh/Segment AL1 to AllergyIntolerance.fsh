...
* group.element[5].target.product[1].value = "AND If severity was used equivalent to reaction severity in FHIR"
...
* group.element[7].target.code = #reaction.manifestation.text
...
* group.element[7].target.display = "reaction.manifestation.text"
