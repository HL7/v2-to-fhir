...
* id = "segment-al1allergeryintolerance-to-allergyintolerance"
* url = "http://hl7.org/fhir/v2-tofhir/segment-al1allergeryintolerance-to-allergyintolerance"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Segment AL1[AllergeryIntolerance] to AllergyIntolerance.fsh"
...
* group.element[0].target.dependsOn[1].value = "Allergy"
...
* group.element[3].target.product[1].value = "AND If severity was used equivalent to severity in FHIR"
...
* group.element[4].target.code = #WARNING
* group.element[4].target.display = "WARNING"
* group.element[4].target.product[0].property = "antlr"
* group.element[4].target.product[0].value = "IF AL1-4 NOT IN HL70128"
* group.element[4].target.product[1].property = "narrative"
* group.element[4].target.product[1].value = "AND If severity was used equivalent to severity in FHIR"
...
* group.element[5].target.code = #AllergyIntolerance.reaction.severity.extension-data-absent-reason
...
* group.element[5].target.display = "AllergyIntolerance.reaction.severity.extension-data-absent-reason"
...
* group.element[5].target.product[0].value = "If AL1-4 EQUALS 'U'"
* group.element[5].target.product[1].property = "narrative"
* group.element[5].target.product[1].value = "AND If severity was used equivalent to severity in FHIR"
* group.element[6].code = #AL1-4
...
* group.element[6].target.code = #AllergyIntolerance.criticality
...
* group.element[6].target.display = "AllergyIntolerance.criticality"
* group.element[6].target.dependsOn[0].property = "data-type-map"
* group.element[6].target.dependsOn[0].value = "CWE[code]"
* group.element[6].target.dependsOn[1].property = "vocabulary-map"
* group.element[6].target.dependsOn[1].value = "AllergyCriticality"
* group.element[6].target.product[0].property = "narrative"
* group.element[6].target.product[0].value = "If severity was used equivalent to criticality"
* group.element[7].code = #AL1-5
...
* group.element[7].display = "Allergy Reaction Code"
* group.element[7].target.equivalence = #equivalent
* group.element[7].target.code = #AllergyIntolerance.reaction.manifestation.text
...
* group.element[8].display = "Identification Date"
* group.element[8].target.equivalence = #equivalent
* group.element[8].target.code = #AllergyIntolerance.onsetDateTime
...
* group.element[8].target.display = "AllergyIntolerance.onsetDateTime"
