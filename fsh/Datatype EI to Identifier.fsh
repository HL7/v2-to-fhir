// HL7 Data Type - FHIR R4_ EI[Identifier] - Sheet1.csv
...
* id = "datatype-ei-to-identifier"
* url = "http://hl7.org/fhir/uv/v2mappings/datatype-ei-to-identifier"
* version = "1.0"
* name = "DatatypeEItoIdentifier"
* status = #active
* experimental = true
* date = "2020-08-12"
...
* extension[0].extension[1].valueString = "Datatype EI to Identifier.fsh"
