...
* extension[0].extension[1].valueString = "Segment ORC[Provenance] to Provenance.fsh"
...
* group.element[0].target.display = "Provenance.activity.coding.code"
...
* group.element[1].target.display = "Provenance.activity.coding.system"
...
* group.element[2].target.display = "Provenance.activity.coding.code"
...
* group.element[3].target.display = "Provenance.activity.coding.system"
...
* group.element[4].target.display = "Provenance.activity.coding.code"
* group.element[4].target.dependsOn[0].property = "value"
* group.element[4].target.dependsOn[0].value = "\"DELETE\""
...
* group.element[6].target.dependsOn[0].value = "DTM[instant]"
...
* group.element[9].target.display = "Provenance.agent[1].type.coding.code"
...
* group.element[10].target.display = "Provenance.agent[1].type.coding.system"
...
* group.element[12].target.display = "Provenance.agent[2].type.coding.code"
...
* group.element[13].target.display = "Provenance.agent[2].type.coding.system"
...
* group.element[15].target.display = "Provenance.agent[3].type.coding.code"
...
* group.element[16].target.display = "Provenance.agent[3].type.coding.system"
...
* group.element[18].target.dependsOn[0].value = "XON[Location]"
...
* group.element[20].target.dependsOn[0].value = "XTN"
...
* group.element[21].target.dependsOn[0].value = "XAD"
