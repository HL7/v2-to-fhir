...
* group.element[11].target.dependsOn[0].value = "PV1"
...
* group.element[12].target.dependsOn[0].value = "PV2"
...
* group.element[13].display = "Participation (for Patient Visit)"
* group.element[13].target.equivalence = #equivalent
* group.element[13].target.code = #PractitionerRole[2]
* group.element[13].target.display = "PractitionerRole[2]"
* group.element[13].target.comment = "Incorporate PRT content into the Encounter created from the PV1 segment."
* group.element[13].target.dependsOn[0].property = "segment-map"
* group.element[13].target.dependsOn[0].value = "PRT[PractitionerRole]"
...
* group.element[14].display = "Insurance"
* group.element[14].target.equivalence = #equivalent
* group.element[14].target.code = #Coverage[1]
* group.element[14].target.display = "Coverage[1]"
* group.element[14].target.comment = "Processing of the IN1 segment results in the creation of a new Coverage resource"
* group.element[14].target.dependsOn[0].property = "segment-map"
* group.element[14].target.dependsOn[0].value = "IN1"
...
* group.element[15].display = "Insurance Additional Information"
* group.element[15].target.equivalence = #equivalent
* group.element[15].target.code = #Coverage[1]
* group.element[15].target.display = "Coverage[1]"
* group.element[15].target.comment = "Incorporate IN2 content into the Coverage created from the IN1 segment."
* group.element[15].target.dependsOn[0].property = "segment-map"
* group.element[15].target.dependsOn[0].value = "IN2"
...
* group.element[16].display = "Insurance Additional Information, Certification"
* group.element[16].target.equivalence = #equivalent
* group.element[16].target.code = #Coverage[1]
* group.element[16].target.display = "Coverage[1]"
* group.element[16].target.comment = "Incorporate IN3 content into the Coverage created from the IN1 segment."
* group.element[16].target.dependsOn[0].property = "segment-map"
* group.element[16].target.dependsOn[0].value = "IN3"
...
* group.element[17].target.comment = "Processing of the AL1 segment results in the creation of a new AllergyIntolerance resource"
* group.element[17].target.dependsOn[0].property = "segment-map"
* group.element[17].target.dependsOn[0].value = "AL1"
...
* group.element[18].target.comment = "Processing of each ORC segment results in the creation of a new ServiceRequest resource"
...
* group.element[19].target.code = #Provenance[3]
* group.element[19].target.display = "Provenance[3]"
* group.element[19].target.comment = "Using Provenance is the preferred way, but a local implementation may decide to add extensions to the main resource.  As the use and guidance of Provenance matures we wil revisit this later."
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "ORC[Provenance]"
...
* group.element[20].display = "Participation (for Common Order)"
...
* group.element[20].target.dependsOn[1].value = "ServiceRequest[1].requester.reference=PractitionerRole[3].id"
...
* group.element[21].display = "Timing/Quantity"
...
* group.element[22].display = "Timing/Quantity Order Sequence"
...
* group.element[24].target.dependsOn[0].value = "NTE[Annotation]"
...
* group.element[25].target.code = #PractitionerRole[4]
* group.element[25].target.display = "PractitionerRole[4]"
...
* group.element[25].target.dependsOn[1].value = "ServiceRequest[1].specimen[1](Specimen.collection.collector.reference)=PractitionerRole[4].id"
* group.element[25].target.product[0].property = "antlr"
* group.element[25].target.product[0].value = "IF PRT-4.1 EQUALS \"SC\" AND PRT-4.3 EQUALS \"HL70443\""
...
* group.element[26].target.dependsOn[1].value = "ServiceRequest[1].requester.reference=PractitionerRole[3].id"
...
* group.element[27].display = "Diagnosis"
...
* group.element[27].target.comment = "Processing of the DG1 segment results in the creation of a new Condition resource which is referenced in the ServiceRequest created by the ORC segment"
* group.element[27].target.dependsOn[0].property = "segment-map"
* group.element[27].target.dependsOn[0].value = "DG1"
* group.element[27].target.dependsOn[1].property = "references"
* group.element[27].target.dependsOn[1].value = "ServiceRequest[1].reasonReference.reference=Condition[1].id; Condition[1].subject=Patient[PID]"
...
* group.element[28].target.code = #Observation[1]
* group.element[28].target.display = "Observation[1]"
...
* group.element[28].target.dependsOn[1].value = "ServiceRequest[1].supportingInfo.reference=Observation[1].id; Observation[1].subject.id=Patient[1].id"
...
* group.element[29].target.dependsOn[1].value = "Observation[2].device.reference=Device.id"
...
* group.element[30].target.comment = "Incorporate PRT content into the Observation created from the OBX segment in the same segment group when it represents observation location information."
...
* group.element[31].target.comment = "Incorporate PRT content into the Observation created from the OBX segment in the same segment group when it represents observation practitioner information."
...
* group.element[31].target.dependsOn[1].value = "Observation[2].performer.reference=PractitionerRole[7].id"
* group.element[31].target.product[0].property = "antlr"
* group.element[31].target.product[0].value = "IF PRT-5 VALUED"
* group.element[32].code = #OML_O21.ORDER.OBSERVATION_REQUEST.SPECIMEN.SPM
...
* group.element[32].display = "Specimen"
* group.element[32].target.equivalence = #equivalent
* group.element[32].target.code = #Specimen
* group.element[32].target.display = "Specimen"
* group.element[32].target.dependsOn[0].property = "segment-map"
* group.element[32].target.dependsOn[0].value = "SPM"
* group.element[32].target.dependsOn[1].property = "references"
* group.element[32].target.dependsOn[1].value = "ServiceRequest[1].specimen.reference=Specimen[SPM].id"
