...
* extension[0].extension[1].valueString = "Datatype XON[Organization] to Organization.fsh"
...
* group.element[3].target.display = "Organization.identifier.type.coding.system"
