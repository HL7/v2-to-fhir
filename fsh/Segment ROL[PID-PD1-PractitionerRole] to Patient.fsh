...
* id = "segment-rolpid-pd1-practitionerrole-to-patient"
* url = "http://hl7.org/fhir/v2-tofhir/segment-rolpid-pd1-practitionerrole-to-patient"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Segment ROL[PID-PD1-PractitionerRole] to Patient.fsh"
...
* group.element[1].target.dependsOn[0].value = "Operation"
...
* group.element[3].target.extension[0].extension[0].valueCode = #"Reference(Practioner)"
...
* group.element[6].target.product[0].value = "IF XAD.7 IN (\"N\",\"BDL\",\"F\",\"H\",\"P\",\"BR\",\"V\")"
...
* group.element[7].target.product[0].value = "IF XAD.7 IN (\"M\",\"O\",\"S\",\"SH\",\"TM\")"
...
* group.element[8].target.dependsOn[0].value = "XAD"
* group.element[8].target.product[0].property = "antlr"
* group.element[8].target.product[0].value = "IF XAD.7 IN (\"B\",\"BI\",\"L\")"
...
* group.element[9].target.dependsOn[0].value = "XTN"
...
* group.element[10].target.extension[0].extension[0].valueCode = #"Reference(Location)"
...
* group.element[10].target.dependsOn[0].value = "PL"
...
* group.element[11].target.extension[0].extension[0].valueCode = #"Reference(Organization)"
