...
* group.element[1].target.code = #extension-event-location(Location)
...
* group.element[1].target.display = "extension-event-location(Location)"
...
* group.element[2].target.code = #extension-event-location(Location.address)
...
* group.element[2].target.display = "extension-event-location(Location.address)"
