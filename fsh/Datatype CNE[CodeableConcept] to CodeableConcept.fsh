...
* id = "datatype-cnecodeableconcept-to-codeableconcept"
* url = "http://hl7.org/fhir/v2-tofhir/datatype-cnecodeableconcept-to-codeableconcept"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Datatype CNE[CodeableConcept] to CodeableConcept.fsh"
