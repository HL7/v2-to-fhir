...
* id = "datatype-xcnpractitionerrole-to-practitionerrole"
* url = "http://hl7.org/fhir/v2-tofhir/datatype-xcnpractitionerrole-to-practitionerrole"
* version = "1.0"
...
* group.element[0].target.code = #PractitionerRole.practitioner(Practitioner.identifier.value)
...
* group.element[0].target.display = "PractitionerRole.practitioner(Practitioner.identifier.value)"
...
* group.element[1].target.code = #PractitionerRole.practitioner(Practitioner.name)
* group.element[1].target.display = "PractitionerRole.practitioner(Practitioner.name)"
...
* group.element[2].target.code = #PractitionerRole.practitioner(Practitioner.name.given)
...
* group.element[2].target.display = "PractitionerRole.practitioner(Practitioner.name.given)"
...
* group.element[3].target.code = #PractitionerRole.practitioner(Practitioner.name.given)
...
* group.element[3].target.display = "PractitionerRole.practitioner(Practitioner.name.given)"
...
* group.element[4].target.code = #PractitionerRole.practitioner(Practitioner.name.suffix)
...
* group.element[4].target.display = "PractitionerRole.practitioner(Practitioner.name.suffix)"
...
* group.element[5].target.code = #PractitionerRole.practitioner(Practitioner.name.prefix)
...
* group.element[5].target.display = "PractitionerRole.practitioner(Practitioner.name.prefix)"
...
* group.element[6].target.code = #PractitionerRole.practitioner(Practitioner.name.suffix)
...
* group.element[6].target.display = "PractitionerRole.practitioner(Practitioner.name.suffix)"
...
* group.element[7].target.code = #PractitionerRole.practitioner(Practitioner.identifier.#ext-assigningAuthority#)
* group.element[7].target.display = "PractitionerRole.practitioner(Practitioner.identifier.#ext-assigningAuthority#)"
* group.element[7].target.dependsOn[0].property = "data-type-map"
* group.element[7].target.dependsOn[0].value = "HD[AssigningAuthority]"
...
* group.element[8].target.code = #PractitionerRole.practitioner(Practitioner.name.use)
...
* group.element[8].target.display = "PractitionerRole.practitioner(Practitioner.name.use)"
* group.element[8].target.dependsOn[0].property = "vocabulary-map"
* group.element[8].target.dependsOn[0].value = "Name Type"
...
* group.element[9].target.code = #PractitionerRole.practitioner(Practitioner.identifier.type.coding.code)
...
* group.element[9].target.display = "PractitionerRole.practitioner(Practitioner.identifier.type.coding.code)"
* group.element[9].target.dependsOn[0].property = "vocabulary-map"
* group.element[9].target.dependsOn[0].value = "ID Type"
...
* group.element[10].target.code = #PractitionerRole.practitioner(Practitioner.name.period)
...
* group.element[10].target.display = "PractitionerRole.practitioner(Practitioner.name.period)"
* group.element[10].target.dependsOn[0].property = "data-type-map"
* group.element[10].target.dependsOn[0].value = "DR"
* group.element[10].target.product[0].property = "antlr"
* group.element[10].target.product[0].value = "IF XCN.19 NOT VALUED XCN.20 NOT VALUED"
...
* group.element[11].target.code = #PractitionerRole.practitioner(Practitioner.name.family.extension-humanname-assembly-order)
...
* group.element[11].target.display = "PractitionerRole.practitioner(Practitioner.name.family.extension-humanname-assembly-order)"
...
* group.element[12].target.code = #PractitionerRole.practitioner(Practitioner.name.period.start)
...
* group.element[12].target.display = "PractitionerRole.practitioner(Practitioner.name.period.start)"
...
* group.element[13].target.code = #PractitionerRole.practitioner(Practitioner.name.period.end)
...
* group.element[13].target.display = "PractitionerRole.practitioner(Practitioner.name.period.end)"
...
* group.element[14].target.code = #PractitionerRole.practitioner(Practitioner.name.suffix)
...
* group.element[14].target.display = "PractitionerRole.practitioner(Practitioner.name.suffix)"
