...
* url = "http://hl7.org/fhir/v2-tofhir/segment-evn-to-provenance"
* version = "1.0"
...
* group.element[0].display = "Recorded Date/Time"
...
* group.element[1].display = "Event Reason Code"
* group.element[1].target.equivalence = #equivalent
* group.element[1].target.code = #reason
...
* group.element[1].target.display = "reason"
...
* group.element[1].target.dependsOn[1].value = "EventReason"
* group.element[1].target.product[0].property = "antlr"
* group.element[1].target.product[0].value = "IF ENV-4 NOT \"U\""
...
* group.element[2].target.code = #reason.extension-data-absent-reason
...
* group.element[2].target.display = "reason.extension-data-absent-reason"
* group.element[2].target.dependsOn[0].property = "value"
* group.element[2].target.dependsOn[0].value = "\"unknown\""
* group.element[2].target.product[0].property = "antlr"
* group.element[2].target.product[0].value = "IF EVN-4 IS \"U\""
* group.element[3].code = #EVN-5
...
* group.element[3].display = "Operator ID"
* group.element[3].target.equivalence = #equivalent
* group.element[3].target.code = #agent.who(Practitioner)
...
* group.element[3].target.display = "agent.who(Practitioner)"
...
* group.element[3].target.dependsOn[1].value = "OperatorID"
* group.element[4].code = #EVN-6
...
* group.element[4].display = "Event Occurred"
* group.element[4].target.equivalence = #equivalent
* group.element[4].target.code = #occurredDateTime
...
* group.element[4].target.display = "occurredDateTime"
* group.element[5].code = #EVN-7
...
* group.element[5].display = "Event Facility"
...
* group.element[5].target.extension[0].extension[0].valueInteger = 0
...
* group.element[5].target.dependsOn[0].value = "HD[Location]"
