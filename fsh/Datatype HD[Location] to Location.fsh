...
* id = "datatype-hdlocation-to-location"
* url = "http://hl7.org/fhir/v2-tofhir/datatype-hdlocation-to-location"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Datatype HD[Location] to Location.fsh"
...
* group.element[1].target.product[0].value = "IF HD.3 IN (\"ISO\", \"UUID\")"
...
* group.element[2].target.code = #Location.physicalType.coding.code
...
* group.element[2].target.display = "Location.physicalType.coding.code"
* group.element[2].target.dependsOn[0].property = "value"
* group.element[2].target.dependsOn[0].value = "\"si\""
...
* group.element[3].target.code = #Location.physicalType.coding.system
...
* group.element[3].target.display = "Location.physicalType.coding.system"
