...
* group.element[8].target.code = #identifier[3].type.coding.code
...
* group.element[8].target.display = "identifier[3].type.coding.code"
...
* group.element[9].target.code = #identifier[3].type.coding.system
...
* group.element[9].target.display = "identifier[3].type.coding.system"
...
* group.element[10].target.code = #effectiveDateTime
...
* group.element[10].target.display = "effectiveDateTime"
...
* group.element[11].target.code = #extension-event-statusReason
...
* group.element[11].target.display = "extension-event-statusReason"
