...
* extension[0].extension[1].valueString = "Datatype XCN[RelatedPerson] to RelatedPerson.fsh"
...
* group.element[7].target.code = #RelatedPerson.name.use
...
* group.element[7].target.display = "RelatedPerson.name.use"
...
* group.element[8].target.code = #RelatedPerson.identifier.type.coding.code
...
* group.element[8].target.display = "RelatedPerson.identifier.type.coding.code"
...
* group.element[9].target.code = #RelatedPerson.identifier.#ext-assigningFacility#)
...
* group.element[9].target.display = "RelatedPerson.identifier.#ext-assigningFacility#)"
...
* group.element[10].target.code = #RelatedPerson.name.period
...
* group.element[10].target.display = "RelatedPerson.name.period"
...
* group.element[12].target.code = #RelatedPerson.name.period.start
...
* group.element[12].target.display = "RelatedPerson.name.period.start"
...
* group.element[13].target.code = #RelatedPerson.name.period.end
...
* group.element[13].target.display = "RelatedPerson.name.period.end"
...
* group.element[14].target.code = #RelatedPerson.name.suffix
...
* group.element[14].target.display = "RelatedPerson.name.suffix"
