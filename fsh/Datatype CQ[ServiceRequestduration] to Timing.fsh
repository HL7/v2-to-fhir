Instance: DatatypeCQtoTiming
InstanceOf: ConceptMap
Title: "Datatype CQ to Timing Map"
* description = "This ConceptMap represents the mapping from the HL7 V2 null to the FHIR null."
* id = "datatype-cqservicerequestduration-to-timing"
* url = "http://hl7.org/fhir/v2-tofhir/datatype-cqservicerequestduration-to-timing"
* version = "1.0"
...
* extension[0].extension[1].valueString = "Datatype CQ[ServiceRequestduration] to Timing.fsh"
...
* group.element[0].target.code = #Timing.repeat.duration
...
* group.element[0].target.display = "Timing.repeat.duration"
...
* group.element[1].target.code = #Timing.repeat.durationUnit
...
* group.element[1].target.display = "Timing.repeat.durationUnit"
* group.element[1].target.dependsOn[0].property = "data-type-map"
* group.element[1].target.dependsOn[0].value = "CWE[duration]"
