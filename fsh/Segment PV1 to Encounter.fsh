...
* group.element[2].target.dependsOn[0].value = "PL"
...
* group.element[3].target.display = "Encounter.location[1].status"
...
* group.element[4].target.display = "Encounter.location[1].status"
...
* group.element[6].target.dependsOn[0].value = "CX"
...
* group.element[7].target.dependsOn[0].value = "PL"
...
* group.element[8].target.display = "Encounter.location[2].status"
...
* group.element[10].target.display = "Encounter.participant[1].type.coding.code"
...
* group.element[11].target.display = "Encounter.participant[1].type.coding.system"
...
* group.element[12].target.display = "Encounter.participant[1].type.coding.display"
...
* group.element[14].target.display = "Encounter.participant[2].type.coding.code"
...
* group.element[15].target.display = "Encounter.participant[2].type.coding.system"
...
* group.element[16].target.display = "Encounter.participant[2].type.text"
...
* group.element[18].target.display = "Encounter.participant[3].type.coding.code"
...
* group.element[19].target.display = "Encounter.participant[3].type.coding.system"
...
* group.element[20].target.display = "Encounter.participant[3].type.text"
...
* group.element[25].target.extension[0].extension[0].valueCode = #"Reference(Practitioner)"
...
* group.element[25].target.dependsOn[0].value = "XCN[Practitioner]"
...
* group.element[26].target.display = "Encounter.participant[4].type.coding.code"
* group.element[26].target.dependsOn[0].property = "value"
* group.element[26].target.dependsOn[0].value = "\"ADM\""
...
* group.element[27].target.display = "Encounter.participant[4].type.coding.system"
* group.element[27].target.dependsOn[0].property = "value"
* group.element[27].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v3-ParticipationType\""
...
* group.element[28].extension[0].extension[0].valueCode = #"XCN"
...
* group.element[28].target.display = "Encounter.participant[4].type.text"
* group.element[28].target.dependsOn[0].property = "value"
* group.element[28].target.dependsOn[0].value = "\"admitter\""
...
* group.element[29].target.dependsOn[0].value = "CX"
...
* group.element[30].target.code = #Encounter.identifier[1].type.coding.code
...
* group.element[30].target.display = "Encounter.identifier[1].type.coding.code"
* group.element[30].target.dependsOn[0].property = "value"
* group.element[30].target.dependsOn[0].value = "\"VN\""
...
* group.element[31].target.display = "Encounter.identifier[1].type.coding.system"
* group.element[31].target.dependsOn[0].property = "value"
* group.element[31].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0203\""
...
* group.element[32].extension[0].extension[0].valueCode = #"CX"
...
* group.element[32].target.display = "Encounter.identifier[1].type.text"
* group.element[32].target.dependsOn[0].property = "value"
* group.element[32].target.dependsOn[0].value = "\"visit number\""
...
* group.element[34].extension[0].extension[0].valueCode = #"DLD"
...
* group.element[34].target.extension[0].extension[0].valueCode = #"Reference(Location)"
...
* group.element[34].target.dependsOn[0].value = "DLD"
...
* group.element[36].target.code = #Encounter.location[3].location(Location)
...
* group.element[36].target.extension[0].extension[0].valueCode = #"Reference(Location)"
...
* group.element[36].target.display = "Encounter.location[3].location(Location)"
* group.element[36].target.dependsOn[0].property = "data-type-map"
* group.element[36].target.dependsOn[0].value = "PL"
* group.element[37].code = #PV1-42
...
* group.element[37].display = "Pending Location"
* group.element[37].target.equivalence = #equivalent
* group.element[37].target.code = #Encounter.location[3].status
* group.element[37].target.display = "Encounter.location[3].status"
* group.element[37].target.dependsOn[0].property = "value"
* group.element[37].target.dependsOn[0].value = "\"planned\""
...
* group.element[38].target.code = #Encounter.location[4].location(Location)
...
* group.element[39].extension[0].extension[0].valueCode = #"PL"
...
* group.element[39].display = "Prior Temporary Location"
* group.element[39].target.equivalence = #equivalent
* group.element[39].target.code = #Encounter.location[4].status
* group.element[39].target.display = "Encounter.location[4].status"
* group.element[39].target.dependsOn[0].property = "value"
* group.element[39].target.dependsOn[0].value = "\"completed\""
* group.element[40].code = #PV1-44
...
* group.element[40].display = "Admit Date/Time"
* group.element[40].target.equivalence = #equivalent
* group.element[40].target.code = #Encounter.period.start
...
* group.element[40].target.display = "Encounter.period.start"
* group.element[40].target.dependsOn[0].property = "data-type-map"
* group.element[40].target.dependsOn[0].value = "DTM"
...
* group.element[41].target.code = #Encounter.period.end
...
* group.element[41].target.display = "Encounter.period.end"
* group.element[41].target.dependsOn[0].property = "data-type-map"
* group.element[41].target.dependsOn[0].value = "DTM"
* group.element[42].code = #PV1-45
...
* group.element[42].display = "Discharge Date/Time"
* group.element[42].target.equivalence = #equivalent
* group.element[42].target.code = #Encounter.status
...
* group.element[42].target.display = "= \"finished\""
* group.element[42].target.product[0].property = "antlr"
* group.element[42].target.product[0].value = "IF PV1-45 VALUED"
* group.element[43].code = #PV1-50
...
* group.element[43].extension[0].extension[0].valueCode = #"CX"
...
* group.element[43].display = "Alternate Visit ID"
* group.element[43].target.equivalence = #equivalent
* group.element[43].target.code = #Encounter.identifier[2]
...
* group.element[43].target.display = "Encounter.identifier[2]"
* group.element[43].target.dependsOn[0].property = "data-type-map"
* group.element[43].target.dependsOn[0].value = "CX"
...
* group.element[44].target.code = #Encounter.participant[5].individual(Practitioner)
...
* group.element[44].target.extension[0].extension[0].valueCode = #"Reference(Practitioner)"
...
* group.element[44].target.display = "Encounter.participant[5].individual(Practitioner)"
...
* group.element[45].target.code = #Encounter.participant[5].type.coding.code
...
* group.element[45].target.display = "= \"PART\""
* group.element[45].target.dependsOn[0].property = "value"
* group.element[45].target.dependsOn[0].value = "\"PART\""
...
* group.element[46].target.code = #Encounter.participant[5].type.coding.system
...
* group.element[46].target.display = "Encounter.participant[5].type.coding.system"
* group.element[46].target.dependsOn[0].property = "value"
* group.element[46].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v3-ParticipationType\""
...
* group.element[47].target.code = #Encounter.participant[5].type.text
...
* group.element[47].target.display = "= \"Participation\""
* group.element[47].target.dependsOn[0].property = "value"
* group.element[47].target.dependsOn[0].value = "\"Participation\""
* group.element[48].code = #PV1-54
* group.element[48].extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[48].display = "Service Episode Identifier"
* group.element[48].target.equivalence = #equivalent
* group.element[48].target.code = #Encounter.episodeOfCare(EpisodeOfCare.identifier)
* group.element[48].target.extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[48].target.display = "Encounter.episodeOfCare(EpisodeOfCare.identifier)"
* group.element[48].target.dependsOn[0].property = "data-type-map"
* group.element[48].target.dependsOn[0].value = "CX"
