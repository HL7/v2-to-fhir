...
* group.element[22].target.code = #hospitalization.reAdmission
...
* group.element[22].target.display = "hospitalization.reAdmission"
...
* group.element[22].target.dependsOn[1].value = "ReadmissionIndicator"
...
* group.element[23].target.code = #hospitalization.admitSource
...
* group.element[24].display = "Admitting Doctor"
* group.element[24].target.equivalence = #equivalent
* group.element[24].target.code = #participant[4].individual(Practitioner)
...
* group.element[24].target.display = "participant[4].individual(Practitioner)"
...
* group.element[25].target.code = #participant[4].type.coding.code
...
* group.element[25].target.display = "participant[4].type.coding.code"
* group.element[25].target.dependsOn[0].property = "value"
* group.element[25].target.dependsOn[0].value = "\"ADM\""
...
* group.element[26].target.code = #participant[4].type.coding.system
...
* group.element[26].target.display = "participant[4].type.coding.system"
* group.element[26].target.dependsOn[0].property = "value"
* group.element[26].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v3-ParticipationType\""
...
* group.element[27].target.code = #participant[4].type.text
...
* group.element[27].target.extension[0].extension[0].valueCode = #"string"
...
* group.element[27].target.display = "participant[4].type.text"
* group.element[27].target.dependsOn[0].property = "value"
* group.element[27].target.dependsOn[0].value = "\"admitter\""
* group.element[28].code = #PV1-19
...
* group.element[28].display = "Visit Number"
* group.element[28].target.equivalence = #equivalent
* group.element[28].target.code = #identifier[1]
...
* group.element[28].target.display = "identifier[1]"
* group.element[28].target.dependsOn[0].property = "data-type-map"
* group.element[28].target.dependsOn[0].value = "CX[Identifier]"
...
* group.element[29].target.code = #identifier[1].type.coding.code
...
* group.element[29].target.display = "identifier[1].type.coding.code"
* group.element[29].target.dependsOn[0].property = "value"
* group.element[29].target.dependsOn[0].value = "\"VN\""
...
* group.element[30].target.code = #identifier[1].type.coding.system
...
* group.element[30].target.display = "identifier[1].type.coding.system"
* group.element[30].target.dependsOn[0].property = "value"
* group.element[30].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v2-0203\""
...
* group.element[31].extension[0].extension[0].valueCode = #"CX"
...
* group.element[31].target.code = #identifier[1].type.text
...
* group.element[31].target.display = "identifier[1].type.text"
* group.element[31].target.dependsOn[0].property = "value"
* group.element[31].target.dependsOn[0].value = "\"visit number\""
* group.element[32].code = #PV1-36
...
* group.element[32].display = "Discharge Disposition"
* group.element[32].target.equivalence = #equivalent
* group.element[32].target.code = #hospitalization.dischargeDisposition
...
* group.element[33].extension[0].extension[0].valueCode = #"DLD"
...
* group.element[33].display = "Discharged to Location"
* group.element[33].target.equivalence = #equivalent
* group.element[33].target.code = #hospitalization.destination(Location)
...
* group.element[33].target.extension[0].extension[0].valueCode = #"Reference(Location)"
...
* group.element[33].target.display = "hospitalization.destination(Location)"
* group.element[33].target.dependsOn[0].property = "data-type-map"
* group.element[33].target.dependsOn[0].value = "DLD[Location]"
* group.element[34].code = #PV1-38
...
* group.element[34].display = "Diet Type"
* group.element[34].target.equivalence = #equivalent
* group.element[34].target.code = #hospitalization.dietPreference
...
* group.element[35].extension[0].extension[0].valueCode = #"PL"
...
* group.element[35].display = "Pending Location"
* group.element[35].target.equivalence = #equivalent
* group.element[35].target.code = #location[3].location(Location)
...
* group.element[35].target.extension[0].extension[0].valueCode = #"Reference(Location)"
...
* group.element[35].target.display = "location[3].location(Location)"
* group.element[35].target.dependsOn[0].property = "data-type-map"
* group.element[35].target.dependsOn[0].value = "PL"
* group.element[36].code = #PV1-42
...
* group.element[36].extension[0].extension[0].valueCode = #"PL"
...
* group.element[36].display = "Pending Location"
* group.element[36].target.equivalence = #equivalent
* group.element[36].target.code = #location[3].status
* group.element[36].target.display = "location[3].status"
* group.element[36].target.dependsOn[0].property = "value"
* group.element[36].target.dependsOn[0].value = "\"planned\""
* group.element[37].code = #PV1-43
...
* group.element[37].extension[0].extension[0].valueCode = #"PL"
...
* group.element[37].display = "Prior Temporary Location"
* group.element[37].target.equivalence = #equivalent
* group.element[37].target.code = #location[4].location(Location)
...
* group.element[37].target.extension[0].extension[0].valueCode = #"Reference(Location)"
...
* group.element[37].target.display = "location[4].location(Location)"
* group.element[37].target.dependsOn[0].property = "data-type-map"
* group.element[37].target.dependsOn[0].value = "PL"
* group.element[38].code = #PV1-43
...
* group.element[38].extension[0].extension[0].valueCode = #"PL"
...
* group.element[38].display = "Prior Temporary Location"
* group.element[38].target.equivalence = #equivalent
* group.element[38].target.code = #location[4].status
* group.element[38].target.display = "location[4].status"
* group.element[38].target.dependsOn[0].property = "value"
* group.element[38].target.dependsOn[0].value = "\"completed\""
* group.element[39].code = #PV1-44
...
* group.element[39].display = "Admit Date/Time"
* group.element[39].target.equivalence = #equivalent
* group.element[39].target.code = #period.start
...
* group.element[39].target.display = "period.start"
* group.element[40].code = #PV1-45
...
* group.element[40].display = "Discharge Date/Time"
* group.element[40].target.equivalence = #equivalent
* group.element[40].target.code = #period.end
...
* group.element[40].target.display = "period.end"
* group.element[41].code = #PV1-45
...
* group.element[41].display = "Discharge Date/Time"
* group.element[41].target.equivalence = #equivalent
* group.element[41].target.code = #status
...
* group.element[41].target.extension[0].extension[1].valueInteger = 1
...
* group.element[41].target.display = "= \"finished\""
* group.element[41].target.product[0].property = "antlr"
* group.element[41].target.product[0].value = "IF PV1-45 VALUED"
* group.element[42].code = #PV1-50
...
* group.element[42].extension[0].extension[0].valueCode = #"CX"
...
* group.element[42].display = "Alternate Visit ID"
* group.element[42].target.equivalence = #equivalent
* group.element[42].target.code = #identifier[2]
...
* group.element[42].target.display = "identifier[2]"
* group.element[42].target.dependsOn[0].property = "data-type-map"
* group.element[42].target.dependsOn[0].value = "CX"
...
* group.element[43].target.code = #participant[5].individual(Practitioner)
...
* group.element[43].target.extension[0].extension[0].valueCode = #"Reference(Practitioner)"
...
* group.element[43].target.display = "participant[5].individual(Practitioner)"
* group.element[43].target.dependsOn[0].property = "data-type-map"
* group.element[43].target.dependsOn[0].value = "XCN[Practitioner]"
* group.element[44].code = #PV1-52
* group.element[44].extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[44].display = "Other Healthcare Provider"
* group.element[44].target.equivalence = #equivalent
* group.element[44].target.code = #participant[5].type.coding.code
* group.element[44].target.extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[44].target.display = "= \"PART\""
* group.element[44].target.dependsOn[0].property = "value"
* group.element[44].target.dependsOn[0].value = "\"PART\""
* group.element[45].code = #PV1-52
* group.element[45].extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[45].display = "Other Healthcare Provider"
* group.element[45].target.equivalence = #equivalent
* group.element[45].target.code = #participant[5].type.coding.system
* group.element[45].target.extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[45].target.display = "participant[5].type.coding.system"
* group.element[45].target.dependsOn[0].property = "value"
* group.element[45].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/v3-ParticipationType\""
* group.element[46].code = #PV1-52
* group.element[46].extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[46].target.code = #participant[5].type.text
* group.element[46].target.extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
...
* group.element[46].target.display = "= \"Participation\""
* group.element[46].target.dependsOn[0].property = "value"
* group.element[46].target.dependsOn[0].value = "\"Participation\""
* group.element[47].code = #PV1-54
* group.element[47].extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
* group.element[47].extension[0].extension[0].url = "type"
* group.element[47].extension[0].extension[0].valueCode = #"CX"
...
* group.element[47].target.extension[0].url = "http://hl7.org/fhir/v2-tofhir/StructureDefinition/TypeInfo"
