...
* extension[0].extension[1].valueString = "Datatype TQ[ServiceRequest] to ServiceRequest.fsh"
...
* group.element[4].target.display = "ServiceRequest.occurenceTiming.repeat.boundsDuration.system"
...
* group.element[5].target.dependsOn[0].value = "TS"
...
* group.element[6].target.dependsOn[0].value = "TS"
