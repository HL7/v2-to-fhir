...
* group.element[9].target.code = #name.period
...
* group.element[9].target.display = "name.period"
...
* group.element[11].target.code = #name.period.start
...
* group.element[11].target.display = "name.period.start"
...
* group.element[12].target.code = #name.period.end
...
* group.element[12].target.display = "name.period.end"
...
* group.element[13].target.code = #name.suffix
...
* group.element[13].target.display = "name.suffix"
