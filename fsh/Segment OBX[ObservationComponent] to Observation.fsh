...
* extension[0].extension[1].valueString = "Segment OBX[ObservationComponent] to Observation.fsh"
...
* group.element[5].target.dependsOn[0].value = "IS[Codeable Concept]"
...
* group.element[6].target.dependsOn[0].value = "DR"
...
* group.element[9].target.display = "Observation.component[all].valueString"
...
* group.element[10].target.dependsOn[0].value = "TM"
...
* group.element[13].target.display = "Observation.component[all].valueString"
...
* group.element[24].target.dependsOn[0].value = "DTM"
