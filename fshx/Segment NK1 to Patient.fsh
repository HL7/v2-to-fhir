...
* group.element[4].target.code = #contact.relationship
...
* group.element[4].target.display = "contact.relationship"
...
* group.element[5].target.code = #contact.period.start
...
* group.element[5].target.display = "contact.period.start"
...
* group.element[6].target.code = #contact.period.end
...
* group.element[6].target.display = "contact.period.end"
...
* group.element[7].target.code = #contact.organization[1](Organization)
...
* group.element[7].target.display = "contact.organization[1](Organization)"
...
* group.element[8].target.code = #contact.gender
...
* group.element[8].target.display = "contact.gender"
...
* group.element[9].target.code = #contact.organization[1](Organization.contact.name)
...
* group.element[9].target.display = "contact.organization[1](Organization.contact.name)"
* group.element[9].target.dependsOn[0].property = "data-type-map"
* group.element[9].target.dependsOn[0].value = "XPN[HumanName]"
...
* group.element[10].target.code = #contact.organization[1](Organization.contact.telecom)
...
* group.element[10].target.display = "contact.organization[1](Organization.contact.telecom)"
...
* group.element[11].target.code = #contact.organization[1](Organization.contact.address)
...
* group.element[11].target.display = "contact.organization[1](Organization.contact.address)"
...
* group.element[12].target.code = #contact.telecom[3]
...
* group.element[12].target.display = "contact.telecom[3]"
...
* group.element[13].target.code = #contact.telecom[4]
...
* group.element[13].target.display = "contact.telecom[4]"
