...
* group.element[5].target.code = #length.value
...
* group.element[5].target.display = "length.value"
* group.element[5].target.dependsOn[0].property = "data-type-map"
* group.element[5].target.dependsOn[0].value = "NM[Quantity]"
...
* group.element[6].target.code = #length.unit
...
* group.element[6].target.display = "length.unit"
* group.element[6].target.dependsOn[0].property = "value"
* group.element[6].target.dependsOn[0].value = "\"d\""
...
* group.element[7].target.code = #length.system
...
* group.element[7].target.display = "length.system"
* group.element[7].target.dependsOn[0].property = "value"
* group.element[7].target.dependsOn[0].value = "\"http://unitsofmeasure.org/\""
...
* group.element[15].target.code = #extension-encounter-modeOfArrival
...
* group.element[15].target.extension[0].extension[0].valueCode = #"Coding"
...
* group.element[15].target.display = "extension-encounter-modeOfArrival"
* group.element[15].target.dependsOn[0].property = "data-type-map"
* group.element[15].target.dependsOn[0].value = "CWE[Coding]"
* group.element[15].target.dependsOn[1].property = "vocabulary-map"
* group.element[15].target.dependsOn[1].value = "ModeOfArrival"
