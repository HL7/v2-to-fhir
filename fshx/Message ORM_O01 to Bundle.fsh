...
* url = "http://hl7.org/fhir/v2-tofhir/message-orm-o01-to-bundle"
* version = "1.0"
...
* group.element[3].target.code = #Task[1]
* group.element[3].target.display = "Task[1]"
* group.element[3].target.dependsOn[0].property = "segment-map"
* group.element[3].target.dependsOn[0].value = "MSH[Task]"
...
* group.element[6].target.code = #Encounter
* group.element[6].target.display = "Encounter"
...
* group.element[8].target.code = #Encounter
* group.element[8].target.display = "Encounter"
...
* group.element[9].target.code = #Coverage
* group.element[9].target.display = "Coverage"
...
* group.element[9].target.dependsOn[0].value = "IN1[Coverage]"
* group.element[9].target.dependsOn[1].property = "references"
* group.element[9].target.dependsOn[1].value = "Coverage.subscriber.reference=Patient[1].id"
...
* group.element[10].target.code = #Coverage
* group.element[10].target.display = "Coverage"
...
* group.element[10].target.dependsOn[0].value = "IN2[Coverage]"
...
* group.element[11].target.code = #Coverage
* group.element[11].target.display = "Coverage"
...
* group.element[11].target.dependsOn[0].value = "IN3[Coverage]"
...
* group.element[13].target.dependsOn[1].value = "ServiceRequest.subject.reference=Patient[1].id"
...
* group.element[14].target.dependsOn[0].value = "ORC[Task-New Order]"
* group.element[14].target.dependsOn[1].property = "references"
* group.element[14].target.dependsOn[1].value = "Task.basedOn.reference=ServiceRequest[1].id; Task.encounter.reference=Encounter[1].id; Task.for.reference=Patient[1].id; Task.reasonReference=Condition[1]id; Task.insurance.reference=Coverage[1].id"
* group.element[14].target.product[0].property = "antlr"
* group.element[14].target.product[0].value = "IF ORC.1 EQUALS \"NW\""
* group.element[14].target.product[1].property = "fhirpath"
* group.element[14].target.product[1].value = "ORC.element(\"1\")=\"NW\""
* group.element[14].target.product[2].property = "narrative"
* group.element[14].target.product[2].value = "If the receiving system should perform the order"
...
* group.element[15].target.dependsOn[0].value = "ORC[Task-CancelOrder]"
* group.element[15].target.dependsOn[1].property = "references"
* group.element[15].target.dependsOn[1].value = "Task.basedOn.reference=ServiceRequest[1].id; Task.encounter.reference=Encounter[1].id; Task.for.reference=Patient[1].id; Task.reasonReference=Condition[1].id; Task.insurance.reference=Coverage[1].id"
* group.element[15].target.product[0].property = "antlr"
* group.element[15].target.product[0].value = "IF ORC.1 EQUALS \"OC\""
* group.element[15].target.product[1].property = "fhirpath"
* group.element[15].target.product[1].value = "ORC.element(\"1\")=\"OC\""
...
* group.element[16].target.code = #Provenance
* group.element[16].target.display = "Provenance"
...
* group.element[16].target.dependsOn[1].value = "Provenance.target=ServiceRequest[ORC]"
...
* group.element[20].target.code = #SupplyRequest
* group.element[20].target.display = "SupplyRequest"
...
* group.element[21].target.dependsOn[0].value = "NTE[Annotation]"
...
* group.element[22].target.dependsOn[1].value = "ServiceRequest[1].reasonReference(Condition.subject.reference=Patient[1].id)"
