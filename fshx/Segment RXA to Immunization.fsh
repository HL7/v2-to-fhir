...
* group.element[14].target.code = #meta.lastUpdated
...
* group.element[14].target.display = "meta.lastUpdated"
...
* group.element[15].target.code = #meta.versionId
...
* group.element[15].target.display = "meta.versionId"
