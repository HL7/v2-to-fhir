...
* url = "http://hl7.org/fhir/v2-tofhir/table-hl70215-to-v2-0215"
* version = "1.0"
...
* sourceUri = "HL70215"
* targetUri = "http://terminology.hl7.org/CodeSystem/v2-0215"
...
* group.element[0].display = "Family only"
* group.element[0].target.equivalence = #equivalent
* group.element[0].target.code = #F
* group.element[0].target.display = "Family only"
* group.element[1].code = #N
* group.element[1].display = "No Publicity"
* group.element[1].target.equivalence = #equivalent
* group.element[1].target.code = #N
* group.element[1].target.display = "No Publicity"
