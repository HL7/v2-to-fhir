...
* group.element[7].target.code = #performer.actor(Practitioner)
...
* group.element[7].target.display = "performer.actor(Practitioner)"
...
* group.element[8].target.code = #performer.function.coding.code
...
* group.element[8].target.display = "performer.function.coding.code"
...
* group.element[9].target.code = #performer.function.coding.system
...
* group.element[9].target.display = "performer.function.coding.system"
