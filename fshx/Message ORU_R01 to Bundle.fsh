...
* group.element[17].display = "Patient Visit - Additional Info"
...
* group.element[18].display = "Participation (for Patient Visit)"
* group.element[18].target.equivalence = #equivalent
* group.element[18].target.code = #PractitionerRole[2]
* group.element[18].target.display = "PractitionerRole[2]"
* group.element[18].target.comment = "Incorporate PRT content into the Encounter created from the PV1 segment."
...
* group.element[18].target.dependsOn[1].value = "Encounter[1].participant.individual.reference=PractitionerRole[2].id"
...
* group.element[19].target.code = #DiagnosticReport[1]
* group.element[19].target.display = "DiagnosticReport[1]"
* group.element[19].target.comment = "Processing of each ORC segment results in the creation of a new DiagnosticReport resource"
* group.element[19].target.dependsOn[0].property = "segment-map"
* group.element[19].target.dependsOn[0].value = "ORC[DiagnosticReport]"
* group.element[19].target.dependsOn[1].property = "references"
* group.element[19].target.dependsOn[1].value = "DiagnosticReport[1].encounter.reference=Encounter[1].id"
...
* group.element[20].target.dependsOn[1].value = "DiagnosticReport[1].basedOn.reference=ServiceRequest[1].id"
* group.element[21].code = #ORU_R01.PATIENT_RESULT.ORDER_OBSERVATION.COMMON_ORDER.PRT
...
* group.element[21].target.dependsOn[1].value = "DiagnosticReport[1].requester.reference=PractitionerRole[3].id"
...
* group.element[22].target.comment = "Incorporate OBR content into the DiagnosticReport created from the ORC segment in the same segment group."
* group.element[22].target.dependsOn[0].property = "segment-map"
* group.element[22].target.dependsOn[0].value = "OBR[DiagnosticReport]"
...
* group.element[24].target.dependsOn[1].value = "DiagnosticReport[1].performer.reference=PractitionerRole[4].id"
* group.element[24].target.product[0].property = "antlr"
* group.element[24].target.product[0].value = "IF PRT-4.1 IN (\"ARI\",\"TN\",\"TR\") AND PRT-4.3 EQUALS \"HL70443\""
* group.element[24].target.product[1].property = "fhirpath"
* group.element[24].target.product[1].value = "PRT.element(4.1) in (\"ARI\",\"TN\", \"TR\")and(PRT.element(4.3)=\"HL70443\")"
...
* group.element[25].target.code = #PractitionerRole[5]
* group.element[25].target.display = "PractitionerRole[5]"
...
* group.element[25].target.dependsOn[1].value = "DiagnosticReport[1].resultsInterpreter.reference=PractitionerRole[5].id"
* group.element[25].target.product[0].property = "antlr"
* group.element[25].target.product[0].value = "IF PRT-4.1 EQUALS \"PRI\" AND PRT-4.3 EQUALS \"HL70443\""
* group.element[25].target.product[1].property = "fhirpath"
* group.element[25].target.product[1].value = "(PRT.element(4.1)=\"PRI\")and(PRT.element(4.3)=\"HL70443\")"
...
* group.element[26].target.code = #PractitionerRole[6]
* group.element[26].target.display = "PractitionerRole[6]"
...
* group.element[26].target.dependsOn[1].value = "DiagnosticReport[1].specimen[1](Specimen.collection.collector.reference)=PractitionerRole[6].id"
...
* group.element[27].target.dependsOn[1].value = "DiagnosticReport[1].requester.reference=PractitionerRole[3].id"
...
* group.element[28].target.dependsOn[1].value = "DiagnosticReport.result.reference=Observation[2].id"
...
* group.element[29].code = #ORU_R01.PATIENT_RESULT.ORDER_OBSERVATION.OBSERVATION.OBX
...
* group.element[29].display = "Observation related to OBR"
...
* group.element[32].target.code = #PractitionerRole[7]
* group.element[32].target.display = "PractitionerRole[7]"
* group.element[32].target.comment = "Incorporate PRT content into the Observation created from the OBX segment in the same segment group when it represents observation practitioner information."
...
* group.element[32].target.dependsOn[1].value = "Observation[2].performer.reference=PractitionerRole[7].id"
* group.element[32].target.product[0].property = "antlr"
* group.element[32].target.product[0].value = "IF PRT-5 VALUED"
* group.element[33].code = #ORU_R01.PATIENT_RESULT.ORDER_OBSERVATION.OBSERVATION.NTE
...
* group.element[33].display = "Notes and comments"
...
* group.element[34].code = #ORU_R01.PATIENT_RESULT.ORDER_OBSERVATION.SPECIMEN.SPM
...
* group.element[34].display = "Specimen"
