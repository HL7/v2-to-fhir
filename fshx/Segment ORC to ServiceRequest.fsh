...
* group.element[11].target.code = #$this
* group.element[11].target.display = "$this"
...
* group.element[18].target.code = #requester(PractitionerRole.practitioner(Practitioner.address))
* group.element[18].target.display = "requester(PractitionerRole.practitioner(Practitioner.address))"
