...
* url = "http://hl7.org/fhir/v2-tofhir/segment-dg1-to-episodeofcare"
* version = "1.0"
...
* group.element[3].target.code = #diagnose.role
...
* group.element[3].target.display = "diagnose.role"
...
* group.element[6].target.code = #diagnosis.condition(Condition.extension-assertedDate)
...
* group.element[6].target.display = "diagnosis.condition(Condition.extension-assertedDate)"
...
* group.element[7].target.code = #diagnosis.condition(Condition.recordedDate)
...
* group.element[7].target.display = "diagnosis.condition(Condition.recordedDate)"
* group.element[8].code = #DG1-20
...
* group.element[8].display = "Diagnosis Identifier"
* group.element[8].target.equivalence = #equivalent
* group.element[8].target.code = #diagnosis.condition(Condition.identifier)
...
* group.element[8].target.display = "diagnosis.condition(Condition.identifier)"
...
* group.element[9].target.code = #diagnosis.condition(Condition.verificationStatus.coding.code)
...
* group.element[9].target.display = "diagnosis.condition(Condition.verificationStatus.coding.code)"
* group.element[9].target.dependsOn[0].property = "value"
* group.element[9].target.dependsOn[0].value = "\"entered-in-error\""
...
* group.element[10].target.code = #diagnosis.condition(Condition.verificationStatus.coding.system)
...
* group.element[10].target.display = "diagnosis.condition(Condition.verificationStatus.coding.system)"
* group.element[10].target.dependsOn[0].property = "value"
* group.element[10].target.dependsOn[0].value = "\"http://terminology.hl7.org/CodeSystem/condition-ver-status\""
...
* group.element[11].target.code = #diagnosis.condition(Condition.extension-condition-dueTo(Condition))
...
* group.element[11].target.extension[0].extension[0].valueCode = #"Reference(Condition)"
...
* group.element[11].target.display = "diagnosis.condition(Condition.extension-condition-dueTo(Condition))"
