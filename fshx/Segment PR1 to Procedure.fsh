...
* group.element[14].target.code = #perfomer[3].function.coding.uri
...
* group.element[14].target.display = "perfomer[3].function.coding.uri"
...
* group.element[15].target.code = #reasonCode
...
* group.element[16].target.code = #identifier
...
* group.element[17].target.code = #location(Location)
...
* group.element[18].target.code = #partOf(Procedure.identifier)
...
* group.element[18].target.dependsOn[0].value = "EI[Identifier]"
