...
* group.element[2].display = "Role Begin Date/Time"
...
* group.element[3].display = "Role End Date/Time"
...
* group.element[4].display = "Office/Home Address/Birthplace"
