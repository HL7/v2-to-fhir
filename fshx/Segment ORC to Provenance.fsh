...
* group.element[18].target.code = #location(Location[1])
...
* group.element[18].target.display = "location(Location[1])"
...
* group.element[19].target.code = #location(Location[1].address)
...
* group.element[19].target.display = "location(Location[1].address)"
...
* group.element[20].target.code = #location(Location[1].telecom)
...
* group.element[20].target.display = "location(Location[1].telecom)"
...
* group.element[21].target.code = #agent[3].who(Practitioner.address)
...
* group.element[21].target.display = "agent[3].who(Practitioner.address)"
