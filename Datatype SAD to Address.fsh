...
* group.element[3].extension[0].extension[1].valueInteger = line 1
...
* group.element[4].extension[0].extension[1].valueInteger = line 2
...
* group.element[5].extension[0].extension[0].valueInteger = line 3
...
* group.element[6].extension[0].extension[0].valueInteger = line 4
