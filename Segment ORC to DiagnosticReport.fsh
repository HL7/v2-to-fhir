...
* group.element[10].target.code = #extension[1].url
...
* group.element[10].target.display = "extension[1].url"
* group.element[10].target.dependsOn[0].property = "value"
* group.element[10].target.dependsOn[0].value = "\"http://hl7.org/fhir/StructureDefinition/event-statusReason\""
...
* group.element[11].target.code = #extension[1].valueCodeableConcept
...
* group.element[11].target.display = "extension[1].valueCodeableConcept"
